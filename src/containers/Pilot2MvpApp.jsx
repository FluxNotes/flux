...
export class Pilot2MvpApp extends Component {
    constructor(props) {
        super(props);
         ...
         *      handler          Function defined in Pilot2MvpApp that performs some action when the item is clicked
    ...
    // Same function as 'setPilot2MvpAppState' except this function uses a callback
    setPilot2MvpAppStateWithCallback = (state, callback) => {
        this.setState(state, callback);
    }
    ...
    render() {
        ...
        return (
            <MuiThemeProvider theme={theme}>
                <div className={(this.state.loading || this.state.loadingErrorObject) ? "Pilot2MvpApp-content loading-background" : "Pilot2MvpApp-content"}>
                    <Grid fluid>
                        <Row center="xs">
                            <Col sm={12}>
                                <PatientControlPanel
...
export default connect(mapStateToProps, mapDispatchToProps)(Pilot2MvpApp);
