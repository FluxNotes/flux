...
import DefaultAppDashboard from '../dashboard/DefaultAppDashboard';
import DataAccess from '../dataaccess/DataAccess';
import DefaultAppSummaryMetadata from '../summary/DefaultAppSummaryMetadata';
...
export class DefaultApp extends Component {
    constructor(props) {
        ...
        this.summaryMetadata = new DefaultAppSummaryMetadata(this.setForceRefresh);
