...
function createOpts(opts) {
    opts = opts || {};
    opts.typeStructuredField = opts.typeStructuredField || 'single_hashtag_structured_field';
	return opts;
}


function SingleHashtagStructuredFieldPlugin(opts) {
    ...
    const schema = {
		nodes: {
			single_hashtag_structured_field:      props => {
...
export default SingleHashtagStructuredFieldPlugin