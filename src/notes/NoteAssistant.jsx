...
export default class NoteAssistant extends Component {
    ...
    // TODO: Move this into derviedStateFromProps when we move to React 16; or use some kind of memoization to derived the selected/disabled state of buttons
    ...
    onPointOfCareButtonClicked() {
        ...
        this.poc_btn_classname = "selected";
    }

    onNotesToggleButtonClicked() {
        this.notes_btn_classname = "selected";
        this.context_btn_classname = "";
    ...
    disableContextToggleButton() {
        this.notes_btn_classname = "selected";
        this.context_btn_classname = "disabled";
        this.poc_btn_classname = "disabled";
    }

    disableAllButtons() {
        this.notes_btn_classname = "disabled";
        this.context_btn_classname = "disabled";
        this.poc_btn_classname = "disabled";
    }
                            ...
                            <g id="Artboard">
                                <g id="tray---POC-selected" transform="translate(0, 1)">
                                    <g id="Group">
                                        ...
                                        <rect id="Rectangle-Copy-2" className="colored-fill" fillRule="nonzero" x="0.5" y="0.5" width="8" height="3.28571429"></rect>
                                        <rect id="Rectangle-Copy-4" className="colored-fill" fillRule="nonzero" x="10.5" y="5.85714286" width="8" height="3.28571429"></rect>
