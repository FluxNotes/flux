...
class Enrollment {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.research', 'Enrollment');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    if (!asExtension && fhir != null) {
      inst.value = FHIRHelper.createInstanceFromFHIR('shr.entity.Group', fhir, fhirType, shrId, allEntries, mappedResources, referencesOut);
    }
    return inst;
  }
