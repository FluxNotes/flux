...
class PrincipalInvestigator {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.research', 'PrincipalInvestigator');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    if (!asExtension && fhir != null) {
      inst.value = FHIRHelper.createInstanceFromFHIR('shr.entity.Practitioner', fhir, fhirType, shrId, allEntries, mappedResources, referencesOut);
    }
    return inst;
  }
