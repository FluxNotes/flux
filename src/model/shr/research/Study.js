...
class Study extends Entity {
  ...
  toFHIR(asExtension=false) {
    ...
    if (this.studyArm != null && this.studyArm.additionalText != null) {
      if(inst['arm'] === undefined) {
        inst['arm'] = {};
      }
      inst['arm']['description'] = inst ['arm']['description'] || [];
      inst['arm']['description'] = inst['arm']['description'].concat(this.studyArm.additionalText.map(f => typeof f.toFHIR === 'function' ? f.toFHIR() : f));
    }
    return inst;
  }
  ...
  static fromFHIR(fhir, asExtension=false) {
    ...
    if (fhir['arm'] != null && fhir['arm']['description'] != null) {
      ...
      inst.studyArm.additionalText = createInstanceFromFHIR('shr.base.AdditionalText', fhir['arm']['description']);
    }
    return inst;
  }
