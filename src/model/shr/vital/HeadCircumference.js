...
class HeadCircumference extends VitalSign {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/vital/HeadCircumference' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the HeadCircumference class to a FHIR object.
   * The FHIR is expected to be valid against the HeadCircumference FHIR profile, but no validation checks are performed.
