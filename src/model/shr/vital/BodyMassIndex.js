...
class BodyMassIndex extends VitalSign {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/vital/BodyMassIndex' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the BodyMassIndex class to a FHIR object.
   * The FHIR is expected to be valid against the BodyMassIndex FHIR profile, but no validation checks are performed.
