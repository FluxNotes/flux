...
class BodyHeight extends VitalSign {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/vital/BodyHeight' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the BodyHeight class to a FHIR object.
   * The FHIR is expected to be valid against the BodyHeight FHIR profile, but no validation checks are performed.
