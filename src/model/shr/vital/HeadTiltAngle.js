...
class HeadTiltAngle {
  ...
  /**
   * Serializes an instance of the HeadTiltAngle class to a FHIR object.
   * The FHIR is expected to be valid against the HeadTiltAngle FHIR profile, but no validation checks are performed.
  ...
  toFHIR(asExtension = false) {
    let inst = {};
    if (asExtension) {
      inst['url'] = 'http://standardhealthrecord.org/fhir/StructureDefinition/shr-vital-HeadTiltAngle-extension';
