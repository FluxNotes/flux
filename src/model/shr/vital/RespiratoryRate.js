...
class RespiratoryRate extends VitalSign {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/vital/RespiratoryRate' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the RespiratoryRate class to a FHIR object.
   * The FHIR is expected to be valid against the RespiratoryRate FHIR profile, but no validation checks are performed.
