...
/**
 * Generated class for shr.vital.BodyWeight.
 * @extends VitalSign
 */
class BodyWeight extends VitalSign {
  ...
  /**
   * Serializes an instance of the BodyWeight class to a FHIR object.
   * The FHIR is expected to be valid against the BodyWeight FHIR profile, but no validation checks are performed.
