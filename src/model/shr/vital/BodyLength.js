...
class BodyLength extends BodyHeight {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/vital/BodyLength' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the BodyLength class to a FHIR object.
   * The FHIR is expected to be valid against the BodyLength FHIR profile, but no validation checks are performed.
