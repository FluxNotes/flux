...
/**
 * Generated class for shr.vital.OxygenSaturation.
 * @extends VitalSign
 */
class OxygenSaturation extends VitalSign {
  ...
  static fromJSON(json = {}) {
    const inst = new OxygenSaturation();
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/vital/OxygenSaturation' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the OxygenSaturation class to a FHIR object.
   * The FHIR is expected to be valid against the OxygenSaturation FHIR profile, but no validation checks are performed.
