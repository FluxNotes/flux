...
/**
 * Generated class for shr.wound.VisibleInternalStructure.
 * @extends CodedEvaluationComponent
 */
class VisibleInternalStructure extends CodedEvaluationComponent {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/wound/VisibleInternalStructure' } };
    if (this.value != null) {
