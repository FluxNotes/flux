...
/**
 * Generated class for shr.wound.WoundUnderminingObservation.
...
class WoundUnderminingObservation extends ComponentOnlyNonLaboratoryObservation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/wound/WoundUnderminingObservation' };
