...
/**
 * Generated class for shr.wound.WoundBedAppearanceObservation.
...
class WoundBedAppearanceObservation extends ComponentOnlyNonLaboratoryObservation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/wound/WoundBedAppearanceObservation' };
