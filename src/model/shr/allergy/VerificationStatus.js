...
class VerificationStatus {
  ...
  /**
   * Serializes an instance of the VerificationStatus class to a FHIR object.
   * The FHIR is expected to be valid against the VerificationStatus FHIR profile, but no validation checks are performed.
