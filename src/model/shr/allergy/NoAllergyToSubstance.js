...
class NoAllergyToSubstance extends Observation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {NoAllergyToSubstance} this.
   */
  ...
  /**
   * Serializes an instance of the NoAllergyToSubstance class to a JSON object.
   * The JSON is expected to be valid against the NoAllergyToSubstance JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/allergy/NoAllergyToSubstance' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the NoAllergyToSubstance class to a FHIR object.
   * The FHIR is expected to be valid against the NoAllergyToSubstance FHIR profile, but no validation checks are performed.
