...
class Altitude {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the Altitude class.
   * The FHIR must be valid against the Altitude FHIR profile, although this is not validated by the function.
