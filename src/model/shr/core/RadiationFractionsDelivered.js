...
/**
 * Generated class for shr.core.RadiationFractionsDelivered.
 */
class RadiationFractionsDelivered {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'RadiationFractionsDelivered');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/RadiationFractionsDelivered' } };
    if (this.value != null) {
