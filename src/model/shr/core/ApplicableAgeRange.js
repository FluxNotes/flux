...
/**
 * Generated class for shr.core.ApplicableAgeRange.
 */
class ApplicableAgeRange {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'ApplicableAgeRange');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/ApplicableAgeRange' } };
    if (this.value != null) {
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    if (!asExtension && fhir != null) {
      inst.value = FHIRHelper.createInstanceFromFHIR('shr.core.Range', fhir, fhirType, shrId, allEntries, mappedResources, referencesOut);
    }
    return inst;
  }
