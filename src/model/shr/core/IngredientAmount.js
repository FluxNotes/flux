...
/**
 * Generated class for shr.core.IngredientAmount.
 */
class IngredientAmount {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'IngredientAmount');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/IngredientAmount' } };
    if (this.value != null) {
