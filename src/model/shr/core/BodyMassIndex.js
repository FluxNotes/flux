...
/**
 * Generated class for shr.core.BodyMassIndex.
 * @extends VitalSign
 */
class BodyMassIndex extends VitalSign {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'BodyMassIndex');
  ...
  /**
   * Serializes an instance of the BodyMassIndex class to a JSON object.
   * The JSON is expected to be valid against the BodyMassIndex JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/BodyMassIndex' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the BodyMassIndex class.
   * The FHIR must be valid against the BodyMassIndex FHIR profile, although this is not validated by the function.
   ...
   * @returns {BodyMassIndex} An instance of BodyMassIndex populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/BodyMassIndex', 'uri');
    if (fhir['meta'] != null) {
