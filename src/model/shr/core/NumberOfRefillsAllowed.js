...
/**
 * Generated class for shr.core.NumberOfRefillsAllowed.
 */
class NumberOfRefillsAllowed {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'NumberOfRefillsAllowed');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/NumberOfRefillsAllowed' } };
    if (this.value != null) {
