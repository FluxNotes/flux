...
/**
 * Generated class for shr.core.RequestIntent.
 */
class RequestIntent {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'RequestIntent');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/RequestIntent' } };
    if (this.value != null) {
