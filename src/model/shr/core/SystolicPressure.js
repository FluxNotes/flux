...
/**
 * Generated class for shr.core.SystolicPressure.
 * @extends QuantitativeObservationComponent
 */
class SystolicPressure extends QuantitativeObservationComponent {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'SystolicPressure');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/SystolicPressure' } };
    if (this.code != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the SystolicPressure class.
   * The FHIR must be valid against the SystolicPressure FHIR profile, although this is not validated by the function.
   ...
   * @returns {SystolicPressure} An instance of SystolicPressure populated with the FHIR data
   */
