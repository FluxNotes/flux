...
/**
 * Generated class for shr.core.AccessionIdentifier.
 * @extends Identifier
 */
class AccessionIdentifier extends Identifier {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'AccessionIdentifier');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/AccessionIdentifier' } };
