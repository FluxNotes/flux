...
/**
 * Generated class for shr.core.ComponentOnlyNonLaboratoryObservation.
...
class ComponentOnlyNonLaboratoryObservation extends NonLaboratoryObservation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'ComponentOnlyNonLaboratoryObservation');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/ComponentOnlyNonLaboratoryObservation' };
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/ComponentOnlyNonLaboratoryObservation', 'uri');
    if (fhir['meta'] != null) {
