...
/**
 * Generated class for shr.core.ParticipationPeriod.
 */
class ParticipationPeriod {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'ParticipationPeriod');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/ParticipationPeriod' } };
    if (this.value != null) {
