...
/**
 * Generated class for shr.core.LaboratoryPanel.
 * @extends LaboratoryObservation
 */
class LaboratoryPanel extends LaboratoryObservation {
  ...
  /**
   * Deserializes JSON data to an instance of the LaboratoryPanel class.
   * The JSON must be valid against the LaboratoryPanel JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {LaboratoryPanel} An instance of LaboratoryPanel populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'LaboratoryPanel');
  ...
  /**
   * Serializes an instance of the LaboratoryPanel class to a JSON object.
   * The JSON is expected to be valid against the LaboratoryPanel JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/LaboratoryPanel' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the LaboratoryPanel class.
   * The FHIR must be valid against the LaboratoryPanel FHIR profile, although this is not validated by the function.
   ...
   * @returns {LaboratoryPanel} An instance of LaboratoryPanel populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/LaboratoryPanel', 'uri');
    if (fhir['meta'] != null) {
