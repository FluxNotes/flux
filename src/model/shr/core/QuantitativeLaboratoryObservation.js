...
/**
 * Generated class for shr.core.QuantitativeLaboratoryObservation.
 * @extends LaboratoryObservation
 */
class QuantitativeLaboratoryObservation extends LaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {QuantitativeLaboratoryObservation} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the QuantitativeLaboratoryObservation class.
   * The JSON must be valid against the QuantitativeLaboratoryObservation JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {QuantitativeLaboratoryObservation} An instance of QuantitativeLaboratoryObservation populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'QuantitativeLaboratoryObservation');
  ...
  /**
   * Serializes an instance of the QuantitativeLaboratoryObservation class to a JSON object.
   * The JSON is expected to be valid against the QuantitativeLaboratoryObservation JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/QuantitativeLaboratoryObservation' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the QuantitativeLaboratoryObservation class.
   * The FHIR must be valid against the QuantitativeLaboratoryObservation FHIR profile, although this is not validated by the function.
   ...
   * @returns {QuantitativeLaboratoryObservation} An instance of QuantitativeLaboratoryObservation populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/QuantitativeLaboratoryObservation', 'uri');
    if (fhir['meta'] != null) {
...
export default QuantitativeLaboratoryObservation;
