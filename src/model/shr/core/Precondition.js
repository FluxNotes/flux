...
/**
 * Generated class for shr.core.Precondition.
 */
class Precondition {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'Precondition');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Precondition' } };
    if (this.value != null) {
