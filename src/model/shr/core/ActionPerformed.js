...
/**
 * Generated class for shr.core.ActionPerformed.
...
class ActionPerformed extends ActionStatement {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'ActionPerformed');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/ActionPerformed' } };
