...
/**
 * Generated class for shr.core.PrincipalInvestigator.
 */
class PrincipalInvestigator {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'PrincipalInvestigator');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/PrincipalInvestigator' } };
    if (this.value != null) {
