...
class QualitativeFrequency {
  ...
  /**
   * Serializes an instance of the QualitativeFrequency class to a FHIR object.
   * The FHIR is expected to be valid against the QualitativeFrequency FHIR profile, but no validation checks are performed.
