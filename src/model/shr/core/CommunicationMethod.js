...
/**
 * Generated class for shr.core.CommunicationMethod.
 */
class CommunicationMethod {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'CommunicationMethod');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/CommunicationMethod' } };
    if (this.value != null) {
