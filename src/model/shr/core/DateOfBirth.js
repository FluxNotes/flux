...
/**
 * Generated class for shr.core.DateOfBirth.
 */
class DateOfBirth {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'DateOfBirth');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/DateOfBirth' } };
    if (this.value != null) {
