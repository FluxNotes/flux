...
/**
 * Generated class for shr.core.OrganizationName.
 */
class OrganizationName {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'OrganizationName');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/OrganizationName' } };
    if (this.value != null) {
