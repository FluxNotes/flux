...
/**
 * Generated class for shr.core.PlaceOfBirth.
 */
class PlaceOfBirth {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'PlaceOfBirth');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/PlaceOfBirth' } };
    if (this.value != null) {
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    if (!asExtension && fhir != null) {
      inst.value = FHIRHelper.createInstanceFromFHIR('shr.core.Address', fhir, fhirType, shrId, allEntries, mappedResources, referencesOut);
    }
    return inst;
  }
