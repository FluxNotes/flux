...
/**
 * Generated class for shr.core.MostRecentOccurrenceTime.
 */
class MostRecentOccurrenceTime {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'MostRecentOccurrenceTime');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/MostRecentOccurrenceTime' } };
    if (this.value != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the MostRecentOccurrenceTime class.
   * The FHIR must be valid against the MostRecentOccurrenceTime FHIR profile, although this is not validated by the function.
   ...
   * @returns {MostRecentOccurrenceTime} An instance of MostRecentOccurrenceTime populated with the FHIR data
   */
