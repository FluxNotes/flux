...
/**
 * Generated class for shr.core.BrandName.
 */
class BrandName {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'BrandName');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/BrandName' } };
    if (this.value != null) {
