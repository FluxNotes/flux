...
/**
 * Generated class for shr.core.ECOGPerformanceStatus.
 * @extends SimpleCodedNonLaboratoryObservation
 */
class ECOGPerformanceStatus extends SimpleCodedNonLaboratoryObservation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'ECOGPerformanceStatus');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/ECOGPerformanceStatus' };
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/ECOGPerformanceStatus', 'uri');
    if (fhir['meta'] != null) {
