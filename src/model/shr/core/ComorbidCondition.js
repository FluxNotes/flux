...
/**
 * Generated class for shr.core.ComorbidCondition.
 * @extends Condition
 */
class ComorbidCondition extends Condition {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {ComorbidCondition} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the ComorbidCondition class.
   * The JSON must be valid against the ComorbidCondition JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {ComorbidCondition} An instance of ComorbidCondition populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'ComorbidCondition');
  ...
  /**
   * Serializes an instance of the ComorbidCondition class to a JSON object.
   * The JSON is expected to be valid against the ComorbidCondition JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/ComorbidCondition' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ComorbidCondition class.
   * The FHIR must be valid against the ComorbidCondition FHIR profile, although this is not validated by the function.
   ...
   * @returns {ComorbidCondition} An instance of ComorbidCondition populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/ComorbidCondition', 'uri');
    if (fhir['meta'] != null) {
