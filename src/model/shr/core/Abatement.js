...
/**
 * Generated class for shr.core.Abatement.
 */
class Abatement {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'Abatement');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Abatement' } };
    if (this.value != null) {
