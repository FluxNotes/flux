...
/**
 * Generated class for shr.core.Outcome.
 */
class Outcome {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'Outcome');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Outcome' } };
    if (this.value != null) {
