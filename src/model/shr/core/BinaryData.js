...
class BinaryData {
  ...
  /**
   * Serializes an instance of the BinaryData class to a FHIR object.
   * The FHIR is expected to be valid against the BinaryData FHIR profile, but no validation checks are performed.
