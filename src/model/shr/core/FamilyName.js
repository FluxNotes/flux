...
class FamilyName {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'FamilyName');
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the FamilyName class.
   * The FHIR must be valid against the FamilyName FHIR profile, although this is not validated by the function.
   ...
   * @returns {FamilyName} An instance of FamilyName populated with the FHIR data
   */
