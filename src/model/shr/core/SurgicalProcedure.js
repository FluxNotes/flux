...
/**
 * Generated class for shr.core.SurgicalProcedure.
 * @extends Procedure
 */
class SurgicalProcedure extends Procedure {
  ...
  /**
   * Get the SurgicalBodyLocation array.
   * @returns {Array<SurgicalBodyLocation>} The shr.core.SurgicalBodyLocation array
   */
  get bodyLocation() {
  ...
  /**
   * Set the SurgicalBodyLocation array.
   * @param {Array<SurgicalBodyLocation>} bodyLocation - The shr.core.SurgicalBodyLocation array
   */
  ...
  /**
   * Set the SurgicalBodyLocation array and return 'this' for chaining.
   * @param {Array<SurgicalBodyLocation>} bodyLocation - The shr.core.SurgicalBodyLocation array
   * @returns {SurgicalProcedure} this.
   */
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'SurgicalProcedure');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/SurgicalProcedure' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the SurgicalProcedure class.
   * The FHIR must be valid against the SurgicalProcedure FHIR profile, although this is not validated by the function.
   ...
   * @returns {SurgicalProcedure} An instance of SurgicalProcedure populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/SurgicalProcedure', 'uri');
    if (fhir['meta'] != null) {
