...
class DisplayText {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'DisplayText');
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the DisplayText class.
   * The FHIR must be valid against the DisplayText FHIR profile, although this is not validated by the function.
   ...
   * @returns {DisplayText} An instance of DisplayText populated with the FHIR data
   */
