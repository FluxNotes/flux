...
/**
 * Generated class for shr.core.Capacity.
 */
class Capacity {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'Capacity');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Capacity' } };
    if (this.value != null) {
