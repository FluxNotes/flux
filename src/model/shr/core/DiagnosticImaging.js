...
import ImagingProcedure from './ImagingProcedure';

/**
 * Generated class for shr.core.DiagnosticImaging.
 * @extends ImagingProcedure
 */
class DiagnosticImaging extends ImagingProcedure {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {DiagnosticImaging} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the DiagnosticImaging class.
   * The JSON must be valid against the DiagnosticImaging JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {DiagnosticImaging} An instance of DiagnosticImaging populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'DiagnosticImaging');
  ...
  /**
   * Serializes an instance of the DiagnosticImaging class to a JSON object.
   * The JSON is expected to be valid against the DiagnosticImaging JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/DiagnosticImaging' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the DiagnosticImaging class.
   * The FHIR must be valid against the DiagnosticImaging FHIR profile, although this is not validated by the function.
   ...
   * @returns {DiagnosticImaging} An instance of DiagnosticImaging populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/DiagnosticImaging', 'uri');
    if (fhir['meta'] != null) {
