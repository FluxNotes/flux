...
class Attachment extends EmbeddedContent {
  ...
  /**
   * Serializes an instance of the Attachment class to a FHIR object.
   * The FHIR is expected to be valid against the Attachment FHIR profile, but no validation checks are performed.
