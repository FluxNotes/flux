...
class DistanceFromLandmark {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'DistanceFromLandmark');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    if (!asExtension && fhir != null) {
      inst.value = FHIRHelper.createInstanceFromFHIR('shr.core.Distance', fhir, fhirType, shrId, allEntries, mappedResources, referencesOut);
    }
    return inst;
  }
