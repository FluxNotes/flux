...
/**
 * Generated class for shr.core.ClinicalStatement.
 * @extends DomainResource
 */
class ClinicalStatement extends DomainResource {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'ClinicalStatement');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/ClinicalStatement' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ClinicalStatement class.
   * The FHIR must be valid against the ClinicalStatement FHIR profile, although this is not validated by the function.
   ...
   * @returns {ClinicalStatement} An instance of ClinicalStatement populated with the FHIR data
   */
