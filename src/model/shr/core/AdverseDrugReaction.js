...
/**
 * Generated class for shr.core.AdverseDrugReaction.
...
class AdverseDrugReaction extends AdverseEvent {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'AdverseDrugReaction');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/AdverseDrugReaction' };
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/AdverseDrugReaction', 'uri');
    if (fhir['meta'] != null) {
