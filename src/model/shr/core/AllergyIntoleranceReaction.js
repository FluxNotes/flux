...
/**
 * Generated class for shr.core.AllergyIntoleranceReaction.
 */
class AllergyIntoleranceReaction {

  /**
   * Get the SubstanceCode.
   * @returns {SubstanceCode} The shr.core.SubstanceCode
   */
  get substanceCode() {
   ...
   * @param {SubstanceCode} substanceCode - The shr.core.SubstanceCode
   */
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'AllergyIntoleranceReaction');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/AllergyIntoleranceReaction' } };
