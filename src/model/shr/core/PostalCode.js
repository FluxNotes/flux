...
class PostalCode {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'PostalCode');
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the PostalCode class.
   * The FHIR must be valid against the PostalCode FHIR profile, although this is not validated by the function.
   ...
   * @returns {PostalCode} An instance of PostalCode populated with the FHIR data
   */
