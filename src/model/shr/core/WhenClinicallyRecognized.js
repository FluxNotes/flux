...
/**
 * Generated class for shr.core.WhenClinicallyRecognized.
 */
class WhenClinicallyRecognized {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'WhenClinicallyRecognized');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/WhenClinicallyRecognized' } };
    if (this.value != null) {
