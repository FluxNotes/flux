...
/**
 * Generated class for shr.core.HeadCircumference.
 * @extends VitalSign
 */
class HeadCircumference extends VitalSign {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'HeadCircumference');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/HeadCircumference' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the HeadCircumference class.
   * The FHIR must be valid against the HeadCircumference FHIR profile, although this is not validated by the function.
   ...
   * @returns {HeadCircumference} An instance of HeadCircumference populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/HeadCircumference', 'uri');
    if (fhir['meta'] != null) {
