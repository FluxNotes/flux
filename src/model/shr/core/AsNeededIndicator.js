...
/**
 * Generated class for shr.core.AsNeededIndicator.
 */
class AsNeededIndicator {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'AsNeededIndicator');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/AsNeededIndicator' } };
    if (this.value != null) {
