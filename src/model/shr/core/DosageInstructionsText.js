...
/**
 * Generated class for shr.core.DosageInstructionsText.
 */
class DosageInstructionsText {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'DosageInstructionsText');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/DosageInstructionsText' } };
    if (this.value != null) {
