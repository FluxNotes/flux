...
/**
 * Generated class for shr.core.RadiationDosePerFraction.
 */
class RadiationDosePerFraction {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'RadiationDosePerFraction');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/RadiationDosePerFraction' } };
    if (this.value != null) {
