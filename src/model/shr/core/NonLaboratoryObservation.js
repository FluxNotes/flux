...
/**
 * Generated class for shr.core.NonLaboratoryObservation.
 * @extends Observation
 */
class NonLaboratoryObservation extends Observation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'NonLaboratoryObservation');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/NonLaboratoryObservation' };
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/NonLaboratoryObservation', 'uri');
    if (fhir['meta'] != null) {
