...
class GivenName {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'GivenName');
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the GivenName class.
   * The FHIR must be valid against the GivenName FHIR profile, although this is not validated by the function.
   ...
   * @returns {GivenName} An instance of GivenName populated with the FHIR data
   */
