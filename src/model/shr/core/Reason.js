...
class Reason {
  ...
  /**
   * Serializes an instance of the Reason class to a FHIR object.
   * The FHIR is expected to be valid against the Reason FHIR profile, but no validation checks are performed.
  ...
  toFHIR(asExtension = false) {
    ...
    if (asExtension) {
      ...
      inst['url'] = 'http://standardhealthrecord.org/fhir/StructureDefinition/shr-core-Reason-extension';
    }
