...
class GeneralizedDuration {
  ...
  /**
   * Serializes an instance of the GeneralizedDuration class to a FHIR object.
   * The FHIR is expected to be valid against the GeneralizedDuration FHIR profile, but no validation checks are performed.
