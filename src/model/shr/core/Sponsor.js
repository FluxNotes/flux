...
/**
 * Generated class for shr.core.Sponsor.
 */
class Sponsor {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'Sponsor');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Sponsor' } };
    if (this.value != null) {
