...
/**
 * Generated class for shr.core.PossibleDrugCause.
 * @extends PossibleCause
 */
class PossibleDrugCause extends PossibleCause {

  /**
   * Get the choice value; one of: shr.core.Medication reference, shr.core.MedicationAdministration reference, shr.core.MedicationStatement reference.
   * @returns {Reference} The choice value; one of: shr.core.Medication reference, shr.core.MedicationAdministration reference, shr.core.MedicationStatement reference
   */
  get value() {
    return this._value;
  }
  ...
  /**
   * Set the choice value; one of: shr.core.Medication reference, shr.core.MedicationAdministration reference, shr.core.MedicationStatement reference.
   * This field/value is required.
   * @param {Reference} value - The choice value; one of: shr.core.Medication reference, shr.core.MedicationAdministration reference, shr.core.MedicationStatement reference
   */
  set value(value) {
    this._value = value;
  }
  ...
  /**
   * Set the choice value; one of: shr.core.Medication reference, shr.core.MedicationAdministration reference, shr.core.MedicationStatement reference and return 'this' for chaining.
   * This field/value is required.
   * @param {Reference} value - The choice value; one of: shr.core.Medication reference, shr.core.MedicationAdministration reference, shr.core.MedicationStatement reference
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'PossibleDrugCause');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/PossibleDrugCause' } };
    if (this.value != null) {
