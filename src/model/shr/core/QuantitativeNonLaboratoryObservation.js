...
/**
 * Generated class for shr.core.QuantitativeNonLaboratoryObservation.
 * @extends NonLaboratoryObservation
 */
class QuantitativeNonLaboratoryObservation extends NonLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {QuantitativeNonLaboratoryObservation} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the QuantitativeNonLaboratoryObservation class.
   * The JSON must be valid against the QuantitativeNonLaboratoryObservation JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {QuantitativeNonLaboratoryObservation} An instance of QuantitativeNonLaboratoryObservation populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'QuantitativeNonLaboratoryObservation');
  ...
  /**
   * Serializes an instance of the QuantitativeNonLaboratoryObservation class to a JSON object.
   * The JSON is expected to be valid against the QuantitativeNonLaboratoryObservation JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/QuantitativeNonLaboratoryObservation' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the QuantitativeNonLaboratoryObservation class.
   * The FHIR must be valid against the QuantitativeNonLaboratoryObservation FHIR profile, although this is not validated by the function.
   ...
   * @returns {QuantitativeNonLaboratoryObservation} An instance of QuantitativeNonLaboratoryObservation populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/QuantitativeNonLaboratoryObservation', 'uri');
    if (fhir['meta'] != null) {
...
export default QuantitativeNonLaboratoryObservation;
