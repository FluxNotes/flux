...
/**
 * Generated class for shr.core.LotNumber.
 */
class LotNumber {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'LotNumber');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/LotNumber' } };
    if (this.value != null) {
