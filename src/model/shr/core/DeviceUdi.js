...
/**
 * Generated class for shr.core.DeviceUdi.
 */
class DeviceUdi {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'DeviceUdi');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/DeviceUdi' } };
    if (this.value != null) {
