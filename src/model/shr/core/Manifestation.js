...
/**
 * Generated class for shr.core.Manifestation.
 */
class Manifestation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'Manifestation');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Manifestation' } };
    if (this.value != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the Manifestation class.
   * The FHIR must be valid against the Manifestation FHIR profile, although this is not validated by the function.
   ...
   * @returns {Manifestation} An instance of Manifestation populated with the FHIR data
   */
