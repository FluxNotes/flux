...
/**
 * Generated class for shr.core.MedicationNonadherence.
 * @extends CodedNonLaboratoryObservation
 */
class MedicationNonadherence extends CodedNonLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {MedicationNonadherence} this.
   */
  ...
  /**
   * Get the shr.core.Medication reference array.
   * @returns {Array<Reference>} The shr.core.Medication reference array
   */
  get medication() {
  ...
  /**
   * Set the shr.core.Medication reference array.
   * @param {Array<Reference>} medication - The shr.core.Medication reference array
   */
  ...
  /**
   * Set the shr.core.Medication reference array and return 'this' for chaining.
   * @param {Array<Reference>} medication - The shr.core.Medication reference array
   * @returns {MedicationNonadherence} this.
   */
   ...
   * @returns {Array<MedicationNonAdherenceReason>} The shr.core.MedicationNonAdherenceReason array
   */
   ...
   * @param {Array<MedicationNonAdherenceReason>} medicationNonAdherenceReason - The shr.core.MedicationNonAdherenceReason array
   */
  ...
  /**
   * Deserializes JSON data to an instance of the MedicationNonadherence class.
   * The JSON must be valid against the MedicationNonadherence JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {MedicationNonadherence} An instance of MedicationNonadherence populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'MedicationNonadherence');
  ...
  /**
   * Serializes an instance of the MedicationNonadherence class to a JSON object.
   * The JSON is expected to be valid against the MedicationNonadherence JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/MedicationNonadherence' };
    ...
    if (this.medication != null) {
      inst['Medication'] = this.medication.map(f => f.toJSON());
    }
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the MedicationNonadherence class.
   * The FHIR must be valid against the MedicationNonadherence FHIR profile, although this is not validated by the function.
   ...
   * @returns {MedicationNonadherence} An instance of MedicationNonadherence populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/MedicationNonadherence', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_extension of fhir['extension'] || []) {
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/shr-core-Medication-extension') {
        inst.medication = inst.medication || [];
        const inst_medication = FHIRHelper.createReference( FHIRHelper.createInstanceFromFHIR('shr.core.Medication', fhir_extension, 'Extension', shrId, allEntries, mappedResources, referencesOut, true), referencesOut);
        inst.medication.push(inst_medication);
      }
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/shr-core-MedicationNonAdherenceReason-extension') {
        inst.medicationNonAdherenceReason = inst.medicationNonAdherenceReason || [];
        const inst_medicationNonAdherenceReason = FHIRHelper.createInstanceFromFHIR('shr.core.MedicationNonAdherenceReason', fhir_extension, 'Extension', shrId, allEntries, mappedResources, referencesOut, true);
        inst.medicationNonAdherenceReason.push(inst_medicationNonAdherenceReason);
      }
    }
...
export default MedicationNonadherence;
