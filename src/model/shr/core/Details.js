...
class Details {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the Details class.
   * The FHIR must be valid against the Details FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {asExtension=false} Whether the provided instance is an extension
   * @returns {Details} An instance of Details populated with the FHIR data
   */
