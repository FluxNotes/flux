...
/**
 * Generated class for shr.core.DriversLicenseNumber.
 */
class DriversLicenseNumber {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'DriversLicenseNumber');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/DriversLicenseNumber' } };
    if (this.value != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the DriversLicenseNumber class.
   * The FHIR must be valid against the DriversLicenseNumber FHIR profile, although this is not validated by the function.
   ...
   * @returns {DriversLicenseNumber} An instance of DriversLicenseNumber populated with the FHIR data
   */
