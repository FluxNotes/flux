...
/**
 * Generated class for shr.core.EntityOrRole.
 * @extends DomainResource
 */
class EntityOrRole extends DomainResource {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'EntityOrRole');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/EntityOrRole' } };
