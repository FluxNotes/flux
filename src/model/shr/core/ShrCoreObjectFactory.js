...
export default class ShrCoreObjectFactory {
  ...
  static createInstanceFromFHIR(fhir, type, asExtension=false) {
    ...
    case 'PlainText': return PlainText.fromFHIR(fhir, asExtension);
    case 'Details': return Details.fromFHIR(fhir, asExtension);
    ...
    case 'TermMapping': return TermMapping.fromFHIR(fhir, asExtension);
    case 'Match': return Match.fromFHIR(fhir, asExtension);
