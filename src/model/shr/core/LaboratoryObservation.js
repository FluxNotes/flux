...
/**
 * Generated class for shr.core.LaboratoryObservation.
 * @extends Observation
 */
class LaboratoryObservation extends Observation {
  ...
  /**
   * Get the PractitionerOrOrganizationPerformer array.
   * @returns {Array<PractitionerOrOrganizationPerformer>} The shr.core.PractitionerOrOrganizationPerformer array
   */
  get performer() {
  ...
  /**
   * Set the PractitionerOrOrganizationPerformer array.
   * @param {Array<PractitionerOrOrganizationPerformer>} performer - The shr.core.PractitionerOrOrganizationPerformer array
   */
  ...
  /**
   * Set the PractitionerOrOrganizationPerformer array and return 'this' for chaining.
   * @param {Array<PractitionerOrOrganizationPerformer>} performer - The shr.core.PractitionerOrOrganizationPerformer array
   * @returns {LaboratoryObservation} this.
   */
  ...
  /**
   * Get the Specimen.
   * @returns {Specimen} The shr.core.Specimen
   */
  get specimen() {
  ...
  /**
   * Set the Specimen.
   * @param {Specimen} specimen - The shr.core.Specimen
   */
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'LaboratoryObservation');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/LaboratoryObservation' };
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/LaboratoryObservation', 'uri');
    if (fhir['meta'] != null) {
