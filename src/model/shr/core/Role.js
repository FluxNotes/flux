...
/**
 * Generated class for shr.core.Role.
...
class Role extends EntityOrRole {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'Role');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Role' } };
