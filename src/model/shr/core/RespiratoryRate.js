...
/**
 * Generated class for shr.core.RespiratoryRate.
 * @extends VitalSign
 */
class RespiratoryRate extends VitalSign {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'RespiratoryRate');
  ...
  /**
   * Serializes an instance of the RespiratoryRate class to a JSON object.
   * The JSON is expected to be valid against the RespiratoryRate JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/RespiratoryRate' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the RespiratoryRate class.
   * The FHIR must be valid against the RespiratoryRate FHIR profile, although this is not validated by the function.
   ...
   * @returns {RespiratoryRate} An instance of RespiratoryRate populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/RespiratoryRate', 'uri');
    if (fhir['meta'] != null) {
