...
/**
 * Generated class for shr.core.Actual.
 */
class Actual {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'Actual');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Actual' } };
    if (this.value != null) {
