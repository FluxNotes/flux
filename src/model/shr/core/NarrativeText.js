...
/**
 * Generated class for shr.core.NarrativeText.
 */
class NarrativeText {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'NarrativeText');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/NarrativeText' } };
    if (this.value != null) {
