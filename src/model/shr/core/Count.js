...
class Count {
  ...
  /**
   * Serializes an instance of the Count class to a FHIR object.
   * The FHIR is expected to be valid against the Count FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the Count class.
   * The FHIR must be valid against the Count FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {asExtension=false} Whether the provided instance is an extension
   * @returns {Count} An instance of Count populated with the FHIR data
   */
