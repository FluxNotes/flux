...
/**
 * Generated class for shr.core.VendorModelNumber.
 */
class VendorModelNumber {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'VendorModelNumber');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/VendorModelNumber' } };
    if (this.value != null) {
