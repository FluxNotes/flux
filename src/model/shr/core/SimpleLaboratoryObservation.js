...
/**
 * Generated class for shr.core.SimpleLaboratoryObservation.
...
class SimpleLaboratoryObservation extends LaboratoryObservation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'SimpleLaboratoryObservation');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/SimpleLaboratoryObservation' };
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/SimpleLaboratoryObservation', 'uri');
    if (fhir['meta'] != null) {
