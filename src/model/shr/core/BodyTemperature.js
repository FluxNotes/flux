...
/**
 * Generated class for shr.core.BodyTemperature.
 * @extends VitalSign
 */
class BodyTemperature extends VitalSign {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'BodyTemperature');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/BodyTemperature' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the BodyTemperature class.
   * The FHIR must be valid against the BodyTemperature FHIR profile, although this is not validated by the function.
   ...
   * @returns {BodyTemperature} An instance of BodyTemperature populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/BodyTemperature', 'uri');
    if (fhir['meta'] != null) {
