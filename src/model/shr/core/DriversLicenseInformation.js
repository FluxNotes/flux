...
/**
 * Generated class for shr.core.DriversLicenseInformation.
 */
class DriversLicenseInformation {

  /**
   * Get the DriversLicenseNumber.
   * @returns {DriversLicenseNumber} The shr.core.DriversLicenseNumber
   */
   ...
   * @param {DriversLicenseNumber} driversLicenseNumber - The shr.core.DriversLicenseNumber
   */
   ...
   * @returns {StateOfIssue} The shr.core.StateOfIssue
   */
  get stateOfIssue() {
   ...
   * @param {StateOfIssue} stateOfIssue - The shr.core.StateOfIssue
   */
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'DriversLicenseInformation');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/DriversLicenseInformation' } };
