...
/**
 * Generated class for shr.core.ConditionCause.
 */
class ConditionCause {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'ConditionCause');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/ConditionCause' } };
    if (this.value != null) {
