...
/**
 * Generated class for shr.core.ImagingProcedure.
 * @extends Procedure
 */
class ImagingProcedure extends Procedure {
   ...
   * @returns {Array<ImagingSubstance>} The shr.core.ImagingSubstance array
   */
   ...
   * @param {Array<ImagingSubstance>} imagingSubstance - The shr.core.ImagingSubstance array
   */
  ...
  /**
   * Deserializes JSON data to an instance of the ImagingProcedure class.
   * The JSON must be valid against the ImagingProcedure JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {ImagingProcedure} An instance of ImagingProcedure populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'ImagingProcedure');
  ...
  /**
   * Serializes an instance of the ImagingProcedure class to a JSON object.
   * The JSON is expected to be valid against the ImagingProcedure JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/ImagingProcedure' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ImagingProcedure class.
   * The FHIR must be valid against the ImagingProcedure FHIR profile, although this is not validated by the function.
   ...
   * @returns {ImagingProcedure} An instance of ImagingProcedure populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/ImagingProcedure', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_extension of fhir['extension'] || []) {
      ...
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/shr-core-ImagingSubstance-extension') {
        inst.imagingSubstance = inst.imagingSubstance || [];
        const inst_imagingSubstance = FHIRHelper.createInstanceFromFHIR('shr.core.ImagingSubstance', fhir_extension, 'Extension', shrId, allEntries, mappedResources, referencesOut, true);
