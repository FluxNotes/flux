...
/**
 * Generated class for shr.core.Affiliation.
 */
class Affiliation {

  /**
   * Get the value (aliases organization).
   * @returns {Organization} The shr.core.Organization
   */
  get value() {
   ...
   * @param {Organization} value - The shr.core.Organization
   */
  set value(value) {
   ...
   * This field/value is required.
   * @param {Organization} organization - The shr.core.Organization
   */
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'Affiliation');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Affiliation' } };
    if (this.value != null) {
