...
/**
 * Generated class for shr.core.DoseAmount.
 */
class DoseAmount {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'DoseAmount');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/DoseAmount' } };
    if (this.value != null) {
