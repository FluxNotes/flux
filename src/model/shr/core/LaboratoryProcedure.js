...
/**
 * Generated class for shr.core.LaboratoryProcedure.
 * @extends Procedure
 */
class LaboratoryProcedure extends Procedure {
  ...
  /**
   * Get the shr.core.Specimen reference.
   * @returns {Reference} The shr.core.Specimen reference
   */
  get specimen() {
  ...
  /**
   * Set the shr.core.Specimen reference.
   * @param {Reference} specimen - The shr.core.Specimen reference
   */
  ...
  /**
   * Set the shr.core.Specimen reference and return 'this' for chaining.
   * @param {Reference} specimen - The shr.core.Specimen reference
   * @returns {LaboratoryProcedure} this.
   */
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'LaboratoryProcedure');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/LaboratoryProcedure' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the LaboratoryProcedure class.
   * The FHIR must be valid against the LaboratoryProcedure FHIR profile, although this is not validated by the function.
   ...
   * @returns {LaboratoryProcedure} An instance of LaboratoryProcedure populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/LaboratoryProcedure', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_extension of fhir['extension'] || []) {
      ...
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/shr-core-Specimen-extension') {
        inst.specimen = FHIRHelper.createReference( FHIRHelper.createInstanceFromFHIR('shr.core.Specimen', fhir_extension, 'Extension', shrId, allEntries, mappedResources, referencesOut, true), referencesOut);
      }
    }
