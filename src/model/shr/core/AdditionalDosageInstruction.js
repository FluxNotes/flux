...
/**
 * Generated class for shr.core.AdditionalDosageInstruction.
 */
class AdditionalDosageInstruction {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'AdditionalDosageInstruction');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/AdditionalDosageInstruction' } };
    if (this.value != null) {
