...
/**
 * Generated class for shr.core.TaxIdentificationNumber.
 * @extends Identifier
 */
class TaxIdentificationNumber extends Identifier {
   ...
   * This field/value is required.
   * @param {Type} type - The shr.core.Type
   * @returns {TaxIdentificationNumber} this.
   */
  withType(type) {
  ...
  /**
   * Deserializes JSON data to an instance of the TaxIdentificationNumber class.
   * The JSON must be valid against the TaxIdentificationNumber JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {TaxIdentificationNumber} An instance of TaxIdentificationNumber populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'TaxIdentificationNumber');
  ...
  /**
   * Serializes an instance of the TaxIdentificationNumber class to a JSON object.
   * The JSON is expected to be valid against the TaxIdentificationNumber JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/TaxIdentificationNumber' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TaxIdentificationNumber class.
   * The FHIR must be valid against the TaxIdentificationNumber FHIR profile, although this is not validated by the function.
   ...
   * @returns {TaxIdentificationNumber} An instance of TaxIdentificationNumber populated with the FHIR data
   */
