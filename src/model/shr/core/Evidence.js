...
/**
 * Generated class for shr.core.Evidence.
 */
class Evidence {

  /**
   * Get the Manifestation array.
   * @returns {Array<Manifestation>} The shr.core.Manifestation array
   */
  get manifestation() {
   ...
   * @param {Array<Manifestation>} manifestation - The shr.core.Manifestation array
   */
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'Evidence');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Evidence' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the Evidence class.
   * The FHIR must be valid against the Evidence FHIR profile, although this is not validated by the function.
   ...
   * @returns {Evidence} An instance of Evidence populated with the FHIR data
   */
