...
class Longitude {
  ...
  /**
   * Serializes an instance of the Longitude class to a FHIR object.
   * The FHIR is expected to be valid against the Longitude FHIR profile, but no validation checks are performed.
