...
/**
 * Generated class for shr.core.TermMapping.
 */
class TermMapping {
  ...
  /**
   * Get the Match.
   * @returns {Match} The shr.core.Match
   */
  get match() {
    return this._match;
  }
   ...
   * Set the Match.
   * This field/value is required.
   * @param {Match} match - The shr.core.Match
   */
  set match(match) {
    this._match = match;
  }
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/TermMapping' } };
    if (this.value != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TermMapping class.
   * The FHIR must be valid against the TermMapping FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {asExtension=false} Whether the provided instance is an extension
   * @returns {TermMapping} An instance of TermMapping populated with the FHIR data
   */
