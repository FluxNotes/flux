...
/**
 * Generated class for shr.core.NarrativeQualifier.
 */
class NarrativeQualifier {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'NarrativeQualifier');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/NarrativeQualifier' } };
    if (this.value != null) {
