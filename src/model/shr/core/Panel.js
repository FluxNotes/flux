...
/**
 * Generated class for shr.core.Panel.
 * @extends Observation
 */
class Panel extends Observation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'Panel');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Panel' };
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/Panel', 'uri');
    if (fhir['meta'] != null) {
