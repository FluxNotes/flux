...
class Duration extends SimpleQuantity {
  ...
  static fromFHIR(fhir, asExtension=false) {
    ...
    if (fhir['extension'] != null) {
      const match = fhir['extension'].find(e => e.url == 'http://example.com/fhir/StructureDefinition/shr-core-Units-extension');
      if (match != null) {
        inst.units = createInstanceFromFHIR('shr.core.Units', match, true);
      }
    }
    return inst;
  }
