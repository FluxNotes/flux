...
/**
 * Generated class for shr.core.ManufactureDate.
 */
class ManufactureDate {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'ManufactureDate');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/ManufactureDate' } };
    if (this.value != null) {
