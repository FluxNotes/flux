...
class NonOccurrenceTimeOrPeriod {
  ...
  /**
   * Serializes an instance of the NonOccurrenceTimeOrPeriod class to a FHIR object.
   * The FHIR is expected to be valid against the NonOccurrenceTimeOrPeriod FHIR profile, but no validation checks are performed.
  ...
  toFHIR(asExtension=false) {
    let inst = {};
    if (asExtension) {
      inst['url'] = 'http://example.com/fhir/StructureDefinition/shr-core-NonOccurrenceTimeOrPeriod-extension';
    }
