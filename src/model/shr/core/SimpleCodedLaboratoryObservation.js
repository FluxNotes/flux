...
/**
 * Generated class for shr.core.SimpleCodedLaboratoryObservation.
...
class SimpleCodedLaboratoryObservation extends CodedLaboratoryObservation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'SimpleCodedLaboratoryObservation');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/SimpleCodedLaboratoryObservation' };
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/SimpleCodedLaboratoryObservation', 'uri');
    if (fhir['meta'] != null) {
