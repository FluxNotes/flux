...
/**
 * Generated class for shr.core.BloodPressure.
 * @extends VitalSign
 */
class BloodPressure extends VitalSign {
  ...
  /**
   * Get the BodyPosition.
   * @returns {BodyPosition} The shr.core.BodyPosition
   */
  get bodyPosition() {
  ...
  /**
   * Set the BodyPosition.
   * @param {BodyPosition} bodyPosition - The shr.core.BodyPosition
   */
  set bodyPosition(bodyPosition) {
    this._bodyPosition = bodyPosition;
  }

  /**
   * Set the BodyPosition and return 'this' for chaining.
   * @param {BodyPosition} bodyPosition - The shr.core.BodyPosition
   * @returns {BloodPressure} this.
   */
  withBodyPosition(bodyPosition) {
    this.bodyPosition = bodyPosition; return this;
  }

  /**
   * Get the BloodPressureCuffSize.
   * @returns {BloodPressureCuffSize} The shr.core.BloodPressureCuffSize
   */
  get bloodPressureCuffSize() {
    return this._bloodPressureCuffSize;
  }

  /**
   * Set the BloodPressureCuffSize.
   * @param {BloodPressureCuffSize} bloodPressureCuffSize - The shr.core.BloodPressureCuffSize
   */
  set bloodPressureCuffSize(bloodPressureCuffSize) {
    this._bloodPressureCuffSize = bloodPressureCuffSize;
  }

  /**
   * Set the BloodPressureCuffSize and return 'this' for chaining.
   * @param {BloodPressureCuffSize} bloodPressureCuffSize - The shr.core.BloodPressureCuffSize
   * @returns {BloodPressure} this.
   */
  withBloodPressureCuffSize(bloodPressureCuffSize) {
    this.bloodPressureCuffSize = bloodPressureCuffSize; return this;
  }
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'BloodPressure');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/BloodPressure' };
    ...
    if (this.bodyPosition != null) {
      inst['BodyPosition'] = typeof this.bodyPosition.toJSON === 'function' ? this.bodyPosition.toJSON() : this.bodyPosition;
    }
    if (this.bloodPressureCuffSize != null) {
      inst['BloodPressureCuffSize'] = typeof this.bloodPressureCuffSize.toJSON === 'function' ? this.bloodPressureCuffSize.toJSON() : this.bloodPressureCuffSize;
    }
    return inst;
  }

  /**
   * Deserializes FHIR JSON data to an instance of the BloodPressure class.
   * The FHIR must be valid against the BloodPressure FHIR profile, although this is not validated by the function.
   ...
   * @returns {BloodPressure} An instance of BloodPressure populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/BloodPressure', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_extension of fhir['extension'] || []) {
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/shr-core-Precondition-extension' && fhir_extension['url'] != null && fhir_extension['url'] === 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/shr-core-Precondition-extension') {
        ...
        if (fhir_extension['valueCodeableConcept'] != null) {
          inst_precondition.value = FHIRHelper.createInstanceFromFHIR('shr.core.CodeableConcept', fhir_extension['valueCodeableConcept'], 'CodeableConcept', shrId, allEntries, mappedResources, referencesOut, false);
        }
      }
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/shr-core-BodyPosition-extension') {
        inst.bodyPosition = FHIRHelper.createInstanceFromFHIR('shr.core.BodyPosition', fhir_extension, 'Extension', shrId, allEntries, mappedResources, referencesOut, true);
      }
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/shr-core-BloodPressureCuffSize-extension') {
        inst.bloodPressureCuffSize = FHIRHelper.createInstanceFromFHIR('shr.core.BloodPressureCuffSize', fhir_extension, 'Extension', shrId, allEntries, mappedResources, referencesOut, true);
      }
    }
