...
class HumanNameSuffix {
  ...
  /**
   * Serializes an instance of the HumanNameSuffix class to a FHIR object.
   * The FHIR is expected to be valid against the HumanNameSuffix FHIR profile, but no validation checks are performed.
