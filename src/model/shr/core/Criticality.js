...
/**
 * Generated class for shr.core.Criticality.
 */
class Criticality {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'Criticality');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Criticality' } };
    if (this.value != null) {
