...
/**
 * Generated class for shr.core.CountryOfIssue.
 */
class CountryOfIssue {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'CountryOfIssue');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/CountryOfIssue' } };
    if (this.value != null) {
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    if (!asExtension && fhir != null) {
      inst.value = FHIRHelper.createInstanceFromFHIR('shr.core.Country', fhir, fhirType, shrId, allEntries, mappedResources, referencesOut);
    }
    return inst;
  }
