...
/**
 * Generated class for shr.core.CongenitalAbnormality.
 * @extends Condition
 */
class CongenitalAbnormality extends Condition {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {CongenitalAbnormality} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the CongenitalAbnormality class.
   * The JSON must be valid against the CongenitalAbnormality JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {CongenitalAbnormality} An instance of CongenitalAbnormality populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'CongenitalAbnormality');
  ...
  /**
   * Serializes an instance of the CongenitalAbnormality class to a JSON object.
   * The JSON is expected to be valid against the CongenitalAbnormality JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/CongenitalAbnormality' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the CongenitalAbnormality class.
   * The FHIR must be valid against the CongenitalAbnormality FHIR profile, although this is not validated by the function.
   ...
   * @returns {CongenitalAbnormality} An instance of CongenitalAbnormality populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/CongenitalAbnormality', 'uri');
    if (fhir['meta'] != null) {
...
export default CongenitalAbnormality;
