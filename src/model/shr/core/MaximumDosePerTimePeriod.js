...
/**
 * Generated class for shr.core.MaximumDosePerTimePeriod.
 */
class MaximumDosePerTimePeriod {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'MaximumDosePerTimePeriod');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/MaximumDosePerTimePeriod' } };
    if (this.value != null) {
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    if (!asExtension && fhir != null) {
      inst.value = FHIRHelper.createInstanceFromFHIR('shr.core.Ratio', fhir, fhirType, shrId, allEntries, mappedResources, referencesOut);
    }
    return inst;
  }
