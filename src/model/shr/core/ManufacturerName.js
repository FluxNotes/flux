...
/**
 * Generated class for shr.core.ManufacturerName.
 */
class ManufacturerName {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'ManufacturerName');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/ManufacturerName' } };
    if (this.value != null) {
