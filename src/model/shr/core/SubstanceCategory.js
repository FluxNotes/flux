...
/**
 * Generated class for shr.core.SubstanceCategory.
 */
class SubstanceCategory {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'SubstanceCategory');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/SubstanceCategory' } };
    if (this.value != null) {
