...
/**
 * Generated class for shr.core.OxygenSaturation.
 * @extends VitalSign
 */
class OxygenSaturation extends VitalSign {
  ...
  /**
   * Deserializes JSON data to an instance of the OxygenSaturation class.
   * The JSON must be valid against the OxygenSaturation JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {OxygenSaturation} An instance of OxygenSaturation populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'OxygenSaturation');
  ...
  /**
   * Serializes an instance of the OxygenSaturation class to a JSON object.
   * The JSON is expected to be valid against the OxygenSaturation JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/OxygenSaturation' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the OxygenSaturation class.
   * The FHIR must be valid against the OxygenSaturation FHIR profile, although this is not validated by the function.
   ...
   * @returns {OxygenSaturation} An instance of OxygenSaturation populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/OxygenSaturation', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_component of fhir['component'] || []) {
      ...
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '19941-4')) {
      }
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '3150-0')) {
      }
    }
    return inst;
  }
