...
/**
 * Generated class for shr.core.SpecimenQuantity.
 */
class SpecimenQuantity {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'SpecimenQuantity');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/SpecimenQuantity' } };
    if (this.value != null) {
