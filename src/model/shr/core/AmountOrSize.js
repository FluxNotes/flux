...
/**
 * Generated class for shr.core.AmountOrSize.
 */
class AmountOrSize {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'AmountOrSize');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/AmountOrSize' } };
    if (this.value != null) {
