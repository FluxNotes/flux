...
/**
 * Generated class for shr.core.ExpirationDate.
 */
class ExpirationDate {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'ExpirationDate');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/ExpirationDate' } };
    if (this.value != null) {
