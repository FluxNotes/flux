...
/**
 * Generated class for shr.core.CollectionTime.
 */
class CollectionTime {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'CollectionTime');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/CollectionTime' } };
    if (this.value != null) {
