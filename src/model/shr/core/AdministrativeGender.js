...
/**
 * Generated class for shr.core.AdministrativeGender.
 */
class AdministrativeGender {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'AdministrativeGender');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/AdministrativeGender' } };
    if (this.value != null) {
