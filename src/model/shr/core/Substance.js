...
/**
 * Generated class for shr.core.Substance.
 * @extends Entity
 */
class Substance extends Entity {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'Substance');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Substance' };
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/Substance', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_category of fhir['category'] || []) {
      inst.category = inst.category || [];
      const inst_category = FHIRHelper.createInstanceFromFHIR('shr.core.Category', fhir_category, 'CodeableConcept', shrId, allEntries, mappedResources, referencesOut, false);
    ...
    for (const fhir_ingredient of fhir['ingredient'] || []) {
      ...
      const inst_ingredient = FHIRHelper.createInstanceFromFHIR('shr.core.Ingredient', fhir_ingredient, 'BackboneElement', shrId, allEntries, mappedResources, referencesOut, false);
      inst.ingredient.push(inst_ingredient);
      if (fhir_ingredient['quantity'] != null) {
        inst_ingredient.ingredientAmount = FHIRHelper.createInstanceFromFHIR('shr.core.IngredientAmount', fhir_ingredient['quantity'], 'Ratio', shrId, allEntries, mappedResources, referencesOut, false);
      }
      if (fhir_ingredient['substance'] != null) {
        inst_ingredient.substanceOrCode = inst_ingredient.substanceOrCode || FHIRHelper.createInstanceFromFHIR('shr.core.SubstanceOrCode', {}, null, shrId);
        ...
        if (mappedResources[entryId]) {
          ...
          const entryType = 'http://standardhealthrecord.org/spec/shr/core/Substance';
