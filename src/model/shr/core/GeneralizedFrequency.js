...
class GeneralizedFrequency {
  ...
  /**
   * Serializes an instance of the GeneralizedFrequency class to a FHIR object.
   * The FHIR is expected to be valid against the GeneralizedFrequency FHIR profile, but no validation checks are performed.
