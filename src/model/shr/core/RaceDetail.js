...
/**
 * Generated class for shr.core.RaceDetail.
 */
class RaceDetail {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'RaceDetail');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/RaceDetail' } };
    if (this.value != null) {
