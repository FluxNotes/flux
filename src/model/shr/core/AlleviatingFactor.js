...
/**
 * Generated class for shr.core.AlleviatingFactor.
 */
class AlleviatingFactor {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'AlleviatingFactor');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/AlleviatingFactor' } };
    if (this.value != null) {
