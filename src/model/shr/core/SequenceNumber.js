...
/**
 * Generated class for shr.core.SequenceNumber.
 */
class SequenceNumber {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'SequenceNumber');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/SequenceNumber' } };
    if (this.value != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the SequenceNumber class.
   * The FHIR must be valid against the SequenceNumber FHIR profile, although this is not validated by the function.
   ...
   * @returns {SequenceNumber} An instance of SequenceNumber populated with the FHIR data
   */
