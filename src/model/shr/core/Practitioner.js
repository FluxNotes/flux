...
/**
 * Generated class for shr.core.Practitioner.
 * @extends Role
 */
class Practitioner extends Role {
   ...
   * @returns {Array<Qualification>} The shr.core.Qualification array
   */
  get qualification() {
   ...
   * @param {Array<Qualification>} qualification - The shr.core.Qualification array
   */
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'Practitioner');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Practitioner' };
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/Practitioner', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_qualification of fhir['qualification'] || []) {
      ...
      const inst_qualification = FHIRHelper.createInstanceFromFHIR('shr.core.Qualification', fhir_qualification, 'BackboneElement', shrId, allEntries, mappedResources, referencesOut, false);
      inst.qualification.push(inst_qualification);
      for (const fhir_qualification_identifier of fhir_qualification['identifier'] || []) {
        inst_qualification.identifier = inst_qualification.identifier || [];
        const inst_qualification_identifier = FHIRHelper.createInstanceFromFHIR('shr.core.Identifier', fhir_qualification_identifier, 'Identifier', shrId, allEntries, mappedResources, referencesOut, false);
        inst_qualification.identifier.push(inst_qualification_identifier);
      }
      if (fhir_qualification['code'] != null) {
        inst_qualification.type = FHIRHelper.createInstanceFromFHIR('shr.core.Type', fhir_qualification['code'], 'CodeableConcept', shrId, allEntries, mappedResources, referencesOut, false);
      }
      if (fhir_qualification['period'] != null) {
        inst_qualification.effectiveTimePeriod = FHIRHelper.createInstanceFromFHIR('shr.core.EffectiveTimePeriod', fhir_qualification['period'], 'Period', shrId, allEntries, mappedResources, referencesOut, false);
      }
      if (fhir_qualification['issuer'] != null) {
        ...
        inst_qualification.issuer = mappedResources[entryId];
      }
    }
    for (const fhir_communication of fhir['communication'] || []) {
      ...
      inst_person_communication.language = FHIRHelper.createInstanceFromFHIR('shr.core.Language', fhir_communication, 'CodeableConcept', shrId, allEntries, mappedResources, referencesOut, false);
    }
    return inst;
  }
