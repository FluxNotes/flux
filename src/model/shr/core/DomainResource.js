...
/**
 * Generated class for shr.core.DomainResource.
 * @extends Resource
 */
class DomainResource extends Resource {
  ...
  /**
   * Get the Narrative.
   * @returns {Narrative} The shr.core.Narrative
   */
  get narrative() {
  ...
  /**
   * Set the Narrative.
   * @param {Narrative} narrative - The shr.core.Narrative
   */
  ...
  /**
   * Deserializes JSON data to an instance of the DomainResource class.
   * The JSON must be valid against the DomainResource JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {DomainResource} An instance of DomainResource populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'DomainResource');
  ...
  /**
   * Serializes an instance of the DomainResource class to a JSON object.
   * The JSON is expected to be valid against the DomainResource JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/DomainResource' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the DomainResource class.
   * The FHIR must be valid against the DomainResource FHIR profile, although this is not validated by the function.
   ...
   * @returns {DomainResource} An instance of DomainResource populated with the FHIR data
   */
