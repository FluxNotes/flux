...
/**
 * Generated class for shr.core.QuantityPerDispense.
 */
class QuantityPerDispense {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'QuantityPerDispense');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/QuantityPerDispense' } };
    if (this.value != null) {
