...
/**
 * Generated class for shr.core.SecurityLabel.
 */
class SecurityLabel {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'SecurityLabel');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/SecurityLabel' } };
    if (this.value != null) {
