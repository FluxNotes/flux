...
/**
 * Generated class for shr.core.MedicationExposure.
 * @extends ActionPerformed
 */
class MedicationExposure extends ActionPerformed {
   ...
   * @param {Method} method - The shr.core.Method
   * @returns {MedicationExposure} this.
   */
  withMethod(method) {
  ...
  /**
   * Deserializes JSON data to an instance of the MedicationExposure class.
   * The JSON must be valid against the MedicationExposure JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {MedicationExposure} An instance of MedicationExposure populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'MedicationExposure');
  ...
  /**
   * Serializes an instance of the MedicationExposure class to a JSON object.
   * The JSON is expected to be valid against the MedicationExposure JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/MedicationExposure' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the MedicationExposure class.
   * The FHIR must be valid against the MedicationExposure FHIR profile, although this is not validated by the function.
   ...
   * @returns {MedicationExposure} An instance of MedicationExposure populated with the FHIR data
   */
...
export default MedicationExposure;
