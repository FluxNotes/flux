...
class PersonName extends Name {
  ...
  /**
   * Serializes an instance of the PersonName class to a FHIR object.
   * The FHIR is expected to be valid against the PersonName FHIR profile, but no validation checks are performed.
