...
/**
 * Generated class for shr.core.StageInformation.
 */
class StageInformation {

  /**
   * Get the StageSummary.
   * @returns {StageSummary} The shr.core.StageSummary
   */
  get stageSummary() {
   ...
   * @param {StageSummary} stageSummary - The shr.core.StageSummary
   */
  ...
  /**
   * Get the StageDetail.
   * @returns {StageDetail} The shr.core.StageDetail
   */
  get stageDetail() {
  ...
  /**
   * Set the StageDetail.
   * @param {StageDetail} stageDetail - The shr.core.StageDetail
   */
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'StageInformation');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/StageInformation' } };
