...
class Definitional {
  ...
  /**
   * Serializes an instance of the Definitional class to a FHIR object.
   * The FHIR is expected to be valid against the Definitional FHIR profile, but no validation checks are performed.
