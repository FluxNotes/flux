...
/**
 * Generated class for shr.core.PlacerOrderNumber.
 * @extends Identifier
 */
class PlacerOrderNumber extends Identifier {
   ...
   * This field/value is required.
   * @param {Type} type - The shr.core.Type
   * @returns {PlacerOrderNumber} this.
   */
  withType(type) {
  ...
  /**
   * Deserializes JSON data to an instance of the PlacerOrderNumber class.
   * The JSON must be valid against the PlacerOrderNumber JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {PlacerOrderNumber} An instance of PlacerOrderNumber populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'PlacerOrderNumber');
  ...
  /**
   * Serializes an instance of the PlacerOrderNumber class to a JSON object.
   * The JSON is expected to be valid against the PlacerOrderNumber JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/PlacerOrderNumber' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the PlacerOrderNumber class.
   * The FHIR must be valid against the PlacerOrderNumber FHIR profile, although this is not validated by the function.
   ...
   * @returns {PlacerOrderNumber} An instance of PlacerOrderNumber populated with the FHIR data
   */
...
export default PlacerOrderNumber;
