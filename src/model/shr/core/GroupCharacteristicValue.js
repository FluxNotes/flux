...
/**
 * Generated class for shr.core.GroupCharacteristicValue.
 */
class GroupCharacteristicValue {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'GroupCharacteristicValue');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/GroupCharacteristicValue' } };
    if (this.value != null) {
