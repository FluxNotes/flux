...
/**
 * Generated class for shr.core.MothersMaidenName.
 */
class MothersMaidenName {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'MothersMaidenName');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/MothersMaidenName' } };
    if (this.value != null) {
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    if (!asExtension && fhir != null) {
      inst.value = FHIRHelper.createInstanceFromFHIR('shr.core.HumanName', fhir, fhirType, shrId, allEntries, mappedResources, referencesOut);
    }
    return inst;
  }
