...
/**
 * Generated class for shr.core.ManagingOrganization.
 */
class ManagingOrganization {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'ManagingOrganization');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/ManagingOrganization' } };
    if (this.value != null) {
