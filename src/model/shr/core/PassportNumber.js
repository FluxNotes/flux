...
/**
 * Generated class for shr.core.PassportNumber.
 */
class PassportNumber {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'PassportNumber');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/PassportNumber' } };
    if (this.value != null) {
