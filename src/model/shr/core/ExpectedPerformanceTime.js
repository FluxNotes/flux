...
/**
 * Generated class for shr.core.ExpectedPerformanceTime.
 */
class ExpectedPerformanceTime {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'ExpectedPerformanceTime');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/ExpectedPerformanceTime' } };
    if (this.value != null) {
