...
class HumanNamePrefix {
  ...
  /**
   * Serializes an instance of the HumanNamePrefix class to a FHIR object.
   * The FHIR is expected to be valid against the HumanNamePrefix FHIR profile, but no validation checks are performed.
