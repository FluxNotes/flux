...
/**
 * Generated class for shr.core.OverTheCounter.
 */
class OverTheCounter {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'OverTheCounter');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/OverTheCounter' } };
    if (this.value != null) {
