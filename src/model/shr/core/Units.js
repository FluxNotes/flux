...
class Units {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'Units');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    if (!asExtension && fhir != null) {
      inst.value = FHIRHelper.createInstanceFromFHIR('shr.core.Coding', fhir, fhirType, shrId, allEntries, mappedResources, referencesOut);
    }
    return inst;
  }
