...
/**
 * Generated class for shr.core.SocialHistoryObservation.
 * @extends NonLaboratoryObservation
 */
class SocialHistoryObservation extends NonLaboratoryObservation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'SocialHistoryObservation');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/SocialHistoryObservation' } };
