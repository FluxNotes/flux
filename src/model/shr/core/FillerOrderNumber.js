...
/**
 * Generated class for shr.core.FillerOrderNumber.
 * @extends Identifier
 */
class FillerOrderNumber extends Identifier {
   ...
   * This field/value is required.
   * @param {Type} type - The shr.core.Type
   * @returns {FillerOrderNumber} this.
   */
  withType(type) {
  ...
  /**
   * Deserializes JSON data to an instance of the FillerOrderNumber class.
   * The JSON must be valid against the FillerOrderNumber JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {FillerOrderNumber} An instance of FillerOrderNumber populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'FillerOrderNumber');
  ...
  /**
   * Serializes an instance of the FillerOrderNumber class to a JSON object.
   * The JSON is expected to be valid against the FillerOrderNumber JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/FillerOrderNumber' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the FillerOrderNumber class.
   * The FHIR must be valid against the FillerOrderNumber FHIR profile, although this is not validated by the function.
   ...
   * @returns {FillerOrderNumber} An instance of FillerOrderNumber populated with the FHIR data
   */
...
export default FillerOrderNumber;
