...
/**
 * Generated class for shr.core.BodyWeight.
 * @extends VitalSign
 */
class BodyWeight extends VitalSign {
  ...
  /**
   * Deserializes JSON data to an instance of the BodyWeight class.
   * The JSON must be valid against the BodyWeight JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {BodyWeight} An instance of BodyWeight populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'BodyWeight');
  ...
  /**
   * Serializes an instance of the BodyWeight class to a JSON object.
   * The JSON is expected to be valid against the BodyWeight JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/BodyWeight' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the BodyWeight class.
   * The FHIR must be valid against the BodyWeight FHIR profile, although this is not validated by the function.
   ...
   * @returns {BodyWeight} An instance of BodyWeight populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/BodyWeight', 'uri');
    if (fhir['meta'] != null) {
