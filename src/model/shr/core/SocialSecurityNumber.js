...
/**
 * Generated class for shr.core.SocialSecurityNumber.
 */
class SocialSecurityNumber {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'SocialSecurityNumber');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/SocialSecurityNumber' } };
    if (this.value != null) {
