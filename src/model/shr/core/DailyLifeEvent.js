...
class DailyLifeEvent {
  ...
  /**
   * Serializes an instance of the DailyLifeEvent class to a FHIR object.
   * The FHIR is expected to be valid against the DailyLifeEvent FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the DailyLifeEvent class.
   * The FHIR must be valid against the DailyLifeEvent FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {asExtension=false} Whether the provided instance is an extension
   * @returns {DailyLifeEvent} An instance of DailyLifeEvent populated with the FHIR data
   */
