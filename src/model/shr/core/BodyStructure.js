...
/**
 * Generated class for shr.core.BodyStructure.
 * @extends Condition
 */
class BodyStructure extends Condition {
  ...
  /**
   * Deserializes JSON data to an instance of the BodyStructure class.
   * The JSON must be valid against the BodyStructure JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {BodyStructure} An instance of BodyStructure populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'BodyStructure');
  ...
  /**
   * Serializes an instance of the BodyStructure class to a JSON object.
   * The JSON is expected to be valid against the BodyStructure JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/BodyStructure' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the BodyStructure class.
   * The FHIR must be valid against the BodyStructure FHIR profile, although this is not validated by the function.
   ...
   * @returns {BodyStructure} An instance of BodyStructure populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/BodyStructure', 'uri');
    if (fhir['meta'] != null) {
