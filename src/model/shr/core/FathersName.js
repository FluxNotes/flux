...
/**
 * Generated class for shr.core.FathersName.
 */
class FathersName {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'FathersName');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/FathersName' } };
    if (this.value != null) {
