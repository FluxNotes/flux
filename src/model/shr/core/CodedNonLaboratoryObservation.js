...
/**
 * Generated class for shr.core.CodedNonLaboratoryObservation.
 * @extends NonLaboratoryObservation
 */
class CodedNonLaboratoryObservation extends NonLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {CodedNonLaboratoryObservation} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the CodedNonLaboratoryObservation class.
   * The JSON must be valid against the CodedNonLaboratoryObservation JSON schema, although this is not validated by the function.
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'CodedNonLaboratoryObservation');
  ...
  /**
   * Serializes an instance of the CodedNonLaboratoryObservation class to a JSON object.
   * The JSON is expected to be valid against the CodedNonLaboratoryObservation JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/CodedNonLaboratoryObservation' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the CodedNonLaboratoryObservation class.
   * The FHIR must be valid against the CodedNonLaboratoryObservation FHIR profile, although this is not validated by the function.
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/CodedNonLaboratoryObservation', 'uri');
    if (fhir['meta'] != null) {
...
export default CodedNonLaboratoryObservation;
