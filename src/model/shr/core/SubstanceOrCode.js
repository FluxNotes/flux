...
/**
 * Generated class for shr.core.SubstanceOrCode.
 */
class SubstanceOrCode {

  /**
   * Get the choice value; one of: shr.core.CodeableConcept, shr.core.Substance reference, shr.core.Medication reference.
   * @returns {(CodeableConcept|Reference)} The choice value; one of: shr.core.CodeableConcept, shr.core.Substance reference, shr.core.Medication reference
   */
  get value() {
    return this._value;
  }
  ...
  /**
   * Set the choice value; one of: shr.core.CodeableConcept, shr.core.Substance reference, shr.core.Medication reference.
   * This field/value is required.
   * @param {(CodeableConcept|Reference)} value - The choice value; one of: shr.core.CodeableConcept, shr.core.Substance reference, shr.core.Medication reference
   */
  set value(value) {
    this._value = value;
  }
  ...
  /**
   * Set the choice value; one of: shr.core.CodeableConcept, shr.core.Substance reference, shr.core.Medication reference and return 'this' for chaining.
   * This field/value is required.
   * @param {(CodeableConcept|Reference)} value - The choice value; one of: shr.core.CodeableConcept, shr.core.Substance reference, shr.core.Medication reference
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'SubstanceOrCode');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/SubstanceOrCode' } };
    if (this.value != null) {
