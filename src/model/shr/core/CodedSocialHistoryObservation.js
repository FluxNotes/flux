...
/**
 * Generated class for shr.core.CodedSocialHistoryObservation.
...
class CodedSocialHistoryObservation extends SocialHistoryObservation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'CodedSocialHistoryObservation');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/CodedSocialHistoryObservation' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the CodedSocialHistoryObservation class.
   * The FHIR must be valid against the CodedSocialHistoryObservation FHIR profile, although this is not validated by the function.
   ...
   * @returns {CodedSocialHistoryObservation} An instance of CodedSocialHistoryObservation populated with the FHIR data
   */
