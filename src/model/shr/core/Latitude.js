...
class Latitude {
  ...
  /**
   * Serializes an instance of the Latitude class to a FHIR object.
   * The FHIR is expected to be valid against the Latitude FHIR profile, but no validation checks are performed.
