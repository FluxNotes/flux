...
/**
 * Generated class for shr.core.ExcludeFlag.
 */
class ExcludeFlag {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'ExcludeFlag');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/ExcludeFlag' } };
    if (this.value != null) {
