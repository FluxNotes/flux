...
/**
 * Generated class for shr.core.SubstitutionAllowed.
 */
class SubstitutionAllowed {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'SubstitutionAllowed');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/SubstitutionAllowed' } };
    if (this.value != null) {
