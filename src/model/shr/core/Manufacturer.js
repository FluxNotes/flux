...
/**
 * Generated class for shr.core.Manufacturer.
 */
class Manufacturer {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'Manufacturer');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Manufacturer' } };
    if (this.value != null) {
