...
/**
 * Generated class for shr.core.BodyLength.
 * @extends VitalSign
 */
class BodyLength extends VitalSign {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'BodyLength');
  ...
  /**
   * Serializes an instance of the BodyLength class to a JSON object.
   * The JSON is expected to be valid against the BodyLength JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/BodyLength' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the BodyLength class.
   * The FHIR must be valid against the BodyLength FHIR profile, although this is not validated by the function.
   ...
   * @returns {BodyLength} An instance of BodyLength populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/BodyLength', 'uri');
    if (fhir['meta'] != null) {
