...
/**
 * Generated class for shr.core.AccessTime.
 */
class AccessTime {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'AccessTime');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/AccessTime' } };
    if (this.value != null) {
