...
/**
 * Generated class for shr.core.HeadlessLaboratoryPanel.
 * @extends LaboratoryPanel
 */
class HeadlessLaboratoryPanel extends LaboratoryPanel {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {HeadlessLaboratoryPanel} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the HeadlessLaboratoryPanel class.
   * The JSON must be valid against the HeadlessLaboratoryPanel JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {HeadlessLaboratoryPanel} An instance of HeadlessLaboratoryPanel populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'HeadlessLaboratoryPanel');
  ...
  /**
   * Serializes an instance of the HeadlessLaboratoryPanel class to a JSON object.
   * The JSON is expected to be valid against the HeadlessLaboratoryPanel JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/HeadlessLaboratoryPanel' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the HeadlessLaboratoryPanel class.
   * The FHIR must be valid against the HeadlessLaboratoryPanel FHIR profile, although this is not validated by the function.
   ...
   * @returns {HeadlessLaboratoryPanel} An instance of HeadlessLaboratoryPanel populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/HeadlessLaboratoryPanel', 'uri');
    if (fhir['meta'] != null) {
...
export default HeadlessLaboratoryPanel;
