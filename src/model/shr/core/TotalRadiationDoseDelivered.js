...
/**
 * Generated class for shr.core.TotalRadiationDoseDelivered.
 */
class TotalRadiationDoseDelivered {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'TotalRadiationDoseDelivered');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/TotalRadiationDoseDelivered' } };
    if (this.value != null) {
