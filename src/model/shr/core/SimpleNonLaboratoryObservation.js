...
/**
 * Generated class for shr.core.SimpleNonLaboratoryObservation.
...
class SimpleNonLaboratoryObservation extends NonLaboratoryObservation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'SimpleNonLaboratoryObservation');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/SimpleNonLaboratoryObservation' };
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/SimpleNonLaboratoryObservation', 'uri');
    if (fhir['meta'] != null) {
