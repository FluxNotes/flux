...
class Location extends Entity {
  ...
  toFHIR(asExtension = false) {
    ...
    if (asExtension) {
      ...
      inst['extension'] = inst['extension'] || [];
      inst['extension'].push(this.geoposition.toFHIR(true));
      inst['extension'] = inst['extension'] || [];
      inst['extension'].push(this.geopoliticalLocation.toFHIR(true));
      inst['extension'] = inst['extension'] || [];
      ...
      inst['url'] = 'http://standardhealthrecord.org/fhir/StructureDefinition/shr-core-Location-extension';
    }
