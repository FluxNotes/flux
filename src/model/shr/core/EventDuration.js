...
class EventDuration {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'EventDuration');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    if (!asExtension && fhir != null) {
      inst.value = FHIRHelper.createInstanceFromFHIR('shr.core.DurationRange', fhir, fhirType, shrId, allEntries, mappedResources, referencesOut);
    }
    return inst;
  }
