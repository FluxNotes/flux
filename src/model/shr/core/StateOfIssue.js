...
/**
 * Generated class for shr.core.StateOfIssue.
 */
class StateOfIssue {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'StateOfIssue');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/StateOfIssue' } };
    if (this.value != null) {
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    if (!asExtension && fhir != null) {
      inst.value = FHIRHelper.createInstanceFromFHIR('shr.core.State', fhir, fhirType, shrId, allEntries, mappedResources, referencesOut);
    }
    return inst;
  }
