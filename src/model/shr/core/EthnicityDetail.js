...
/**
 * Generated class for shr.core.EthnicityDetail.
 */
class EthnicityDetail {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'EthnicityDetail');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/EthnicityDetail' } };
    if (this.value != null) {
