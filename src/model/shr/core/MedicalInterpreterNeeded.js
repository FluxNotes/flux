...
/**
 * Generated class for shr.core.MedicalInterpreterNeeded.
 */
class MedicalInterpreterNeeded {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'MedicalInterpreterNeeded');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/MedicalInterpreterNeeded' } };
    if (this.value != null) {
