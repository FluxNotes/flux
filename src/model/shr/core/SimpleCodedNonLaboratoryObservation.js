...
/**
 * Generated class for shr.core.SimpleCodedNonLaboratoryObservation.
...
class SimpleCodedNonLaboratoryObservation extends CodedNonLaboratoryObservation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'SimpleCodedNonLaboratoryObservation');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/SimpleCodedNonLaboratoryObservation' };
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/SimpleCodedNonLaboratoryObservation', 'uri');
    if (fhir['meta'] != null) {
