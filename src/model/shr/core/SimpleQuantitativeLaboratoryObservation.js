...
import QuantitativeLaboratoryObservation from './QuantitativeLaboratoryObservation';

/**
 * Generated class for shr.core.SimpleQuantitativeLaboratoryObservation.
 * @extends QuantitativeLaboratoryObservation
 */
class SimpleQuantitativeLaboratoryObservation extends QuantitativeLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {SimpleQuantitativeLaboratoryObservation} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the SimpleQuantitativeLaboratoryObservation class.
   * The JSON must be valid against the SimpleQuantitativeLaboratoryObservation JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {SimpleQuantitativeLaboratoryObservation} An instance of SimpleQuantitativeLaboratoryObservation populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'SimpleQuantitativeLaboratoryObservation');
  ...
  /**
   * Serializes an instance of the SimpleQuantitativeLaboratoryObservation class to a JSON object.
   * The JSON is expected to be valid against the SimpleQuantitativeLaboratoryObservation JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/SimpleQuantitativeLaboratoryObservation' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the SimpleQuantitativeLaboratoryObservation class.
   * The FHIR must be valid against the SimpleQuantitativeLaboratoryObservation FHIR profile, although this is not validated by the function.
   ...
   * @returns {SimpleQuantitativeLaboratoryObservation} An instance of SimpleQuantitativeLaboratoryObservation populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/SimpleQuantitativeLaboratoryObservation', 'uri');
    if (fhir['meta'] != null) {
...
export default SimpleQuantitativeLaboratoryObservation;
