...
/**
 * Generated class for shr.core.Package.
 */
class Package {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'Package');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Package' } };
    if (this.value != null) {
