...
/**
 * Generated class for shr.core.BodyHeight.
 * @extends VitalSign
 */
class BodyHeight extends VitalSign {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'BodyHeight');
  ...
  /**
   * Serializes an instance of the BodyHeight class to a JSON object.
   * The JSON is expected to be valid against the BodyHeight JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/BodyHeight' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the BodyHeight class.
   * The FHIR must be valid against the BodyHeight FHIR profile, although this is not validated by the function.
   ...
   * @returns {BodyHeight} An instance of BodyHeight populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/BodyHeight', 'uri');
    if (fhir['meta'] != null) {
