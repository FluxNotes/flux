...
/**
 * Generated class for shr.core.KarnofskyPerformanceStatus.
 * @extends SimpleCodedNonLaboratoryObservation
 */
class KarnofskyPerformanceStatus extends SimpleCodedNonLaboratoryObservation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'KarnofskyPerformanceStatus');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/KarnofskyPerformanceStatus' };
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/core/KarnofskyPerformanceStatus', 'uri');
    if (fhir['meta'] != null) {
