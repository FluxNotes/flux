...
/**
 * Generated class for shr.core.ClinicalStatus.
 */
class ClinicalStatus {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'ClinicalStatus');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/ClinicalStatus' } };
    if (this.value != null) {
