...
class Width extends ObservationComponent {
  ...
  /**
   * Serializes an instance of the Width class to a FHIR object.
   * The FHIR is expected to be valid against the Width FHIR profile, but no validation checks are performed.
