...
class Width extends ObservationComponent {
  ...
  /**
   * Serializes an instance of the Width class to a JSON object.
   * The JSON is expected to be valid against the Width JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Width' } };
    if (this.value != null) {
