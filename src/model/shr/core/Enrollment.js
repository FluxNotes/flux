...
/**
 * Generated class for shr.core.Enrollment.
 */
class Enrollment {

  /**
   * Get the value (aliases group).
   * @returns {Reference} The shr.core.Group reference
   */
  get value() {
    return this._group;
  }
   ...
   * @param {Reference} value - The shr.core.Group reference
   */
  set value(value) {
    this._group = value;
  }
  ...
  /**
   * Get the shr.core.Group reference.
   * @returns {Reference} The shr.core.Group reference
   */
  get group() {
    return this._group;
  ...
  /**
   * Set the shr.core.Group reference.
   * This field/value is required.
   * @param {Reference} group - The shr.core.Group reference
   */
  set group(group) {
    this._group = group;
  }
  ...
  /**
   * Set the shr.core.Group reference and return 'this' for chaining.
   * This field/value is required.
   * @param {Reference} group - The shr.core.Group reference
   * @returns {Enrollment} this.
   */
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'Enrollment');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Enrollment' } };
    if (this.value != null) {
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    if (!asExtension && fhir != null) {
      inst.value = FHIRHelper.createInstanceFromFHIR('shr.core.Group', fhir, fhirType, shrId, allEntries, mappedResources, referencesOut);
    }
    return inst;
  }
