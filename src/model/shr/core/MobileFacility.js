...
/**
 * Generated class for shr.core.MobileFacility.
 */
class MobileFacility {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'MobileFacility');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/MobileFacility' } };
    if (this.value != null) {
