...
class Qount extends Quantity {
  ...
  /**
   * Serializes an instance of the Qount class to a FHIR object.
   * The FHIR is expected to be valid against the Qount FHIR profile, but no validation checks are performed.
