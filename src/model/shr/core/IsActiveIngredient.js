...
/**
 * Generated class for shr.core.IsActiveIngredient.
 */
class IsActiveIngredient {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.core', 'IsActiveIngredient');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/IsActiveIngredient' } };
    if (this.value != null) {
