...
class FamilyMemberConditionAbsent extends ConditionAbsent {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/familyhistory/FamilyMemberConditionAbsent' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the FamilyMemberConditionAbsent class to a FHIR object.
   * The FHIR is expected to be valid against the FamilyMemberConditionAbsent FHIR profile, but no validation checks are performed.
