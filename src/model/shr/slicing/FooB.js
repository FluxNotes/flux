...
/**
 * Generated class for shr.slicing.FooB.
 * @extends Foo
 */
class FooB extends Foo {

  /**
   * Deserializes JSON data to an instance of the FooB class.
   * The JSON must be valid against the FooB JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {FooB} An instance of FooB populated with the JSON data
   */
  ...
  /**
   * Serializes an instance of the FooB class to a JSON object.
   * The JSON is expected to be valid against the FooB JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/slicing/FooB' } };
  ...
  /**
   * Serializes an instance of the FooB class to a FHIR object.
   * The FHIR is expected to be valid against the FooB FHIR profile, but no validation checks are performed.
