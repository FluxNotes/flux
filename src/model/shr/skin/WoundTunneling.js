...
class WoundTunneling extends Observation {
  ...
  /**
   * Serializes an instance of the WoundTunneling class to a JSON object.
   * The JSON is expected to be valid against the WoundTunneling JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/skin/WoundTunneling' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the WoundTunneling class to a FHIR object.
   * The FHIR is expected to be valid against the WoundTunneling FHIR profile, but no validation checks are performed.
