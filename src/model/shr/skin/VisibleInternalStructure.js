...
class VisibleInternalStructure extends Observation {
   ...
   * This field/value is required.
   * @param {CodeableConcept} value - The shr.core.CodeableConcept
   * @returns {VisibleInternalStructure} this.
   */
  withValue(value) {
  ...
  /**
   * Serializes an instance of the VisibleInternalStructure class to a JSON object.
   * The JSON is expected to be valid against the VisibleInternalStructure JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/skin/VisibleInternalStructure' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the VisibleInternalStructure class to a FHIR object.
   * The FHIR is expected to be valid against the VisibleInternalStructure FHIR profile, but no validation checks are performed.
