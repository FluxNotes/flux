...
class ImmersionDepth {
  ...
  /**
   * Serializes an instance of the ImmersionDepth class to a FHIR object.
   * The FHIR is expected to be valid against the ImmersionDepth FHIR profile, but no validation checks are performed.
