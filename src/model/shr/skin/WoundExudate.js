...
class WoundExudate extends Observation {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/skin/WoundExudate' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the WoundExudate class to a FHIR object.
   * The FHIR is expected to be valid against the WoundExudate FHIR profile, but no validation checks are performed.
