...
class SupportSurfaceUsed extends DeviceUsed {
  ...
  /**
   * Serializes an instance of the SupportSurfaceUsed class to a FHIR object.
   * The FHIR is expected to be valid against the SupportSurfaceUsed FHIR profile, but no validation checks are performed.
