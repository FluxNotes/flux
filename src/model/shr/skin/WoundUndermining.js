...
class WoundUndermining extends Observation {
  ...
  /**
   * Serializes an instance of the WoundUndermining class to a JSON object.
   * The JSON is expected to be valid against the WoundUndermining JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/skin/WoundUndermining' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the WoundUndermining class to a FHIR object.
   * The FHIR is expected to be valid against the WoundUndermining FHIR profile, but no validation checks are performed.
