...
class WoundSize extends Observation {
  ...
  /**
   * Serializes an instance of the WoundSize class to a FHIR object.
   * The FHIR is expected to be valid against the WoundSize FHIR profile, but no validation checks are performed.
