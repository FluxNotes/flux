...
/**
 * Generated class for shr.skin.WoundAssessmentPanel.
 * @extends Observation
 */
class WoundAssessmentPanel extends Observation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/skin/WoundAssessmentPanel' };
    if (this.value != null) {
