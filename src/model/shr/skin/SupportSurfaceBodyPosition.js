...
class SupportSurfaceBodyPosition {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/skin/SupportSurfaceBodyPosition' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the SupportSurfaceBodyPosition class to a FHIR object.
   * The FHIR is expected to be valid against the SupportSurfaceBodyPosition FHIR profile, but no validation checks are performed.
  ...
  toFHIR(asExtension = false) {
    let inst = {};
    if (asExtension) {
      inst['url'] = 'http://standardhealthrecord.org/fhir/StructureDefinition/shr-skin-SupportSurfaceBodyPosition-extension';
