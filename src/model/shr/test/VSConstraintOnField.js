...
/**
 * Generated class for shr.test.VSConstraintOnField.
 */
class VSConstraintOnField {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {VSConstraintOnField} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the VSConstraintOnField class.
   * The JSON must be valid against the VSConstraintOnField JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {VSConstraintOnField} An instance of VSConstraintOnField populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new VSConstraintOnField();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the VSConstraintOnField class to a JSON object.
   * The JSON is expected to be valid against the VSConstraintOnField JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/test/VSConstraintOnField' };
    if (this.simple != null) {
  ...
  /**
   * Serializes an instance of the VSConstraintOnField class to a FHIR object.
   * The FHIR is expected to be valid against the VSConstraintOnField FHIR profile, but no validation checks are performed.
...
export default VSConstraintOnField;
