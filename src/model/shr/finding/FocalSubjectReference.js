...
class FocalSubjectReference {
  ...
  /**
   * Serializes an instance of the FocalSubjectReference class to a FHIR object.
   * The FHIR is expected to be valid against the FocalSubjectReference FHIR profile, but no validation checks are performed.
  ...
  toFHIR(asExtension = false) {
    ...
    if (asExtension) {
      ...
      inst['url'] = 'http://standardhealthrecord.org/fhir/StructureDefinition/shr-finding-FocalSubjectReference-extension';
    }
