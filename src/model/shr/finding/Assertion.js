...
class Assertion extends Observation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/finding/Assertion' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the Assertion class to a FHIR object.
   * The FHIR is expected to be valid against the Assertion FHIR profile, but no validation checks are performed.
