...
/**
 * Generated class for shr.finding.BodyStructureAbsent.
 * @extends Observation
 */
class BodyStructureAbsent extends Observation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {BodyStructureAbsent} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the BodyStructureAbsent class.
   * The JSON must be valid against the BodyStructureAbsent JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {BodyStructureAbsent} An instance of BodyStructureAbsent populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new BodyStructureAbsent();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the BodyStructureAbsent class to a JSON object.
   * The JSON is expected to be valid against the BodyStructureAbsent JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/finding/BodyStructureAbsent' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the BodyStructureAbsent class to a FHIR object.
   * The FHIR is expected to be valid against the BodyStructureAbsent FHIR profile, but no validation checks are performed.
...
export default BodyStructureAbsent;
