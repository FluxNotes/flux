...
class NegationFlag {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/finding/NegationFlag' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the NegationFlag class to a FHIR object.
   * The FHIR is expected to be valid against the NegationFlag FHIR profile, but no validation checks are performed.
  ...
  toFHIR(asExtension = false) {
    let inst = {};
    if (asExtension) {
      inst['url'] = 'http://standardhealthrecord.org/fhir/StructureDefinition/shr-finding-NegationFlag-extension';
