...
class ObservationCode {
  ...
  /**
   * Serializes an instance of the ObservationCode class to a JSON object.
   * The JSON is expected to be valid against the ObservationCode JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/finding/ObservationCode' } };
    if (this.value != null) {
