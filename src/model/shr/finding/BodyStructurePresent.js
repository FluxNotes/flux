...
/**
 * Generated class for shr.finding.BodyStructurePresent.
 * @extends Observation
 */
class BodyStructurePresent extends Observation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/finding/BodyStructurePresent' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the BodyStructurePresent class to a FHIR object.
   * The FHIR is expected to be valid against the BodyStructurePresent FHIR profile, but no validation checks are performed.
