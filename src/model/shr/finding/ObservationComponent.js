...
class ObservationComponent {
  ...
  /**
   * Serializes an instance of the ObservationComponent class to a FHIR object.
   * The FHIR is expected to be valid against the ObservationComponent FHIR profile, but no validation checks are performed.
