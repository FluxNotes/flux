...
class RelatedFinding {
  ...
  /**
   * Serializes an instance of the RelatedFinding class to a FHIR object.
   * The FHIR is expected to be valid against the RelatedFinding FHIR profile, but no validation checks are performed.
