...
class ServiceConnectedDisability extends QuestionAnswer {
   ...
   * This field/value is required.
   * @param {Quantity} value - The shr.core.Quantity
   * @returns {ServiceConnectedDisability} this.
   */
  withValue(value) {
  ...
  /**
   * Serializes an instance of the ServiceConnectedDisability class to a JSON object.
   * The JSON is expected to be valid against the ServiceConnectedDisability JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/lifehistory/ServiceConnectedDisability' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the ServiceConnectedDisability class to a FHIR object.
   * The FHIR is expected to be valid against the ServiceConnectedDisability FHIR profile, but no validation checks are performed.
