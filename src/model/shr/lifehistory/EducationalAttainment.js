...
/**
 * Generated class for shr.lifehistory.EducationalAttainment.
 * @extends QuestionAnswer
 */
class EducationalAttainment extends QuestionAnswer {
  ...
  static fromJSON(json = {}) {
    const inst = new EducationalAttainment();
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/lifehistory/EducationalAttainment' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the EducationalAttainment class to a FHIR object.
   * The FHIR is expected to be valid against the EducationalAttainment FHIR profile, but no validation checks are performed.
