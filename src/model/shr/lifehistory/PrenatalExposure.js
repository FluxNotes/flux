...
class PrenatalExposure extends ExposureToAgent {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/lifehistory/PrenatalExposure' };
    if (this.value != null) {
    ...
    if (this.generalizedTemporalContext != null) {
      inst['GeneralizedTemporalContext'] = typeof this.generalizedTemporalContext.toJSON === 'function' ? this.generalizedTemporalContext.toJSON() : this.generalizedTemporalContext;
    }
    return inst;
  }
  /**
   * Serializes an instance of the PrenatalExposure class to a FHIR object.
   * The FHIR is expected to be valid against the PrenatalExposure FHIR profile, but no validation checks are performed.
