...
/**
 * Generated class for shr.lifehistory.EmploymentStatus.
 * @extends QuestionAnswer
 */
class EmploymentStatus extends QuestionAnswer {
  ...
  /**
   * Deserializes JSON data to an instance of the EmploymentStatus class.
   * The JSON must be valid against the EmploymentStatus JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {EmploymentStatus} An instance of EmploymentStatus populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new EmploymentStatus();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the EmploymentStatus class to a JSON object.
   * The JSON is expected to be valid against the EmploymentStatus JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/lifehistory/EmploymentStatus' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the EmploymentStatus class to a FHIR object.
   * The FHIR is expected to be valid against the EmploymentStatus FHIR profile, but no validation checks are performed.
