...
/**
 * Generated class for shr.lifehistory.CongenitalAbnormality.
 * @extends Condition
 */
class CongenitalAbnormality extends Condition {
  ...
  static fromJSON(json = {}) {
    const inst = new CongenitalAbnormality();
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/lifehistory/CongenitalAbnormality' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the CongenitalAbnormality class to a FHIR object.
   * The FHIR is expected to be valid against the CongenitalAbnormality FHIR profile, but no validation checks are performed.
