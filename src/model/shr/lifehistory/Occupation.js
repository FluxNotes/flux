...
/**
 * Generated class for shr.lifehistory.Occupation.
 * @extends QuestionAnswer
 */
class Occupation extends QuestionAnswer {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lifehistory/Occupation' };
    if (this.value != null) {
