...
class MilitaryServiceEra extends QuestionAnswer {
   ...
   * This field/value is required.
   * @param {CodeableConcept} value - The shr.core.CodeableConcept
   * @returns {MilitaryServiceEra} this.
   */
  withValue(value) {
  ...
  /**
   * Serializes an instance of the MilitaryServiceEra class to a JSON object.
   * The JSON is expected to be valid against the MilitaryServiceEra JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/lifehistory/MilitaryServiceEra' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the MilitaryServiceEra class to a FHIR object.
   * The FHIR is expected to be valid against the MilitaryServiceEra FHIR profile, but no validation checks are performed.
