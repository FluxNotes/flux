...
class DeviceNotUsed extends DeviceAction {
  ...
  /**
   * Serializes an instance of the DeviceNotUsed class to a FHIR object.
   * The FHIR is expected to be valid against the DeviceNotUsed FHIR profile, but no validation checks are performed.
