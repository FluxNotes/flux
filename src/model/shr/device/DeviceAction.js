...
class DeviceAction extends Action {
  ...
  /**
   * Serializes an instance of the DeviceAction class to a FHIR object.
   * The FHIR is expected to be valid against the DeviceAction FHIR profile, but no validation checks are performed.
