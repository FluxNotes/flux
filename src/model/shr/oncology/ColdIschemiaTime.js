...
/**
 * Generated class for shr.oncology.ColdIschemiaTime.
 */
class ColdIschemiaTime {
  ...
  static fromJSON(json = {}) {
    const inst = new ColdIschemiaTime();
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/ColdIschemiaTime' } };
    if (this.value != null) {
