...
class HER2ReceptorStatus extends Observation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/HER2ReceptorStatus' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the HER2ReceptorStatus class to a FHIR object.
   * The FHIR is expected to be valid against the HER2ReceptorStatus FHIR profile, but no validation checks are performed.
