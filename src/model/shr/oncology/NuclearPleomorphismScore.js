...
class NuclearPleomorphismScore extends ObservationComponent {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/NuclearPleomorphismScore' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the NuclearPleomorphismScore class to a FHIR object.
   * The FHIR is expected to be valid against the NuclearPleomorphismScore FHIR profile, but no validation checks are performed.
