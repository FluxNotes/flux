...
class Cellularity extends ObservationComponent {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/Cellularity' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the Cellularity class to a FHIR object.
   * The FHIR is expected to be valid against the Cellularity FHIR profile, but no validation checks are performed.
