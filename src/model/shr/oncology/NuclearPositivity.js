...
class NuclearPositivity extends ObservationComponent {
  ...
  /**
   * Serializes an instance of the NuclearPositivity class to a FHIR object.
   * The FHIR is expected to be valid against the NuclearPositivity FHIR profile, but no validation checks are performed.
