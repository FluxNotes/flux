...
class AverageStainingIntensity extends ObservationComponent {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/AverageStainingIntensity' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the AverageStainingIntensity class to a FHIR object.
   * The FHIR is expected to be valid against the AverageStainingIntensity FHIR profile, but no validation checks are performed.
