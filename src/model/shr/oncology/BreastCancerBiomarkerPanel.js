...
/**
 * Generated class for shr.oncology.BreastCancerBiomarkerPanel.
 * @extends Observation
 */
class BreastCancerBiomarkerPanel extends Observation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {BreastCancerBiomarkerPanel} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the BreastCancerBiomarkerPanel class.
   * The JSON must be valid against the BreastCancerBiomarkerPanel JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {BreastCancerBiomarkerPanel} An instance of BreastCancerBiomarkerPanel populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new BreastCancerBiomarkerPanel();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the BreastCancerBiomarkerPanel class to a JSON object.
   * The JSON is expected to be valid against the BreastCancerBiomarkerPanel JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/BreastCancerBiomarkerPanel' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the BreastCancerBiomarkerPanel class to a FHIR object.
   * The FHIR is expected to be valid against the BreastCancerBiomarkerPanel FHIR profile, but no validation checks are performed.
...
export default BreastCancerBiomarkerPanel;
