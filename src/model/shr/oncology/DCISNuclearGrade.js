...
import SimpleCodedLaboratoryObservation from '../../cimi/statement/SimpleCodedLaboratoryObservation';

/**
 * Generated class for shr.oncology.DCISNuclearGrade.
...
class DCISNuclearGrade extends SimpleCodedLaboratoryObservation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/DCISNuclearGrade' };
