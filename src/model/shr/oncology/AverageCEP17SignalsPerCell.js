...
class AverageCEP17SignalsPerCell extends ObservationComponent {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/AverageCEP17SignalsPerCell' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the AverageCEP17SignalsPerCell class to a FHIR object.
   * The FHIR is expected to be valid against the AverageCEP17SignalsPerCell FHIR profile, but no validation checks are performed.
