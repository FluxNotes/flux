...
class SpecificLaboratoryTest extends FindingMethod {
  ...
  /**
   * Serializes an instance of the SpecificLaboratoryTest class to a FHIR object.
   * The FHIR is expected to be valid against the SpecificLaboratoryTest FHIR profile, but no validation checks are performed.
