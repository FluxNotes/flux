...
class HistologicGrade extends Observation {
  ...
  /**
   * Serializes an instance of the HistologicGrade class to a JSON object.
   * The JSON is expected to be valid against the HistologicGrade JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/HistologicGrade' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the HistologicGrade class to a FHIR object.
   * The FHIR is expected to be valid against the HistologicGrade FHIR profile, but no validation checks are performed.
