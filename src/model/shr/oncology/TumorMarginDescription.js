...
class TumorMarginDescription extends ObservationComponent {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/TumorMarginDescription' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the TumorMarginDescription class to a FHIR object.
   * The FHIR is expected to be valid against the TumorMarginDescription FHIR profile, but no validation checks are performed.
