...
class PercentageInSituCarcinoma extends ObservationComponent {
   ...
   * This field/value is required.
   * @param {Quantity} value - The shr.core.Quantity
   * @returns {PercentageInSituCarcinoma} this.
   */
  withValue(value) {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/PercentageInSituCarcinoma' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the PercentageInSituCarcinoma class to a FHIR object.
   * The FHIR is expected to be valid against the PercentageInSituCarcinoma FHIR profile, but no validation checks are performed.
