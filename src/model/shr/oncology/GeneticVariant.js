...
class GeneticVariant extends Observation {
  ...
  /**
   * Serializes an instance of the GeneticVariant class to a FHIR object.
   * The FHIR is expected to be valid against the GeneticVariant FHIR profile, but no validation checks are performed.
