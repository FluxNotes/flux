...
/**
 * Generated class for shr.oncology.MammaprintRecurrenceScore.
...
class MammaprintRecurrenceScore extends SimpleLaboratoryObservation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/MammaprintRecurrenceScore' };
