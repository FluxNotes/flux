...
/**
 * Generated class for shr.oncology.Aneusomy.
 * @extends ObservationComponent
 */
class Aneusomy extends ObservationComponent {
  ...
  /**
   * Deserializes JSON data to an instance of the Aneusomy class.
   * The JSON must be valid against the Aneusomy JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {Aneusomy} An instance of Aneusomy populated with the JSON data
   */
  ...
  /**
   * Serializes an instance of the Aneusomy class to a FHIR object.
   * The FHIR is expected to be valid against the Aneusomy FHIR profile, but no validation checks are performed.
