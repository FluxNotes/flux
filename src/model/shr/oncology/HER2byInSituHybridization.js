...
/**
 * Generated class for shr.oncology.HER2byInSituHybridization.
 * @extends Observation
 */
class HER2byInSituHybridization extends Observation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {HER2byInSituHybridization} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the HER2byInSituHybridization class.
   * The JSON must be valid against the HER2byInSituHybridization JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {HER2byInSituHybridization} An instance of HER2byInSituHybridization populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new HER2byInSituHybridization();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the HER2byInSituHybridization class to a JSON object.
   * The JSON is expected to be valid against the HER2byInSituHybridization JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/HER2byInSituHybridization' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the HER2byInSituHybridization class to a FHIR object.
   * The FHIR is expected to be valid against the HER2byInSituHybridization FHIR profile, but no validation checks are performed.
...
export default HER2byInSituHybridization;
