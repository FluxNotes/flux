...
class ProgesteroneReceptorStatus extends Observation {
  ...
  /**
   * Set the SpecificLaboratoryTest and return 'this' for chaining.
   * @param {SpecificLaboratoryTest} findingMethod - The shr.oncology.SpecificLaboratoryTest
   * @returns {ProgesteroneReceptorStatus} this.
   */
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/ProgesteroneReceptorStatus' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the ProgesteroneReceptorStatus class to a FHIR object.
   * The FHIR is expected to be valid against the ProgesteroneReceptorStatus FHIR profile, but no validation checks are performed.
