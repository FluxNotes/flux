...
class DegreeOfLymphaticInvolvement extends ObservationComponent {
   ...
   * This field/value is required.
   * @param {CodeableConcept} value - The shr.core.CodeableConcept
   * @returns {DegreeOfLymphaticInvolvement} this.
   */
  withValue(value) {
  ...
  /**
   * Serializes an instance of the DegreeOfLymphaticInvolvement class to a JSON object.
   * The JSON is expected to be valid against the DegreeOfLymphaticInvolvement JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/DegreeOfLymphaticInvolvement' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the DegreeOfLymphaticInvolvement class to a FHIR object.
   * The FHIR is expected to be valid against the DegreeOfLymphaticInvolvement FHIR profile, but no validation checks are performed.
