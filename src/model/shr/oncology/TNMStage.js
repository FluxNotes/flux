...
class TNMStage extends Observation {
  ...
  /**
   * Set the StagingTiming and return 'this' for chaining.
   * @param {StagingTiming} stagingTiming - The shr.oncology.StagingTiming
   * @returns {TNMStage} this.
   */
  withStagingTiming(stagingTiming) {
    this.stagingTiming = stagingTiming; return this;
  }
  ...
  /**
   * Serializes an instance of the TNMStage class to a JSON object.
   * The JSON is expected to be valid against the TNMStage JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/TNMStage' };
    if (this.value != null) {
    ...
    if (this.stagingTiming != null) {
      inst['StagingTiming'] = typeof this.stagingTiming.toJSON === 'function' ? this.stagingTiming.toJSON() : this.stagingTiming;
    }
    return inst;
  }
  /**
   * Serializes an instance of the TNMStage class to a FHIR object.
   * The FHIR is expected to be valid against the TNMStage FHIR profile, but no validation checks are performed.
  ...
  toFHIR(asExtension = false) {
    ...
    if (this.stagingTiming != null) {
      inst['extension'] = inst['extension'] || [];
      inst['extension'].push(this.stagingTiming.toFHIR(true));
    }
    if (this.findingStatus != null) {
