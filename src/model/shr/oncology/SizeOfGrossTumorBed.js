...
class SizeOfGrossTumorBed extends ObservationComponent {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/SizeOfGrossTumorBed' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the SizeOfGrossTumorBed class to a FHIR object.
   * The FHIR is expected to be valid against the SizeOfGrossTumorBed FHIR profile, but no validation checks are performed.
