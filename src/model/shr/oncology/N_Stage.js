...
class N_Stage extends ObservationComponent {
  ...
  /**
   * Serializes an instance of the N_Stage class to a JSON object.
   * The JSON is expected to be valid against the N_Stage JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/oncology/N_Stage' } };
    if (this.value != null) {
