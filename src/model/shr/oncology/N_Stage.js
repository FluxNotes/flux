...
class N_Stage extends ObservationComponent {
  ...
  /**
   * Serializes an instance of the N_Stage class to a FHIR object.
   * The FHIR is expected to be valid against the N_Stage FHIR profile, but no validation checks are performed.
