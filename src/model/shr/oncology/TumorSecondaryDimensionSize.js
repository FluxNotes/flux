...
class TumorSecondaryDimensionSize extends ObservationComponent {
   ...
   * This field/value is required.
   * @param {Quantity} value - The shr.core.Quantity
   * @returns {TumorSecondaryDimensionSize} this.
   */
  withValue(value) {
  ...
  /**
   * Serializes an instance of the TumorSecondaryDimensionSize class to a JSON object.
   * The JSON is expected to be valid against the TumorSecondaryDimensionSize JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/TumorSecondaryDimensionSize' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the TumorSecondaryDimensionSize class to a FHIR object.
   * The FHIR is expected to be valid against the TumorSecondaryDimensionSize FHIR profile, but no validation checks are performed.
