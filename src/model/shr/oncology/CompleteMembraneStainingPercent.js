...
class CompleteMembraneStainingPercent extends ObservationComponent {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/CompleteMembraneStainingPercent' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the CompleteMembraneStainingPercent class to a FHIR object.
   * The FHIR is expected to be valid against the CompleteMembraneStainingPercent FHIR profile, but no validation checks are performed.
