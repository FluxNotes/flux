...
class LymphaticInvolvement extends Observation {
  ...
  /**
   * Serializes an instance of the LymphaticInvolvement class to a FHIR object.
   * The FHIR is expected to be valid against the LymphaticInvolvement FHIR profile, but no validation checks are performed.
