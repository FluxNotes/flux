...
/**
 * Generated class for shr.oncology.OncotypeDxInvasiveRecurrenceScore.
...
class OncotypeDxInvasiveRecurrenceScore extends SimpleLaboratoryObservation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/OncotypeDxInvasiveRecurrenceScore' };
