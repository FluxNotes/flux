...
/**
 * Generated class for shr.oncology.HER2byImmunohistochemistry.
 * @extends Observation
 */
class HER2byImmunohistochemistry extends Observation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {HER2byImmunohistochemistry} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the HER2byImmunohistochemistry class.
   * The JSON must be valid against the HER2byImmunohistochemistry JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {HER2byImmunohistochemistry} An instance of HER2byImmunohistochemistry populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new HER2byImmunohistochemistry();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the HER2byImmunohistochemistry class to a JSON object.
   * The JSON is expected to be valid against the HER2byImmunohistochemistry JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/HER2byImmunohistochemistry' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the HER2byImmunohistochemistry class to a FHIR object.
   * The FHIR is expected to be valid against the HER2byImmunohistochemistry FHIR profile, but no validation checks are performed.
...
export default HER2byImmunohistochemistry;
