...
class HER2toCEP17Ratio extends ObservationComponent {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/HER2toCEP17Ratio' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the HER2toCEP17Ratio class to a FHIR object.
   * The FHIR is expected to be valid against the HER2toCEP17Ratio FHIR profile, but no validation checks are performed.
