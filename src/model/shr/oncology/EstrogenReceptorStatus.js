...
class EstrogenReceptorStatus extends Observation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/EstrogenReceptorStatus' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the EstrogenReceptorStatus class to a FHIR object.
   * The FHIR is expected to be valid against the EstrogenReceptorStatus FHIR profile, but no validation checks are performed.
