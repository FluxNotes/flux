...
/**
 * Generated class for shr.oncology.BreastClinicalLymphNodeInvolvement.
 * @extends LaboratoryObservation
 */
class BreastClinicalLymphNodeInvolvement extends LaboratoryObservation {
  ...
  static fromJSON(json = {}) {
    const inst = new BreastClinicalLymphNodeInvolvement();
  ...
  toJSON() {
    ...
    inst['shr.base.EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/BreastClinicalLymphNodeInvolvement' };
  ...
  /**
   * Serializes an instance of the BreastClinicalLymphNodeInvolvement class to a FHIR object.
   * The FHIR is expected to be valid against the BreastClinicalLymphNodeInvolvement FHIR profile, but no validation checks are performed.
