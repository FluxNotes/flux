...
class BRCA1Variant extends GeneticVariant {
  ...
  /**
   * Serializes an instance of the BRCA1Variant class to a JSON object.
   * The JSON is expected to be valid against the BRCA1Variant JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/BRCA1Variant' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the BRCA1Variant class to a FHIR object.
   * The FHIR is expected to be valid against the BRCA1Variant FHIR profile, but no validation checks are performed.
