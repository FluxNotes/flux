...
class AllredTotalScore extends ObservationComponent {
  ...
  /**
   * Serializes an instance of the AllredTotalScore class to a FHIR object.
   * The FHIR is expected to be valid against the AllredTotalScore FHIR profile, but no validation checks are performed.
