...
class Ki_67LabelingIndex extends Observation {
   ...
   * This field/value is required.
   * @param {Quantity} value - The shr.core.Quantity
   * @returns {Ki_67LabelingIndex} this.
   */
  withValue(value) {
  ...
  /**
   * Serializes an instance of the Ki_67LabelingIndex class to a JSON object.
   * The JSON is expected to be valid against the Ki_67LabelingIndex JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/Ki_67LabelingIndex' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the Ki_67LabelingIndex class to a FHIR object.
   * The FHIR is expected to be valid against the Ki_67LabelingIndex FHIR profile, but no validation checks are performed.
