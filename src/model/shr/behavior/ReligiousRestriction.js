...
class ReligiousRestriction extends BehavioralFinding {
  ...
  /**
   * Serializes an instance of the ReligiousRestriction class to a FHIR object.
   * The FHIR is expected to be valid against the ReligiousRestriction FHIR profile, but no validation checks are performed.
