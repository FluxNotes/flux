...
/**
 * Generated class for shr.behavior.WakeFeelingRested.
 * @extends QuestionAnswer
 */
class WakeFeelingRested extends QuestionAnswer {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {WakeFeelingRested} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the WakeFeelingRested class.
   * The JSON must be valid against the WakeFeelingRested JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {WakeFeelingRested} An instance of WakeFeelingRested populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new WakeFeelingRested();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the WakeFeelingRested class to a JSON object.
   * The JSON is expected to be valid against the WakeFeelingRested JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/behavior/WakeFeelingRested' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the WakeFeelingRested class to a FHIR object.
   * The FHIR is expected to be valid against the WakeFeelingRested FHIR profile, but no validation checks are performed.
...
export default WakeFeelingRested;
