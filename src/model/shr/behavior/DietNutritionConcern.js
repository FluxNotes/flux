...
/**
 * Generated class for shr.behavior.DietNutritionConcern.
 * @extends QuestionAnswer
 */
class DietNutritionConcern extends QuestionAnswer {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {DietNutritionConcern} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the DietNutritionConcern class.
   * The JSON must be valid against the DietNutritionConcern JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {DietNutritionConcern} An instance of DietNutritionConcern populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new DietNutritionConcern();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the DietNutritionConcern class to a JSON object.
   * The JSON is expected to be valid against the DietNutritionConcern JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/behavior/DietNutritionConcern' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the DietNutritionConcern class to a FHIR object.
   * The FHIR is expected to be valid against the DietNutritionConcern FHIR profile, but no validation checks are performed.
...
export default DietNutritionConcern;
