...
class SubstanceUse extends BehavioralFinding {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/behavior/SubstanceUse' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the SubstanceUse class to a FHIR object.
   * The FHIR is expected to be valid against the SubstanceUse FHIR profile, but no validation checks are performed.
