...
class IntravenousDrugUse extends SubstanceUse {
  ...
  /**
   * Serializes an instance of the IntravenousDrugUse class to a FHIR object.
   * The FHIR is expected to be valid against the IntravenousDrugUse FHIR profile, but no validation checks are performed.
