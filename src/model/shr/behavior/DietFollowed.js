...
/**
 * Generated class for shr.behavior.DietFollowed.
 * @extends QuestionAnswer
 */
class DietFollowed extends QuestionAnswer {
  ...
  /**
   * Deserializes JSON data to an instance of the DietFollowed class.
   * The JSON must be valid against the DietFollowed JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {DietFollowed} An instance of DietFollowed populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new DietFollowed();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the DietFollowed class to a JSON object.
   * The JSON is expected to be valid against the DietFollowed JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/behavior/DietFollowed' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the DietFollowed class to a FHIR object.
   * The FHIR is expected to be valid against the DietFollowed FHIR profile, but no validation checks are performed.
