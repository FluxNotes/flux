...
/**
 * Generated class for shr.behavior.AlcoholBingeFrequency.
 * @extends QuestionAnswer
 */
class AlcoholBingeFrequency extends QuestionAnswer {
   ...
   * This field/value is required.
   * @param {CodeableConcept} value - The shr.core.CodeableConcept
   * @returns {AlcoholBingeFrequency} this.
   */
  withValue(value) {
  ...
  /**
   * Deserializes JSON data to an instance of the AlcoholBingeFrequency class.
   * The JSON must be valid against the AlcoholBingeFrequency JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {AlcoholBingeFrequency} An instance of AlcoholBingeFrequency populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new AlcoholBingeFrequency();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the AlcoholBingeFrequency class to a JSON object.
   * The JSON is expected to be valid against the AlcoholBingeFrequency JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/behavior/AlcoholBingeFrequency' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the AlcoholBingeFrequency class to a FHIR object.
   * The FHIR is expected to be valid against the AlcoholBingeFrequency FHIR profile, but no validation checks are performed.
...
export default AlcoholBingeFrequency;
