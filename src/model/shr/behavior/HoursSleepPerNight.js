...
class HoursSleepPerNight extends QuestionAnswer {
  ...
  /**
   * Serializes an instance of the HoursSleepPerNight class to a FHIR object.
   * The FHIR is expected to be valid against the HoursSleepPerNight FHIR profile, but no validation checks are performed.
