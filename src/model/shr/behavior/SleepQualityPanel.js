...
class SleepQualityPanel extends Observation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {SleepQualityPanel} this.
   */
  ...
  /**
   * Serializes an instance of the SleepQualityPanel class to a JSON object.
   * The JSON is expected to be valid against the SleepQualityPanel JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/behavior/SleepQualityPanel' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the SleepQualityPanel class to a FHIR object.
   * The FHIR is expected to be valid against the SleepQualityPanel FHIR profile, but no validation checks are performed.
