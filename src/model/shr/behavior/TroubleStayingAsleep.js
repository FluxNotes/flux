...
/**
 * Generated class for shr.behavior.TroubleStayingAsleep.
 * @extends QuestionAnswer
 */
class TroubleStayingAsleep extends QuestionAnswer {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {TroubleStayingAsleep} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the TroubleStayingAsleep class.
   * The JSON must be valid against the TroubleStayingAsleep JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {TroubleStayingAsleep} An instance of TroubleStayingAsleep populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new TroubleStayingAsleep();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the TroubleStayingAsleep class to a JSON object.
   * The JSON is expected to be valid against the TroubleStayingAsleep JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/behavior/TroubleStayingAsleep' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the TroubleStayingAsleep class to a FHIR object.
   * The FHIR is expected to be valid against the TroubleStayingAsleep FHIR profile, but no validation checks are performed.
...
export default TroubleStayingAsleep;
