...
/**
 * Generated class for shr.behavior.TroubleFallingAsleep.
 * @extends QuestionAnswer
 */
class TroubleFallingAsleep extends QuestionAnswer {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {TroubleFallingAsleep} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the TroubleFallingAsleep class.
   * The JSON must be valid against the TroubleFallingAsleep JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {TroubleFallingAsleep} An instance of TroubleFallingAsleep populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new TroubleFallingAsleep();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the TroubleFallingAsleep class to a JSON object.
   * The JSON is expected to be valid against the TroubleFallingAsleep JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/behavior/TroubleFallingAsleep' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the TroubleFallingAsleep class to a FHIR object.
   * The FHIR is expected to be valid against the TroubleFallingAsleep FHIR profile, but no validation checks are performed.
...
export default TroubleFallingAsleep;
