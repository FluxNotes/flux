...
/**
 * Generated class for shr.behavior.ONCSmokingStatus.
 * @extends BehavioralFinding
 */
class ONCSmokingStatus extends BehavioralFinding {
  ...
  /**
   * Deserializes JSON data to an instance of the ONCSmokingStatus class.
   * The JSON must be valid against the ONCSmokingStatus JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {ONCSmokingStatus} An instance of ONCSmokingStatus populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new ONCSmokingStatus();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the ONCSmokingStatus class to a JSON object.
   * The JSON is expected to be valid against the ONCSmokingStatus JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/behavior/ONCSmokingStatus' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the ONCSmokingStatus class to a FHIR object.
   * The FHIR is expected to be valid against the ONCSmokingStatus FHIR profile, but no validation checks are performed.
