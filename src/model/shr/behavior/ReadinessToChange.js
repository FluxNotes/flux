...
class ReadinessToChange extends ObservationComponent {
   ...
   * This field/value is required.
   * @param {CodeableConcept} value - The shr.core.CodeableConcept
   * @returns {ReadinessToChange} this.
   */
  withValue(value) {
  ...
  /**
   * Serializes an instance of the ReadinessToChange class to a JSON object.
   * The JSON is expected to be valid against the ReadinessToChange JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/behavior/ReadinessToChange' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the ReadinessToChange class to a FHIR object.
   * The FHIR is expected to be valid against the ReadinessToChange FHIR profile, but no validation checks are performed.
  ...
  toFHIR(asExtension = false) {
    ...
    if (asExtension) {
      ...
      inst['url'] = 'http://standardhealthrecord.org/fhir/StructureDefinition/shr-behavior-ReadinessToChange-extension';
    }
