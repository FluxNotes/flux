...
class AlcoholUse extends SubstanceUse {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/behavior/AlcoholUse' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the AlcoholUse class to a FHIR object.
   * The FHIR is expected to be valid against the AlcoholUse FHIR profile, but no validation checks are performed.
