...
/**
 * Generated class for shr.behavior.Religion.
 * @extends BehavioralFinding
 */
class Religion extends BehavioralFinding {
  ...
  /**
   * Deserializes JSON data to an instance of the Religion class.
   * The JSON must be valid against the Religion JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {Religion} An instance of Religion populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new Religion();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the Religion class to a JSON object.
   * The JSON is expected to be valid against the Religion JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/behavior/Religion' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the Religion class to a FHIR object.
   * The FHIR is expected to be valid against the Religion FHIR profile, but no validation checks are performed.
