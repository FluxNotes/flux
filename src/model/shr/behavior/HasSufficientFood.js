...
/**
 * Generated class for shr.behavior.HasSufficientFood.
 * @extends QuestionAnswer
 */
class HasSufficientFood extends QuestionAnswer {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {HasSufficientFood} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the HasSufficientFood class.
   * The JSON must be valid against the HasSufficientFood JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {HasSufficientFood} An instance of HasSufficientFood populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new HasSufficientFood();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the HasSufficientFood class to a JSON object.
   * The JSON is expected to be valid against the HasSufficientFood JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/behavior/HasSufficientFood' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the HasSufficientFood class to a FHIR object.
   * The FHIR is expected to be valid against the HasSufficientFood FHIR profile, but no validation checks are performed.
...
export default HasSufficientFood;
