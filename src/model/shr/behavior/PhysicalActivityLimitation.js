...
/**
 * Generated class for shr.behavior.PhysicalActivityLimitation.
 * @extends QuestionAnswer
 */
class PhysicalActivityLimitation extends QuestionAnswer {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {PhysicalActivityLimitation} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the PhysicalActivityLimitation class.
   * The JSON must be valid against the PhysicalActivityLimitation JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {PhysicalActivityLimitation} An instance of PhysicalActivityLimitation populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new PhysicalActivityLimitation();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the PhysicalActivityLimitation class to a JSON object.
   * The JSON is expected to be valid against the PhysicalActivityLimitation JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/behavior/PhysicalActivityLimitation' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the PhysicalActivityLimitation class to a FHIR object.
   * The FHIR is expected to be valid against the PhysicalActivityLimitation FHIR profile, but no validation checks are performed.
...
export default PhysicalActivityLimitation;
