...
import QuantitativeNonLaboratoryObservation from '../core/QuantitativeNonLaboratoryObservation';

/**
 * Generated class for shr.sdoh.NumberOfDependents.
 * @extends QuantitativeNonLaboratoryObservation
 */
class NumberOfDependents extends QuantitativeNonLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {NumberOfDependents} this.
   */
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'NumberOfDependents');
  ...
  /**
   * Serializes an instance of the NumberOfDependents class to a JSON object.
   * The JSON is expected to be valid against the NumberOfDependents JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/NumberOfDependents' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the NumberOfDependents class.
   * The FHIR must be valid against the NumberOfDependents FHIR profile, although this is not validated by the function.
   ...
   * @returns {NumberOfDependents} An instance of NumberOfDependents populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/NumberOfDependents', 'uri');
    if (fhir['meta'] != null) {
