...
/**
 * Generated class for shr.sdoh.DomesticViolence.
 * @extends CodedSocialHistoryObservation
 */
class DomesticViolence extends CodedSocialHistoryObservation {
  ...
  /**
   * Deserializes JSON data to an instance of the DomesticViolence class.
   * The JSON must be valid against the DomesticViolence JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {DomesticViolence} An instance of DomesticViolence populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'DomesticViolence');
  ...
  /**
   * Serializes an instance of the DomesticViolence class to a JSON object.
   * The JSON is expected to be valid against the DomesticViolence JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/DomesticViolence' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the DomesticViolence class.
   * The FHIR must be valid against the DomesticViolence FHIR profile, although this is not validated by the function.
   ...
   * @returns {DomesticViolence} An instance of DomesticViolence populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/DomesticViolence', 'uri');
    if (fhir['meta'] != null) {
