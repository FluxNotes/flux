...
/**
 * Generated class for shr.sdoh.EducationalAttainment.
 * @extends CodedSocialHistoryObservation
 */
class EducationalAttainment extends CodedSocialHistoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {EducationalAttainment} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the EducationalAttainment class.
   * The JSON must be valid against the EducationalAttainment JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {EducationalAttainment} An instance of EducationalAttainment populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'EducationalAttainment');
  ...
  /**
   * Serializes an instance of the EducationalAttainment class to a JSON object.
   * The JSON is expected to be valid against the EducationalAttainment JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/EducationalAttainment' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the EducationalAttainment class.
   * The FHIR must be valid against the EducationalAttainment FHIR profile, although this is not validated by the function.
   ...
   * @returns {EducationalAttainment} An instance of EducationalAttainment populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/EducationalAttainment', 'uri');
    if (fhir['meta'] != null) {
