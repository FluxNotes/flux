...
/**
 * Generated class for shr.sdoh.HouseholdIncome.
 * @extends SocialHistoryObservation
 */
class HouseholdIncome extends SocialHistoryObservation {
  ...
  /**
   * Deserializes JSON data to an instance of the HouseholdIncome class.
   * The JSON must be valid against the HouseholdIncome JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {HouseholdIncome} An instance of HouseholdIncome populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'HouseholdIncome');
  ...
  /**
   * Serializes an instance of the HouseholdIncome class to a JSON object.
   * The JSON is expected to be valid against the HouseholdIncome JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/HouseholdIncome' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the HouseholdIncome class.
   * The FHIR must be valid against the HouseholdIncome FHIR profile, although this is not validated by the function.
   ...
   * @returns {HouseholdIncome} An instance of HouseholdIncome populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/HouseholdIncome', 'uri');
    if (fhir['meta'] != null) {
