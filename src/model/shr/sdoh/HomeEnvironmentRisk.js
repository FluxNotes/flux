...
/**
 * Generated class for shr.sdoh.HomeEnvironmentRisk.
 * @extends CodedSocialHistoryObservation
 */
class HomeEnvironmentRisk extends CodedSocialHistoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {HomeEnvironmentRisk} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the HomeEnvironmentRisk class.
   * The JSON must be valid against the HomeEnvironmentRisk JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {HomeEnvironmentRisk} An instance of HomeEnvironmentRisk populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'HomeEnvironmentRisk');
  ...
  /**
   * Serializes an instance of the HomeEnvironmentRisk class to a JSON object.
   * The JSON is expected to be valid against the HomeEnvironmentRisk JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/HomeEnvironmentRisk' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the HomeEnvironmentRisk class.
   * The FHIR must be valid against the HomeEnvironmentRisk FHIR profile, although this is not validated by the function.
   ...
   * @returns {HomeEnvironmentRisk} An instance of HomeEnvironmentRisk populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/HomeEnvironmentRisk', 'uri');
    if (fhir['meta'] != null) {
...
export default HomeEnvironmentRisk;
