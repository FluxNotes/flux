...
/**
 * Generated class for shr.sdoh.IntravenousDrugUse.
...
class IntravenousDrugUse extends SubstanceUse {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'IntravenousDrugUse');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/IntravenousDrugUse' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the IntravenousDrugUse class.
   * The FHIR must be valid against the IntravenousDrugUse FHIR profile, although this is not validated by the function.
   ...
   * @returns {IntravenousDrugUse} An instance of IntravenousDrugUse populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/IntravenousDrugUse', 'uri');
    if (fhir['meta'] != null) {
