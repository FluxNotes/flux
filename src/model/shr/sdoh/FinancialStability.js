...
import SocialHistoryObservation from '../core/SocialHistoryObservation';

/**
 * Generated class for shr.sdoh.FinancialStability.
 * @extends SocialHistoryObservation
 */
class FinancialStability extends SocialHistoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {FinancialStability} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the FinancialStability class.
   * The JSON must be valid against the FinancialStability JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {FinancialStability} An instance of FinancialStability populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'FinancialStability');
  ...
  /**
   * Serializes an instance of the FinancialStability class to a JSON object.
   * The JSON is expected to be valid against the FinancialStability JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/FinancialStability' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the FinancialStability class.
   * The FHIR must be valid against the FinancialStability FHIR profile, although this is not validated by the function.
   ...
   * @returns {FinancialStability} An instance of FinancialStability populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/FinancialStability', 'uri');
    if (fhir['meta'] != null) {
