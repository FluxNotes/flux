...
/**
 * Generated class for shr.sdoh.NicotineExposure.
 * @extends SubstanceUse
 */
class NicotineExposure extends SubstanceUse {
  ...
  /**
   * Deserializes JSON data to an instance of the NicotineExposure class.
   * The JSON must be valid against the NicotineExposure JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {NicotineExposure} An instance of NicotineExposure populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'NicotineExposure');
  ...
  /**
   * Serializes an instance of the NicotineExposure class to a JSON object.
   * The JSON is expected to be valid against the NicotineExposure JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/NicotineExposure' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the NicotineExposure class.
   * The FHIR must be valid against the NicotineExposure FHIR profile, although this is not validated by the function.
   ...
   * @returns {NicotineExposure} An instance of NicotineExposure populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/NicotineExposure', 'uri');
    if (fhir['meta'] != null) {
...
export default NicotineExposure;
