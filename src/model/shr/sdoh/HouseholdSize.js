...
/**
 * Generated class for shr.sdoh.HouseholdSize.
 * @extends CodedSocialHistoryObservation
 */
class HouseholdSize extends CodedSocialHistoryObservation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'HouseholdSize');
  ...
  /**
   * Serializes an instance of the HouseholdSize class to a JSON object.
   * The JSON is expected to be valid against the HouseholdSize JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/HouseholdSize' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the HouseholdSize class.
   * The FHIR must be valid against the HouseholdSize FHIR profile, although this is not validated by the function.
   ...
   * @returns {HouseholdSize} An instance of HouseholdSize populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/HouseholdSize', 'uri');
    if (fhir['meta'] != null) {
