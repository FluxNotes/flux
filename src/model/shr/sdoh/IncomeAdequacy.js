...
/**
 * Generated class for shr.sdoh.IncomeAdequacy.
 * @extends NonLaboratoryObservation
 */
class IncomeAdequacy extends NonLaboratoryObservation {
  ...
  /**
   * Deserializes JSON data to an instance of the IncomeAdequacy class.
   * The JSON must be valid against the IncomeAdequacy JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {IncomeAdequacy} An instance of IncomeAdequacy populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'IncomeAdequacy');
  ...
  /**
   * Serializes an instance of the IncomeAdequacy class to a JSON object.
   * The JSON is expected to be valid against the IncomeAdequacy JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/IncomeAdequacy' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the IncomeAdequacy class.
   * The FHIR must be valid against the IncomeAdequacy FHIR profile, although this is not validated by the function.
   ...
   * @returns {IncomeAdequacy} An instance of IncomeAdequacy populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/IncomeAdequacy', 'uri');
    if (fhir['meta'] != null) {
