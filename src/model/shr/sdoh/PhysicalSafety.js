...
/**
 * Generated class for shr.sdoh.PhysicalSafety.
 * @extends SocialHistoryObservation
 */
class PhysicalSafety extends SocialHistoryObservation {
  ...
  /**
   * Deserializes JSON data to an instance of the PhysicalSafety class.
   * The JSON must be valid against the PhysicalSafety JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {PhysicalSafety} An instance of PhysicalSafety populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'PhysicalSafety');
  ...
  /**
   * Serializes an instance of the PhysicalSafety class to a JSON object.
   * The JSON is expected to be valid against the PhysicalSafety JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/PhysicalSafety' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the PhysicalSafety class.
   * The FHIR must be valid against the PhysicalSafety FHIR profile, although this is not validated by the function.
   ...
   * @returns {PhysicalSafety} An instance of PhysicalSafety populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/PhysicalSafety', 'uri');
    if (fhir['meta'] != null) {
