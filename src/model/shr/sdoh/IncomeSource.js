...
/**
 * Generated class for shr.sdoh.IncomeSource.
 * @extends SocialHistoryObservation
 */
class IncomeSource extends SocialHistoryObservation {
  ...
  /**
   * Deserializes JSON data to an instance of the IncomeSource class.
   * The JSON must be valid against the IncomeSource JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {IncomeSource} An instance of IncomeSource populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'IncomeSource');
  ...
  /**
   * Serializes an instance of the IncomeSource class to a JSON object.
   * The JSON is expected to be valid against the IncomeSource JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/IncomeSource' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the IncomeSource class.
   * The FHIR must be valid against the IncomeSource FHIR profile, although this is not validated by the function.
   ...
   * @returns {IncomeSource} An instance of IncomeSource populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/IncomeSource', 'uri');
    if (fhir['meta'] != null) {
