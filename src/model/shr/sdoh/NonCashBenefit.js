...
/**
 * Generated class for shr.sdoh.NonCashBenefit.
 * @extends SocialHistoryObservation
 */
class NonCashBenefit extends SocialHistoryObservation {
  ...
  /**
   * Deserializes JSON data to an instance of the NonCashBenefit class.
   * The JSON must be valid against the NonCashBenefit JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {NonCashBenefit} An instance of NonCashBenefit populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'NonCashBenefit');
  ...
  /**
   * Serializes an instance of the NonCashBenefit class to a JSON object.
   * The JSON is expected to be valid against the NonCashBenefit JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/NonCashBenefit' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the NonCashBenefit class.
   * The FHIR must be valid against the NonCashBenefit FHIR profile, although this is not validated by the function.
   ...
   * @returns {NonCashBenefit} An instance of NonCashBenefit populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/NonCashBenefit', 'uri');
    if (fhir['meta'] != null) {
