...
/**
 * Generated class for shr.sdoh.Coinhabitant.
 * @extends CodedSocialHistoryObservation
 */
class Coinhabitant extends CodedSocialHistoryObservation {
  ...
  /**
   * Deserializes JSON data to an instance of the Coinhabitant class.
   * The JSON must be valid against the Coinhabitant JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {Coinhabitant} An instance of Coinhabitant populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'Coinhabitant');
  ...
  /**
   * Serializes an instance of the Coinhabitant class to a JSON object.
   * The JSON is expected to be valid against the Coinhabitant JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/Coinhabitant' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the Coinhabitant class.
   * The FHIR must be valid against the Coinhabitant FHIR profile, although this is not validated by the function.
   ...
   * @returns {Coinhabitant} An instance of Coinhabitant populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/Coinhabitant', 'uri');
    if (fhir['meta'] != null) {
