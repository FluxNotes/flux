...
/**
 * Generated class for shr.sdoh.EmotionalSafety.
 * @extends CodedSocialHistoryObservation
 */
class EmotionalSafety extends CodedSocialHistoryObservation {
  ...
  /**
   * Deserializes JSON data to an instance of the EmotionalSafety class.
   * The JSON must be valid against the EmotionalSafety JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {EmotionalSafety} An instance of EmotionalSafety populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'EmotionalSafety');
  ...
  /**
   * Serializes an instance of the EmotionalSafety class to a JSON object.
   * The JSON is expected to be valid against the EmotionalSafety JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/EmotionalSafety' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the EmotionalSafety class.
   * The FHIR must be valid against the EmotionalSafety FHIR profile, although this is not validated by the function.
   ...
   * @returns {EmotionalSafety} An instance of EmotionalSafety populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/EmotionalSafety', 'uri');
    if (fhir['meta'] != null) {
