...
/**
 * Generated class for shr.sdoh.AlcoholBingeEpisodes.
 * @extends SubstanceUse
 */
class AlcoholBingeEpisodes extends SubstanceUse {
   ...
   * This field/value is required.
   * @param {Code} code - The shr.core.Code
   * @returns {AlcoholBingeEpisodes} this.
   */
  withCode(code) {
  ...
  /**
   * Deserializes JSON data to an instance of the AlcoholBingeEpisodes class.
   * The JSON must be valid against the AlcoholBingeEpisodes JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {AlcoholBingeEpisodes} An instance of AlcoholBingeEpisodes populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'AlcoholBingeEpisodes');
  ...
  /**
   * Serializes an instance of the AlcoholBingeEpisodes class to a JSON object.
   * The JSON is expected to be valid against the AlcoholBingeEpisodes JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/AlcoholBingeEpisodes' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the AlcoholBingeEpisodes class.
   * The FHIR must be valid against the AlcoholBingeEpisodes FHIR profile, although this is not validated by the function.
   ...
   * @returns {AlcoholBingeEpisodes} An instance of AlcoholBingeEpisodes populated with the FHIR data
   */
...
export default AlcoholBingeEpisodes;
