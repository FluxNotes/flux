...
/**
 * Generated class for shr.sdoh.ForeignCountryOfTravelTwoYears.
 * @extends CodedSocialHistoryObservation
 */
class ForeignCountryOfTravelTwoYears extends CodedSocialHistoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {ForeignCountryOfTravelTwoYears} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the ForeignCountryOfTravelTwoYears class.
   * The JSON must be valid against the ForeignCountryOfTravelTwoYears JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {ForeignCountryOfTravelTwoYears} An instance of ForeignCountryOfTravelTwoYears populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'ForeignCountryOfTravelTwoYears');
  ...
  /**
   * Serializes an instance of the ForeignCountryOfTravelTwoYears class to a JSON object.
   * The JSON is expected to be valid against the ForeignCountryOfTravelTwoYears JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/ForeignCountryOfTravelTwoYears' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ForeignCountryOfTravelTwoYears class.
   * The FHIR must be valid against the ForeignCountryOfTravelTwoYears FHIR profile, although this is not validated by the function.
   ...
   * @returns {ForeignCountryOfTravelTwoYears} An instance of ForeignCountryOfTravelTwoYears populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/ForeignCountryOfTravelTwoYears', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_modifierExtension of fhir['modifierExtension'] || []) {
      if (false) {
        inst.subjectOfInformationCode = FHIRHelper.createInstanceFromFHIR('shr.core.SubjectOfInformationCode', fhir_modifierExtension, 'Extension', shrId, allEntries, mappedResources, referencesOut, false);
      }
    }
...
export default ForeignCountryOfTravelTwoYears;
