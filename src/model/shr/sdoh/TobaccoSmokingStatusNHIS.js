...
import NicotineExposure from './NicotineExposure';

/**
 * Generated class for shr.sdoh.TobaccoSmokingStatusNHIS.
 * @extends NicotineExposure
 */
class TobaccoSmokingStatusNHIS extends NicotineExposure {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {TobaccoSmokingStatusNHIS} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the TobaccoSmokingStatusNHIS class.
   * The JSON must be valid against the TobaccoSmokingStatusNHIS JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {TobaccoSmokingStatusNHIS} An instance of TobaccoSmokingStatusNHIS populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'TobaccoSmokingStatusNHIS');
  ...
  /**
   * Serializes an instance of the TobaccoSmokingStatusNHIS class to a JSON object.
   * The JSON is expected to be valid against the TobaccoSmokingStatusNHIS JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/TobaccoSmokingStatusNHIS' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TobaccoSmokingStatusNHIS class.
   * The FHIR must be valid against the TobaccoSmokingStatusNHIS FHIR profile, although this is not validated by the function.
   ...
   * @returns {TobaccoSmokingStatusNHIS} An instance of TobaccoSmokingStatusNHIS populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/TobaccoSmokingStatusNHIS', 'uri');
    if (fhir['meta'] != null) {
...
export default TobaccoSmokingStatusNHIS;
