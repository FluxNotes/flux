...
import ObservationComponent from '../core/ObservationComponent';

/**
 * Generated class for shr.sdoh.ExposureAmount.
...
class ExposureAmount extends ObservationComponent {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'ExposureAmount');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/ExposureAmount' } };
    if (this.code != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ExposureAmount class.
   * The FHIR must be valid against the ExposureAmount FHIR profile, although this is not validated by the function.
   ...
   * @returns {ExposureAmount} An instance of ExposureAmount populated with the FHIR data
   */
