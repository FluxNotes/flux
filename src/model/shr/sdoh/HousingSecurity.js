...
/**
 * Generated class for shr.sdoh.HousingSecurity.
 * @extends CodedSocialHistoryObservation
 */
class HousingSecurity extends CodedSocialHistoryObservation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'HousingSecurity');
  ...
  /**
   * Serializes an instance of the HousingSecurity class to a JSON object.
   * The JSON is expected to be valid against the HousingSecurity JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/HousingSecurity' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the HousingSecurity class.
   * The FHIR must be valid against the HousingSecurity FHIR profile, although this is not validated by the function.
   ...
   * @returns {HousingSecurity} An instance of HousingSecurity populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/HousingSecurity', 'uri');
    if (fhir['meta'] != null) {
