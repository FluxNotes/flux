...
/**
 * Generated class for shr.sdoh.AlcoholUse.
...
class AlcoholUse extends SubstanceUse {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'AlcoholUse');
  ...
  /**
   * Serializes an instance of the AlcoholUse class to a JSON object.
   * The JSON is expected to be valid against the AlcoholUse JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/AlcoholUse' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the AlcoholUse class.
   * The FHIR must be valid against the AlcoholUse FHIR profile, although this is not validated by the function.
   ...
   * @returns {AlcoholUse} An instance of AlcoholUse populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/AlcoholUse', 'uri');
    if (fhir['meta'] != null) {
