...
/**
 * Generated class for shr.sdoh.ExposureRoute.
 * @extends CodedObservationComponent
 */
class ExposureRoute extends CodedObservationComponent {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'ExposureRoute');
  ...
  /**
   * Serializes an instance of the ExposureRoute class to a JSON object.
   * The JSON is expected to be valid against the ExposureRoute JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/ExposureRoute' } };
    if (this.code != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ExposureRoute class.
   * The FHIR must be valid against the ExposureRoute FHIR profile, although this is not validated by the function.
   ...
   * @returns {ExposureRoute} An instance of ExposureRoute populated with the FHIR data
   */
