...
/**
 * Generated class for shr.sdoh.SubstanceUse.
 * @extends UnprescribedExposure
 */
class SubstanceUse extends UnprescribedExposure {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'SubstanceUse');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/SubstanceUse' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the SubstanceUse class.
   * The FHIR must be valid against the SubstanceUse FHIR profile, although this is not validated by the function.
   ...
   * @returns {SubstanceUse} An instance of SubstanceUse populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/SubstanceUse', 'uri');
    if (fhir['meta'] != null) {
