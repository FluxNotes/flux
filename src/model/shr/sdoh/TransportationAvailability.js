...
import CodedSocialHistoryObservation from '../core/CodedSocialHistoryObservation';

/**
 * Generated class for shr.sdoh.TransportationAvailability.
 * @extends CodedSocialHistoryObservation
 */
class TransportationAvailability extends CodedSocialHistoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {TransportationAvailability} this.
   */
  ...
  /**
   * Get the SubjectOfInformationCode.
   * @returns {SubjectOfInformationCode} The shr.core.SubjectOfInformationCode
   */
  get subjectOfInformationCode() {
    return this._subjectOfInformationCode;
  }

  /**
   * Set the SubjectOfInformationCode.
   * @param {SubjectOfInformationCode} subjectOfInformationCode - The shr.core.SubjectOfInformationCode
   */
  set subjectOfInformationCode(subjectOfInformationCode) {
    this._subjectOfInformationCode = subjectOfInformationCode;
  }

  /**
   * Set the SubjectOfInformationCode and return 'this' for chaining.
   * @param {SubjectOfInformationCode} subjectOfInformationCode - The shr.core.SubjectOfInformationCode
   * @returns {TransportationAvailability} this.
   */
  withSubjectOfInformationCode(subjectOfInformationCode) {
    this.subjectOfInformationCode = subjectOfInformationCode; return this;
  }

  /**
   * Deserializes JSON data to an instance of the TransportationAvailability class.
   * The JSON must be valid against the TransportationAvailability JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {TransportationAvailability} An instance of TransportationAvailability populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.sdoh', 'TransportationAvailability');
  ...
  /**
   * Serializes an instance of the TransportationAvailability class to a JSON object.
   * The JSON is expected to be valid against the TransportationAvailability JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/sdoh/TransportationAvailability' };
    ...
    if (this.subjectOfInformationCode != null) {
      inst['SubjectOfInformationCode'] = typeof this.subjectOfInformationCode.toJSON === 'function' ? this.subjectOfInformationCode.toJSON() : this.subjectOfInformationCode;
    }
    return inst;
  }

  /**
   * Deserializes FHIR JSON data to an instance of the TransportationAvailability class.
   * The FHIR must be valid against the TransportationAvailability FHIR profile, although this is not validated by the function.
   ...
   * @returns {TransportationAvailability} An instance of TransportationAvailability populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/sdoh/TransportationAvailability', 'uri');
    if (fhir['meta'] != null) {
