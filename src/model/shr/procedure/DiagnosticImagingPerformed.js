...
/**
 * Generated class for shr.procedure.DiagnosticImagingPerformed.
 * @extends ProcedurePerformed
 */
class DiagnosticImagingPerformed extends ProcedurePerformed {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {DiagnosticImagingPerformed} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the DiagnosticImagingPerformed class.
   * The JSON must be valid against the DiagnosticImagingPerformed JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {DiagnosticImagingPerformed} An instance of DiagnosticImagingPerformed populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new DiagnosticImagingPerformed();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the DiagnosticImagingPerformed class to a JSON object.
   * The JSON is expected to be valid against the DiagnosticImagingPerformed JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/procedure/DiagnosticImagingPerformed' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the DiagnosticImagingPerformed class.
   * The FHIR must be valid against the DiagnosticImagingPerformed FHIR profile, although this is not validated by the function.
   ...
   * @returns {DiagnosticImagingPerformed} An instance of DiagnosticImagingPerformed populated with the FHIR data
   */
  static fromFHIR(fhir, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/procedure/DiagnosticImagingPerformed');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_notes of fhir['notes'] || []) {
      ...
      const inst_annotation = FHIRHelper.createInstanceFromFHIR('shr.core.Annotation', fhir_notes, shrId, allEntries, mappedResources, referencesOut, false);
...
export default DiagnosticImagingPerformed;
