...
class DiagnosticImagingPerformed extends ProcedurePerformed {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.procedure', 'DiagnosticImagingPerformed');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/procedure/DiagnosticImagingPerformed', 'uri');
    if (fhir['meta'] != null) {
