...
class UsingAccessDeviceCode {
   ...
   * This field/value is required.
   * @param {CodeableConcept} value - The shr.core.CodeableConcept
   * @returns {UsingAccessDeviceCode} this.
   */
  withValue(value) {
  ...
  /**
   * Serializes an instance of the UsingAccessDeviceCode class to a JSON object.
   * The JSON is expected to be valid against the UsingAccessDeviceCode JSON schema, but no validation checks are performed.
  ...
  /**
   * Serializes an instance of the UsingAccessDeviceCode class to a FHIR object.
   * The FHIR is expected to be valid against the UsingAccessDeviceCode FHIR profile, but no validation checks are performed.
  ...
  toFHIR(asExtension = false) {
    let inst = {};
    if (asExtension) {
      inst['url'] = 'http://standardhealthrecord.org/fhir/StructureDefinition/shr-procedure-UsingAccessDeviceCode-extension';
