...
class ImagingProcedurePerformed extends ProcedurePerformed {
  ...
  static fromFHIR(fhir, asExtension=false) {
    ...
    if (fhir['extension'] != null) {
      const match = fhir['extension'].find(e => e.url == 'http://example.com/fhir/StructureDefinition/shr-procedure-ImagingSubstance-extension');
      if (match != null) {
        inst.imagingSubstance = createInstanceFromFHIR('shr.procedure.ImagingSubstance', match, true);
      }
    }
