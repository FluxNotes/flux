...
class ImagingProcedurePerformed extends ProcedurePerformed {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.procedure', 'ImagingProcedurePerformed');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/procedure/ImagingProcedurePerformed', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_extension of fhir['extension'] || []) {
      ...
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/shr-procedure-ImagingSubstance-extension') {
        ...
        const inst_imagingSubstance = FHIRHelper.createInstanceFromFHIR('shr.procedure.ImagingSubstance', fhir_extension, 'Extension', shrId, allEntries, mappedResources, referencesOut, true);
