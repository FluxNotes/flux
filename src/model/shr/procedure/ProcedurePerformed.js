...
class ProcedurePerformed extends ActionPerformed {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.procedure', 'ProcedurePerformed');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/procedure/ProcedurePerformed', 'uri');
    if (fhir['meta'] != null) {
