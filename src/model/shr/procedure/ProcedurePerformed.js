...
class ProcedurePerformed extends ActionPerformed {
   ...
   * @returns {Array<FHIRProcedureParticipant>} The shr.procedure.FHIRProcedureParticipant array
   */
  get participant() {
   ...
   * @param {Array<FHIRProcedureParticipant>} participant - The shr.procedure.FHIRProcedureParticipant array
   */
