...
class HIVScreeningTestPerformed extends LaboratoryProcedurePerformed {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {HIVScreeningTestPerformed} this.
   */
  ...
  /**
   * Serializes an instance of the HIVScreeningTestPerformed class to a JSON object.
   * The JSON is expected to be valid against the HIVScreeningTestPerformed JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/procedure/HIVScreeningTestPerformed' };
  ...
  /**
   * Serializes an instance of the HIVScreeningTestPerformed class to a FHIR object.
   * The FHIR is expected to be valid against the HIVScreeningTestPerformed FHIR profile, but no validation checks are performed.
