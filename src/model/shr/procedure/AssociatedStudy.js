...
class AssociatedStudy {
  ...
  /**
   * Serializes an instance of the AssociatedStudy class to a FHIR object.
   * The FHIR is expected to be valid against the AssociatedStudy FHIR profile, but no validation checks are performed.
  ...
  toFHIR(asExtension = false) {
    let inst = {};
    if (asExtension) {
      inst['url'] = 'http://standardhealthrecord.org/fhir/StructureDefinition/shr-procedure-AssociatedStudy-extension';
