...
class SurgicalApproach {
  ...
  /**
   * Deserializes JSON data to an instance of the SurgicalApproach class.
   * The JSON must be valid against the SurgicalApproach JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {SurgicalApproach} An instance of SurgicalApproach populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.procedure', 'SurgicalApproach');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/procedure/SurgicalApproach' } };
    if (this.value != null) {
