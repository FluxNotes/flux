...
class LaboratoryProcedureRequested extends LaboratoryProcedure {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/procedure/LaboratoryProcedureRequested' };
  ...
  /**
   * Serializes an instance of the LaboratoryProcedureRequested class to a FHIR object.
   * The FHIR is expected to be valid against the LaboratoryProcedureRequested FHIR profile, but no validation checks are performed.
