...
class Access {
  ...
  /**
   * Serializes an instance of the Access class to a JSON object.
   * The JSON is expected to be valid against the Access JSON schema, but no validation checks are performed.
  ...
  /**
   * Serializes an instance of the Access class to a FHIR object.
   * The FHIR is expected to be valid against the Access FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the Access class.
   * The FHIR must be valid against the Access FHIR profile, although this is not validated by the function.
