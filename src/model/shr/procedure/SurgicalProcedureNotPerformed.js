...
class SurgicalProcedureNotPerformed extends SurgicalProcedure {
  ...
  /**
   * Serializes an instance of the SurgicalProcedureNotPerformed class to a FHIR object.
   * The FHIR is expected to be valid against the SurgicalProcedureNotPerformed FHIR profile, but no validation checks are performed.
