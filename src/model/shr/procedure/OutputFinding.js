...
class OutputFinding {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.procedure', 'OutputFinding');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    if (!asExtension && fhir != null) {
      inst.value = FHIRHelper.createInstanceFromFHIR('shr.base.Finding', fhir, fhirType, shrId, allEntries, mappedResources, referencesOut);
    }
    return inst;
  }
