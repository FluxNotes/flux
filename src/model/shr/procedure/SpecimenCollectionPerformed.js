  ...
  static fromFHIR(fhir, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    for (const fhir_extension of fhir['extension'] || []) {
      ...
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/shr-procedure-AmountOrSize-extension') {
        ...
        const inst_amountOrSize = FHIRHelper.createInstanceFromFHIR('shr.procedure.AmountOrSize', fhir_extension, shrId, allEntries, mappedResources, referencesOut, true);
