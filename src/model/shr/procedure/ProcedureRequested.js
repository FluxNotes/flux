...
class ProcedureRequested extends ActionRequested {
  ...
  static fromFHIR(fhir, asExtension=false) {
    ...
    if (fhir['extension'] != null) {
      const match = fhir['extension'].find(e => e.url == 'http://example.com/fhir/StructureDefinition/shr-core-Annotation-extension');
      if (match != null) {
        inst.annotation = createInstanceFromFHIR('shr.core.Annotation', match, true);
      }
    }
    if (fhir['extension'] != null) {
    ...
    if (fhir['occurrence[x]'] != null) {
      inst.expectedPerformanceTime = createInstanceFromFHIR('shr.base.ExpectedPerformanceTime', fhir['occurrence[x]']);
    }
