...
class ProcedureAction extends Action {
  ...
  /**
   * Serializes an instance of the ProcedureAction class to a FHIR object.
   * The FHIR is expected to be valid against the ProcedureAction FHIR profile, but no validation checks are performed.
