...
class SimpleLaboratoryObservation extends LaboratoryObservation {
  ...
  static fromFHIR(fhir, asExtension=false) {
    ...
    if (fhir['extension'] != null) {
      const match = fhir['extension'].find(e => e.url == 'http://example.com/fhir/StructureDefinition/shr-base-DiagnosticService-extension');
      if (match != null) {
        inst.diagnosticService = createInstanceFromFHIR('shr.base.DiagnosticService', match, true);
      }
    }
