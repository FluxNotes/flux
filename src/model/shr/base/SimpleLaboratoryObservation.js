...
/**
 * Generated class for shr.base.SimpleLaboratoryObservation.
...
class SimpleLaboratoryObservation extends LaboratoryObservation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/base/SimpleLaboratoryObservation' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the SimpleLaboratoryObservation class.
   * The FHIR must be valid against the SimpleLaboratoryObservation FHIR profile, although this is not validated by the function.
   ...
   * @returns {SimpleLaboratoryObservation} An instance of SimpleLaboratoryObservation populated with the FHIR data
   */
  static fromFHIR(fhir, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/base/SimpleLaboratoryObservation');
    if (fhir['meta'] != null) {
