...
/**
 * Generated class for shr.base.PatientOrPractitionerOrRelatedPerson.
 * @extends Participant
 */
class PatientOrPractitionerOrRelatedPerson extends Participant {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.base', 'PatientOrPractitionerOrRelatedPerson');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/base/PatientOrPractitionerOrRelatedPerson' } };
    if (this.value != null) {
