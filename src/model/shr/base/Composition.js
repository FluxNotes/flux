...
class Composition extends InformationItem {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.base', 'Composition');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/base/Composition', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_section of fhir['section'] || []) {
      ...
      const inst_section = FHIRHelper.createInstanceFromFHIR('shr.base.Section', fhir_section, 'BackboneElement', shrId, allEntries, mappedResources, referencesOut, false);
      ...
      for (const fhir_section_entry of fhir_section['entry'] || []) {
        ...
        if (!mappedResources[entryId]) {
          ...
          if (referencedEntry) {
            mappedResources[entryId] = FHIRHelper.createInstanceFromFHIR('DomainResource', referencedEntry['resource'], null, shrId, allEntries, mappedResources, referencesOut);
          }
        }
