...
export default class ShrBaseObjectFactory {
  ...
  static createInstanceFromFHIR(fhir, type, asExtension=false) {
    ...
    case 'NarrativeText': return NarrativeText.fromFHIR(fhir, asExtension);
    ...
    case 'Participation': return Participation.fromFHIR(fhir, asExtension);
    ...
    case 'StageInformation': return StageInformation.fromFHIR(fhir, asExtension);
    case 'StageSummary': return StageSummary.fromFHIR(fhir, asExtension);
