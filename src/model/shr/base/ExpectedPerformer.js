...
class ExpectedPerformer {
  ...
  /**
   * Get the choice value; one of: shr.entity.Entity reference, shr.entity.Organization reference.
   * @returns {Reference} The choice value; one of: shr.entity.Entity reference, shr.entity.Organization reference
   */
  get value() {
    return this._value;
  }
  ...
  /**
   * Set the choice value; one of: shr.entity.Entity reference, shr.entity.Organization reference.
   * This field/value is required.
   * @param {Reference} value - The choice value; one of: shr.entity.Entity reference, shr.entity.Organization reference
   */
  set value(value) {
    this._value = value;
  }
  ...
  /**
   * Set the choice value; one of: shr.entity.Entity reference, shr.entity.Organization reference and return 'this' for chaining.
   * This field/value is required.
   * @param {Reference} value - The choice value; one of: shr.entity.Entity reference, shr.entity.Organization reference
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/base/ExpectedPerformer' } };
    if (this.value != null) {
  ...
  toFHIR(asExtension=false) {
    let inst = {};
    if (asExtension) {
      inst['url'] = 'http://example.com/fhir/StructureDefinition/shr-base-ExpectedPerformer-extension';
    }
