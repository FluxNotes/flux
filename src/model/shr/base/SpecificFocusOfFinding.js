...
class SpecificFocusOfFinding {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.base', 'SpecificFocusOfFinding');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    if (!asExtension && fhir != null) {
      inst.value = FHIRHelper.createInstanceFromFHIR('shr.base.InformationItem', fhir, fhirType, shrId, allEntries, mappedResources, referencesOut);
    }
    return inst;
  }
