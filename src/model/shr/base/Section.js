...
class Section extends InformationItem {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.base', 'Section');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    for (const fhir_extension of fhir['extension'] || []) {
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/shr-base-InformationItem-extension') {
        ...
        const inst_informationItem = FHIRHelper.createInstanceFromFHIR('shr.base.InformationItem', fhir_extension, 'Extension', shrId, allEntries, mappedResources, referencesOut, true);
