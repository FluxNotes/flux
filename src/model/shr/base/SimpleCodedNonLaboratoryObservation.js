...
class SimpleCodedNonLaboratoryObservation extends CodedNonLaboratoryObservation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.base', 'SimpleCodedNonLaboratoryObservation');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/base/SimpleCodedNonLaboratoryObservation', 'uri');
    if (fhir['meta'] != null) {
