...
/**
 * Generated class for shr.base.CodedLaboratoryObservation.
...
class CodedLaboratoryObservation extends LaboratoryObservation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.base', 'CodedLaboratoryObservation');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/base/CodedLaboratoryObservation' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the CodedLaboratoryObservation class.
   * The FHIR must be valid against the CodedLaboratoryObservation FHIR profile, although this is not validated by the function.
   ...
   * @returns {CodedLaboratoryObservation} An instance of CodedLaboratoryObservation populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/base/CodedLaboratoryObservation', 'uri');
    if (fhir['meta'] != null) {
