...
class CodedNonLaboratoryObservation extends NonLaboratoryObservation {
  ...
  static fromFHIR(fhir, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/base/CodedNonLaboratoryObservation');
    if (fhir['meta'] != null) {
