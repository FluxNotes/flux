...
class NonLaboratoryObservation extends Observation {
  ...
  /**
   * Serializes an instance of the NonLaboratoryObservation class to a FHIR object.
   * The FHIR is expected to be valid against the NonLaboratoryObservation FHIR profile, but no validation checks are performed.
