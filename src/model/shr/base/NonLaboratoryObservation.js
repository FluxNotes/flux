...
class NonLaboratoryObservation extends Observation {
  ...
  static fromJSON(json={}) {
    const inst = new NonLaboratoryObservation();
  ...
  static fromFHIR(fhir, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/base/NonLaboratoryObservation');
    if (fhir['meta'] != null) {
