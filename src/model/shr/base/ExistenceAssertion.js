...
/**
 * Generated class for shr.base.ExistenceAssertion.
 * @extends Finding
 */
class ExistenceAssertion extends Finding {
   ...
   * @param {PresentOrAbsent} findingResult - The shr.base.PresentOrAbsent
   * @returns {ExistenceAssertion} this.
   */
   ...
   * @returns {ObjectIdentifier} The shr.base.ObjectIdentifier
   */
   ...
   * @param {ObjectIdentifier} objectIdentifier - The shr.base.ObjectIdentifier
   */
  ...
  /**
   * Set the ObjectIdentifier and return 'this' for chaining.
   * @param {ObjectIdentifier} objectIdentifier - The shr.base.ObjectIdentifier
   * @returns {ExistenceAssertion} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the ExistenceAssertion class.
   * The JSON must be valid against the ExistenceAssertion JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {ExistenceAssertion} An instance of ExistenceAssertion populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.base', 'ExistenceAssertion');
  ...
  /**
   * Serializes an instance of the ExistenceAssertion class to a JSON object.
   * The JSON is expected to be valid against the ExistenceAssertion JSON schema, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ExistenceAssertion class.
   * The FHIR must be valid against the ExistenceAssertion FHIR profile, although this is not validated by the function.
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    for (const fhir_extension of fhir['extension'] || []) {
      ...
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/shr-base-ObjectIdentifier-extension') {
        inst.objectIdentifier = FHIRHelper.createInstanceFromFHIR('shr.base.ObjectIdentifier', fhir_extension, 'Extension', shrId, allEntries, mappedResources, referencesOut, true);
      }
    }
    return inst;
  }
...
export default ExistenceAssertion;
