...
class ExistenceAssertion extends Finding {
  ...
  /**
   * Serializes an instance of the ExistenceAssertion class to a FHIR object.
   * The FHIR is expected to be valid against the ExistenceAssertion FHIR profile, but no validation checks are performed.
