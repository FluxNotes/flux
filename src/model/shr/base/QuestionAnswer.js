...
/**
 * Generated class for shr.base.QuestionAnswer.
 * @extends SimpleNonLaboratoryObservation
 */
class QuestionAnswer extends SimpleNonLaboratoryObservation {
   ...
   * @returns {QuestionText} The shr.base.QuestionText
   */
  get questionText() {
   ...
   * @param {QuestionText} questionText - The shr.base.QuestionText
   */
  ...
  /**
   * Set the QuestionText and return 'this' for chaining.
   * @param {QuestionText} questionText - The shr.base.QuestionText
   * @returns {QuestionAnswer} this.
   */
  withQuestionText(questionText) {
    this.questionText = questionText; return this;
  }
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/base/QuestionAnswer' };
    ...
    if (this.questionText != null) {
      inst['QuestionText'] = typeof this.questionText.toJSON === 'function' ? this.questionText.toJSON() : this.questionText;
    }
    return inst;
  }

  /**
   * Deserializes FHIR JSON data to an instance of the QuestionAnswer class.
   * The FHIR must be valid against the QuestionAnswer FHIR profile, although this is not validated by the function.
   ...
   * @returns {QuestionAnswer} An instance of QuestionAnswer populated with the FHIR data
   */
  static fromFHIR(fhir, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/base/QuestionAnswer');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_extension of fhir['extension'] || []) {
      ...
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/shr-base-QuestionText-extension') {
        inst.questionText = FHIRHelper.createInstanceFromFHIR('shr.base.QuestionText', fhir_extension, shrId, allEntries, mappedResources, referencesOut, true);
      }
    }
    if (fhir['status'] != null) {
