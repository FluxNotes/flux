...
class ExpectedMethod {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.base', 'ExpectedMethod');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    if (!asExtension && fhir != null) {
      inst.value = FHIRHelper.createInstanceFromFHIR('shr.base.Method', fhir, fhirType, shrId, allEntries, mappedResources, referencesOut);
    }
    return inst;
  }
