...
class RelatedEncounter {
  ...
  /**
   * Serializes an instance of the RelatedEncounter class to a FHIR object.
   * The FHIR is expected to be valid against the RelatedEncounter FHIR profile, but no validation checks are performed.
  ...
  toFHIR(asExtension = false) {
    let inst = {};
    if (asExtension) {
      inst['url'] = 'http://standardhealthrecord.org/fhir/StructureDefinition/shr-base-RelatedEncounter-extension';
