...
class ConditionAbsentAssertion extends AbsenceAssertion {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.base', 'ConditionAbsentAssertion');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/base/ConditionAbsentAssertion', 'uri');
    if (fhir['meta'] != null) {
