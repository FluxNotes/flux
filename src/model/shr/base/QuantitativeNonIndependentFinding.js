...
/**
 * Generated class for shr.base.QuantitativeNonIndependentFinding.
 * @extends NonIndependentFinding
 */
class QuantitativeNonIndependentFinding extends NonIndependentFinding {
   ...
   * @param {FindingResult} findingResult - The shr.base.FindingResult
   * @returns {QuantitativeNonIndependentFinding} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the QuantitativeNonIndependentFinding class.
   * The JSON must be valid against the QuantitativeNonIndependentFinding JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {QuantitativeNonIndependentFinding} An instance of QuantitativeNonIndependentFinding populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.base', 'QuantitativeNonIndependentFinding');
  ...
  /**
   * Serializes an instance of the QuantitativeNonIndependentFinding class to a JSON object.
   * The JSON is expected to be valid against the QuantitativeNonIndependentFinding JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/base/QuantitativeNonIndependentFinding' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the QuantitativeNonIndependentFinding class.
   * The FHIR must be valid against the QuantitativeNonIndependentFinding FHIR profile, although this is not validated by the function.
   ...
   * @returns {QuantitativeNonIndependentFinding} An instance of QuantitativeNonIndependentFinding populated with the FHIR data
   */
...
export default QuantitativeNonIndependentFinding;
