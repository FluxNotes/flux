...
/**
 * Generated class for shr.base.Criticality.
 */
class Criticality {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/base/Criticality' } };
    if (this.value != null) {
  ...
  toFHIR(asExtension = false) {
    let inst = {};
    if (asExtension) {
      inst['url'] = 'http://example.com/fhir/StructureDefinition/shr-base-Criticality-extension';
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the Criticality class.
   * The FHIR must be valid against the Criticality FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {Criticality} An instance of Criticality populated with the FHIR data
   */
