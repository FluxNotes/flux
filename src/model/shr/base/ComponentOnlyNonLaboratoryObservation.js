...
class ComponentOnlyNonLaboratoryObservation extends NonLaboratoryObservation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.base', 'ComponentOnlyNonLaboratoryObservation');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/base/ComponentOnlyNonLaboratoryObservation', 'uri');
    if (fhir['meta'] != null) {
