...
class ConditionPresentAssertion extends PresenceAssertion {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.base', 'ConditionPresentAssertion');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/base/ConditionPresentAssertion', 'uri');
    if (fhir['meta'] != null) {
