...
class Participant {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.base', 'Participant');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    if (!asExtension && fhir != null) {
      inst.value = FHIRHelper.createInstanceFromFHIR('shr.entity.EntityOrRole', fhir, fhirType, shrId, allEntries, mappedResources, referencesOut);
    }
    return inst;
  }
