...
class EntryId {
  ...
  /**
   * Serializes an instance of the EntryId class to a FHIR object.
   * The FHIR is expected to be valid against the EntryId FHIR profile, but no validation checks are performed.
