...
class ExceptionValue {
  ...
  /**
   * Serializes an instance of the ExceptionValue class to a FHIR object.
   * The FHIR is expected to be valid against the ExceptionValue FHIR profile, but no validation checks are performed.
  ...
  toFHIR(asExtension=false) {
    let inst = {};
    if (asExtension) {
      inst['url'] = 'http://example.com/fhir/StructureDefinition/shr-base-ExceptionValue-extension';
