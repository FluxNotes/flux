...
class RelatedPlan {
  ...
  /**
   * Serializes an instance of the RelatedPlan class to a FHIR object.
   * The FHIR is expected to be valid against the RelatedPlan FHIR profile, but no validation checks are performed.
  ...
  toFHIR(asExtension = false) {
    ...
    if (asExtension) {
      ...
      inst['url'] = 'http://standardhealthrecord.org/fhir/StructureDefinition/shr-action-RelatedPlan-extension';
    }
