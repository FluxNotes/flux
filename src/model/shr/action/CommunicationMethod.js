...
/**
 * Generated class for shr.action.CommunicationMethod.
 */
class CommunicationMethod {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/action/CommunicationMethod' } };
    if (this.value != null) {
  ...
  toFHIR(asExtension = false) {
    let inst = {};
    if (asExtension) {
      inst['url'] = 'http://standardhealthrecord.org/fhir/StructureDefinition/shr-action-CommunicationMethod-extension';
