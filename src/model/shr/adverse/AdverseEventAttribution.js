...
class AdverseEventAttribution {
  ...
  /**
   * Serializes an instance of the AdverseEventAttribution class to a FHIR object.
   * The FHIR is expected to be valid against the AdverseEventAttribution FHIR profile, but no validation checks are performed.
