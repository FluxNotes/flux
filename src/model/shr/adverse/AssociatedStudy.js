...
class AssociatedStudy {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.adverse', 'AssociatedStudy');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    if (!asExtension && fhir != null) {
      inst.value = FHIRHelper.createInstanceFromFHIR('shr.research.Study', fhir, fhirType, shrId, allEntries, mappedResources, referencesOut);
    }
    return inst;
  }
