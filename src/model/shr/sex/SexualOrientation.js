...
/**
 * Generated class for shr.sex.SexualOrientation.
 * @extends QuestionAnswer
 */
class SexualOrientation extends QuestionAnswer {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {SexualOrientation} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the SexualOrientation class.
   * The JSON must be valid against the SexualOrientation JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {SexualOrientation} An instance of SexualOrientation populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new SexualOrientation();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the SexualOrientation class to a JSON object.
   * The JSON is expected to be valid against the SexualOrientation JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/sex/SexualOrientation' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the SexualOrientation class to a FHIR object.
   * The FHIR is expected to be valid against the SexualOrientation FHIR profile, but no validation checks are performed.
