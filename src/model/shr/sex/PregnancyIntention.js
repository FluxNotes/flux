...
/**
 * Generated class for shr.sex.PregnancyIntention.
 * @extends QuestionAnswer
 */
class PregnancyIntention extends QuestionAnswer {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {PregnancyIntention} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the PregnancyIntention class.
   * The JSON must be valid against the PregnancyIntention JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {PregnancyIntention} An instance of PregnancyIntention populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new PregnancyIntention();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the PregnancyIntention class to a JSON object.
   * The JSON is expected to be valid against the PregnancyIntention JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/sex/PregnancyIntention' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the PregnancyIntention class to a FHIR object.
   * The FHIR is expected to be valid against the PregnancyIntention FHIR profile, but no validation checks are performed.
...
export default PregnancyIntention;
