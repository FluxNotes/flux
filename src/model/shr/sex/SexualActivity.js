...
/**
 * Generated class for shr.sex.SexualActivity.
 * @extends QuestionAnswer
 */
class SexualActivity extends QuestionAnswer {
  ...
  /**
   * Deserializes JSON data to an instance of the SexualActivity class.
   * The JSON must be valid against the SexualActivity JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {SexualActivity} An instance of SexualActivity populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new SexualActivity();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the SexualActivity class to a JSON object.
   * The JSON is expected to be valid against the SexualActivity JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/sex/SexualActivity' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the SexualActivity class to a FHIR object.
   * The FHIR is expected to be valid against the SexualActivity FHIR profile, but no validation checks are performed.
