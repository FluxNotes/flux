...
class NumberOfSexualPartnersPastYear extends QuestionAnswer {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {NumberOfSexualPartnersPastYear} this.
   */
  ...
  /**
   * Serializes an instance of the NumberOfSexualPartnersPastYear class to a JSON object.
   * The JSON is expected to be valid against the NumberOfSexualPartnersPastYear JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/sex/NumberOfSexualPartnersPastYear' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the NumberOfSexualPartnersPastYear class to a FHIR object.
   * The FHIR is expected to be valid against the NumberOfSexualPartnersPastYear FHIR profile, but no validation checks are performed.
