...
class ContraceptivesUsed extends QuestionAnswer {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {ContraceptivesUsed} this.
   */
  ...
  /**
   * Serializes an instance of the ContraceptivesUsed class to a JSON object.
   * The JSON is expected to be valid against the ContraceptivesUsed JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/sex/ContraceptivesUsed' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the ContraceptivesUsed class to a FHIR object.
   * The FHIR is expected to be valid against the ContraceptivesUsed FHIR profile, but no validation checks are performed.
