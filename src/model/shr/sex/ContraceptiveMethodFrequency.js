...
class ContraceptiveMethodFrequency extends ObservationComponent {
   ...
   * This field/value is required.
   * @param {CodeableConcept} value - The shr.core.CodeableConcept
   * @returns {ContraceptiveMethodFrequency} this.
   */
  withValue(value) {
  ...
  /**
   * Serializes an instance of the ContraceptiveMethodFrequency class to a JSON object.
   * The JSON is expected to be valid against the ContraceptiveMethodFrequency JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/sex/ContraceptiveMethodFrequency' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the ContraceptiveMethodFrequency class to a FHIR object.
   * The FHIR is expected to be valid against the ContraceptiveMethodFrequency FHIR profile, but no validation checks are performed.
