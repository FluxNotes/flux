...
class ContraceptiveMethodRequested extends ContraceptiveAction {
  ...
  /**
   * Serializes an instance of the ContraceptiveMethodRequested class to a FHIR object.
   * The FHIR is expected to be valid against the ContraceptiveMethodRequested FHIR profile, but no validation checks are performed.
