...
/**
 * Generated class for shr.sex.CurrentPregnancyStatus.
 * @extends QuestionAnswer
 */
class CurrentPregnancyStatus extends QuestionAnswer {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {CurrentPregnancyStatus} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the CurrentPregnancyStatus class.
   * The JSON must be valid against the CurrentPregnancyStatus JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {CurrentPregnancyStatus} An instance of CurrentPregnancyStatus populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new CurrentPregnancyStatus();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the CurrentPregnancyStatus class to a JSON object.
   * The JSON is expected to be valid against the CurrentPregnancyStatus JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/sex/CurrentPregnancyStatus' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the CurrentPregnancyStatus class to a FHIR object.
   * The FHIR is expected to be valid against the CurrentPregnancyStatus FHIR profile, but no validation checks are performed.
