...
class SexualBehavior extends QuestionAnswer {
  ...
  /**
   * Serializes an instance of the SexualBehavior class to a FHIR object.
   * The FHIR is expected to be valid against the SexualBehavior FHIR profile, but no validation checks are performed.
