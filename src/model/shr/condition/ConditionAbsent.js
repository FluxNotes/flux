...
/**
 * Generated class for shr.condition.ConditionAbsent.
 * @extends Observation
 */
class ConditionAbsent extends Observation {
  ...
  /**
   * Deserializes JSON data to an instance of the ConditionAbsent class.
   * The JSON must be valid against the ConditionAbsent JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {ConditionAbsent} An instance of ConditionAbsent populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new ConditionAbsent();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the ConditionAbsent class to a JSON object.
   * The JSON is expected to be valid against the ConditionAbsent JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/condition/ConditionAbsent' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the ConditionAbsent class to a FHIR object.
   * The FHIR is expected to be valid against the ConditionAbsent FHIR profile, but no validation checks are performed.
...
export default ConditionAbsent;
