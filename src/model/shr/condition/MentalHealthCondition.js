...
class MentalHealthCondition extends Condition {
  ...
  /**
   * Serializes an instance of the MentalHealthCondition class to a FHIR object.
   * The FHIR is expected to be valid against the MentalHealthCondition FHIR profile, but no validation checks are performed.
