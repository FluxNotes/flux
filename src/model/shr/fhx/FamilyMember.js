...
import RelatedPerson from '../core/RelatedPerson';

/**
 * Generated class for shr.fhx.FamilyMember.
...
class FamilyMember extends RelatedPerson {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.fhx', 'FamilyMember');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/fhx/FamilyMember' };
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/fhx/FamilyMember', 'uri');
    if (fhir['meta'] != null) {
