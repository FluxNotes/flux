...
/**
 * Generated class for shr.environment.CanAffordFood.
 * @extends QuestionAnswer
 */
class CanAffordFood extends QuestionAnswer {
  ...
  /**
   * Deserializes JSON data to an instance of the CanAffordFood class.
   * The JSON must be valid against the CanAffordFood JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {CanAffordFood} An instance of CanAffordFood populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new CanAffordFood();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the CanAffordFood class to a JSON object.
   * The JSON is expected to be valid against the CanAffordFood JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/CanAffordFood' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the CanAffordFood class to a FHIR object.
   * The FHIR is expected to be valid against the CanAffordFood FHIR profile, but no validation checks are performed.
