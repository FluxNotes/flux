...
/**
 * Generated class for shr.environment.EmotionalSafety.
 * @extends QuestionAnswer
 */
class EmotionalSafety extends QuestionAnswer {
  ...
  static fromJSON(json = {}) {
    const inst = new EmotionalSafety();
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/EmotionalSafety' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the EmotionalSafety class to a FHIR object.
   * The FHIR is expected to be valid against the EmotionalSafety FHIR profile, but no validation checks are performed.
