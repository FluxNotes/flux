...
/**
 * Generated class for shr.environment.Coinhabitant.
 * @extends QuestionAnswer
 */
class Coinhabitant extends QuestionAnswer {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/Coinhabitant' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the Coinhabitant class to a FHIR object.
   * The FHIR is expected to be valid against the Coinhabitant FHIR profile, but no validation checks are performed.
