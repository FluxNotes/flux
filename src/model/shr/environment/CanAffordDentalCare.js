...
/**
 * Generated class for shr.environment.CanAffordDentalCare.
 * @extends QuestionAnswer
 */
class CanAffordDentalCare extends QuestionAnswer {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {CanAffordDentalCare} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the CanAffordDentalCare class.
   * The JSON must be valid against the CanAffordDentalCare JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {CanAffordDentalCare} An instance of CanAffordDentalCare populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new CanAffordDentalCare();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the CanAffordDentalCare class to a JSON object.
   * The JSON is expected to be valid against the CanAffordDentalCare JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/CanAffordDentalCare' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the CanAffordDentalCare class to a FHIR object.
   * The FHIR is expected to be valid against the CanAffordDentalCare FHIR profile, but no validation checks are performed.
...
export default CanAffordDentalCare;
