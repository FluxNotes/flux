...
class HouseholdSize extends QuestionAnswer {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/HouseholdSize' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the HouseholdSize class to a FHIR object.
   * The FHIR is expected to be valid against the HouseholdSize FHIR profile, but no validation checks are performed.
