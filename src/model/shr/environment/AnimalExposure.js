...
class AnimalExposure extends ExposureToAgent {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/AnimalExposure' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the AnimalExposure class to a FHIR object.
   * The FHIR is expected to be valid against the AnimalExposure FHIR profile, but no validation checks are performed.
