...
/**
 * Generated class for shr.environment.CanAffordTransportation.
 * @extends QuestionAnswer
 */
class CanAffordTransportation extends QuestionAnswer {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {CanAffordTransportation} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the CanAffordTransportation class.
   * The JSON must be valid against the CanAffordTransportation JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {CanAffordTransportation} An instance of CanAffordTransportation populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new CanAffordTransportation();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the CanAffordTransportation class to a JSON object.
   * The JSON is expected to be valid against the CanAffordTransportation JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/CanAffordTransportation' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the CanAffordTransportation class to a FHIR object.
   * The FHIR is expected to be valid against the CanAffordTransportation FHIR profile, but no validation checks are performed.
...
export default CanAffordTransportation;
