...
/**
 * Generated class for shr.environment.HouseholdSituationPanel.
 * @extends QuestionAnswer
 */
class HouseholdSituationPanel extends QuestionAnswer {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {HouseholdSituationPanel} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the HouseholdSituationPanel class.
   * The JSON must be valid against the HouseholdSituationPanel JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {HouseholdSituationPanel} An instance of HouseholdSituationPanel populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new HouseholdSituationPanel();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the HouseholdSituationPanel class to a JSON object.
   * The JSON is expected to be valid against the HouseholdSituationPanel JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/HouseholdSituationPanel' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the HouseholdSituationPanel class to a FHIR object.
   * The FHIR is expected to be valid against the HouseholdSituationPanel FHIR profile, but no validation checks are performed.
...
export default HouseholdSituationPanel;
