...
/**
 * Generated class for shr.environment.CanAffordClothing.
 * @extends QuestionAnswer
 */
class CanAffordClothing extends QuestionAnswer {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {CanAffordClothing} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the CanAffordClothing class.
   * The JSON must be valid against the CanAffordClothing JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {CanAffordClothing} An instance of CanAffordClothing populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new CanAffordClothing();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the CanAffordClothing class to a JSON object.
   * The JSON is expected to be valid against the CanAffordClothing JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/CanAffordClothing' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the CanAffordClothing class to a FHIR object.
   * The FHIR is expected to be valid against the CanAffordClothing FHIR profile, but no validation checks are performed.
...
export default CanAffordClothing;
