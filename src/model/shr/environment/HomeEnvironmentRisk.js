...
/**
 * Generated class for shr.environment.HomeEnvironmentRisk.
 * @extends QuestionAnswer
 */
class HomeEnvironmentRisk extends QuestionAnswer {
  ...
  static fromJSON(json = {}) {
    const inst = new HomeEnvironmentRisk();
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/HomeEnvironmentRisk' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the HomeEnvironmentRisk class to a FHIR object.
   * The FHIR is expected to be valid against the HomeEnvironmentRisk FHIR profile, but no validation checks are performed.
