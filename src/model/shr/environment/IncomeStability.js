...
/**
 * Generated class for shr.environment.IncomeStability.
 * @extends QuestionAnswer
 */
class IncomeStability extends QuestionAnswer {
  ...
  /**
   * Deserializes JSON data to an instance of the IncomeStability class.
   * The JSON must be valid against the IncomeStability JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {IncomeStability} An instance of IncomeStability populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new IncomeStability();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the IncomeStability class to a JSON object.
   * The JSON is expected to be valid against the IncomeStability JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/IncomeStability' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the IncomeStability class to a FHIR object.
   * The FHIR is expected to be valid against the IncomeStability FHIR profile, but no validation checks are performed.
