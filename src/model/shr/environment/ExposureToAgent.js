...
/**
 * Generated class for shr.environment.ExposureToAgent.
 * @extends Observation
 */
class ExposureToAgent extends Observation {
  ...
  /**
   * Deserializes JSON data to an instance of the ExposureToAgent class.
   * The JSON must be valid against the ExposureToAgent JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {ExposureToAgent} An instance of ExposureToAgent populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new ExposureToAgent();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the ExposureToAgent class to a JSON object.
   * The JSON is expected to be valid against the ExposureToAgent JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/ExposureToAgent' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the ExposureToAgent class to a FHIR object.
   * The FHIR is expected to be valid against the ExposureToAgent FHIR profile, but no validation checks are performed.
...
export default ExposureToAgent;
