...
/**
 * Generated class for shr.environment.CanAffordHousing.
 * @extends QuestionAnswer
 */
class CanAffordHousing extends QuestionAnswer {
  ...
  /**
   * Deserializes JSON data to an instance of the CanAffordHousing class.
   * The JSON must be valid against the CanAffordHousing JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {CanAffordHousing} An instance of CanAffordHousing populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new CanAffordHousing();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the CanAffordHousing class to a JSON object.
   * The JSON is expected to be valid against the CanAffordHousing JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/CanAffordHousing' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the CanAffordHousing class to a FHIR object.
   * The FHIR is expected to be valid against the CanAffordHousing FHIR profile, but no validation checks are performed.
...
export default CanAffordHousing;
