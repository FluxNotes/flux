...
class ExposureMethod extends ObservationComponent {
  ...
  /**
   * Serializes an instance of the ExposureMethod class to a JSON object.
   * The JSON is expected to be valid against the ExposureMethod JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/ExposureMethod' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the ExposureMethod class to a FHIR object.
   * The FHIR is expected to be valid against the ExposureMethod FHIR profile, but no validation checks are performed.
