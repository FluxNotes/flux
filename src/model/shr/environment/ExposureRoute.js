...
class ExposureRoute extends ObservationComponent {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/ExposureRoute' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the ExposureRoute class to a FHIR object.
   * The FHIR is expected to be valid against the ExposureRoute FHIR profile, but no validation checks are performed.
