...
/**
 * Generated class for shr.environment.PhysicalSafety.
 * @extends QuestionAnswer
 */
class PhysicalSafety extends QuestionAnswer {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/PhysicalSafety' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the PhysicalSafety class to a FHIR object.
   * The FHIR is expected to be valid against the PhysicalSafety FHIR profile, but no validation checks are performed.
