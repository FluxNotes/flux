...
/**
 * Generated class for shr.environment.DomesticViolence.
 * @extends QuestionAnswer
 */
class DomesticViolence extends QuestionAnswer {
  ...
  static fromJSON(json = {}) {
    const inst = new DomesticViolence();
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/DomesticViolence' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the DomesticViolence class to a FHIR object.
   * The FHIR is expected to be valid against the DomesticViolence FHIR profile, but no validation checks are performed.
