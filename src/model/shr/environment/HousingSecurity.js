...
class HousingSecurity extends QuestionAnswer {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/HousingSecurity' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the HousingSecurity class to a FHIR object.
   * The FHIR is expected to be valid against the HousingSecurity FHIR profile, but no validation checks are performed.
