...
/**
 * Generated class for shr.environment.IncomeSource.
 * @extends QuestionAnswer
 */
class IncomeSource extends QuestionAnswer {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/IncomeSource' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the IncomeSource class to a FHIR object.
   * The FHIR is expected to be valid against the IncomeSource FHIR profile, but no validation checks are performed.
