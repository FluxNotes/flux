...
class CanAffordMedication extends QuestionAnswer {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/CanAffordMedication' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the CanAffordMedication class to a FHIR object.
   * The FHIR is expected to be valid against the CanAffordMedication FHIR profile, but no validation checks are performed.
