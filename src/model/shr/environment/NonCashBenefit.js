...
/**
 * Generated class for shr.environment.NonCashBenefit.
 * @extends QuestionAnswer
 */
class NonCashBenefit extends QuestionAnswer {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/NonCashBenefit' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the NonCashBenefit class to a FHIR object.
   * The FHIR is expected to be valid against the NonCashBenefit FHIR profile, but no validation checks are performed.
