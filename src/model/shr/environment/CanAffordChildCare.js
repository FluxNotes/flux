...
/**
 * Generated class for shr.environment.CanAffordChildCare.
 * @extends QuestionAnswer
 */
class CanAffordChildCare extends QuestionAnswer {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {CanAffordChildCare} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the CanAffordChildCare class.
   * The JSON must be valid against the CanAffordChildCare JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {CanAffordChildCare} An instance of CanAffordChildCare populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new CanAffordChildCare();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the CanAffordChildCare class to a JSON object.
   * The JSON is expected to be valid against the CanAffordChildCare JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/CanAffordChildCare' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the CanAffordChildCare class to a FHIR object.
   * The FHIR is expected to be valid against the CanAffordChildCare FHIR profile, but no validation checks are performed.
...
export default CanAffordChildCare;
