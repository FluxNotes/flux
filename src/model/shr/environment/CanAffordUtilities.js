...
/**
 * Generated class for shr.environment.CanAffordUtilities.
 * @extends QuestionAnswer
 */
class CanAffordUtilities extends QuestionAnswer {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {CanAffordUtilities} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the CanAffordUtilities class.
   * The JSON must be valid against the CanAffordUtilities JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {CanAffordUtilities} An instance of CanAffordUtilities populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new CanAffordUtilities();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the CanAffordUtilities class to a JSON object.
   * The JSON is expected to be valid against the CanAffordUtilities JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/CanAffordUtilities' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the CanAffordUtilities class to a FHIR object.
   * The FHIR is expected to be valid against the CanAffordUtilities FHIR profile, but no validation checks are performed.
...
export default CanAffordUtilities;
