...
class NumberOfDependents extends QuestionAnswer {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/environment/NumberOfDependents' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the NumberOfDependents class to a FHIR object.
   * The FHIR is expected to be valid against the NumberOfDependents FHIR profile, but no validation checks are performed.
