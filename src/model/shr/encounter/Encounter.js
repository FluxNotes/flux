...
class Encounter extends InformationItem {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.encounter', 'Encounter');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/encounter/Encounter', 'uri');
    if (fhir['meta'] != null) {
