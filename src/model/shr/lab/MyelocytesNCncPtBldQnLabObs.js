...
/**
 * Generated class for shr.lab.MyelocytesNCncPtBldQnLabObs.
 * @extends SimpleQuantitativeLaboratoryObservation
 */
class MyelocytesNCncPtBldQnLabObs extends SimpleQuantitativeLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {MyelocytesNCncPtBldQnLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the MyelocytesNCncPtBldQnLabObs class.
   * The JSON must be valid against the MyelocytesNCncPtBldQnLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {MyelocytesNCncPtBldQnLabObs} An instance of MyelocytesNCncPtBldQnLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'MyelocytesNCncPtBldQnLabObs');
  ...
  /**
   * Serializes an instance of the MyelocytesNCncPtBldQnLabObs class to a JSON object.
   * The JSON is expected to be valid against the MyelocytesNCncPtBldQnLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/MyelocytesNCncPtBldQnLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the MyelocytesNCncPtBldQnLabObs class.
   * The FHIR must be valid against the MyelocytesNCncPtBldQnLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {MyelocytesNCncPtBldQnLabObs} An instance of MyelocytesNCncPtBldQnLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/MyelocytesNCncPtBldQnLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default MyelocytesNCncPtBldQnLabObs;
