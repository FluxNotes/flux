...
/**
 * Generated class for shr.lab.Myelocytes100WBCNFrPtBldQnManCntLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class Myelocytes100WBCNFrPtBldQnManCntLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {Myelocytes100WBCNFrPtBldQnManCntLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the Myelocytes100WBCNFrPtBldQnManCntLabObs class.
   * The JSON must be valid against the Myelocytes100WBCNFrPtBldQnManCntLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {Myelocytes100WBCNFrPtBldQnManCntLabObs} An instance of Myelocytes100WBCNFrPtBldQnManCntLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'Myelocytes100WBCNFrPtBldQnManCntLabObs');
  ...
  /**
   * Serializes an instance of the Myelocytes100WBCNFrPtBldQnManCntLabObs class to a JSON object.
   * The JSON is expected to be valid against the Myelocytes100WBCNFrPtBldQnManCntLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/Myelocytes100WBCNFrPtBldQnManCntLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the Myelocytes100WBCNFrPtBldQnManCntLabObs class.
   * The FHIR must be valid against the Myelocytes100WBCNFrPtBldQnManCntLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {Myelocytes100WBCNFrPtBldQnManCntLabObs} An instance of Myelocytes100WBCNFrPtBldQnManCntLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/Myelocytes100WBCNFrPtBldQnManCntLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default Myelocytes100WBCNFrPtBldQnManCntLabObs;
