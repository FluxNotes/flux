...
import SimpleLaboratoryObservation from '../core/SimpleLaboratoryObservation';

/**
 * Generated class for shr.lab.MorphologyImpPtBldNarLabObs.
 * @extends SimpleLaboratoryObservation
 */
class MorphologyImpPtBldNarLabObs extends SimpleLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {MorphologyImpPtBldNarLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the MorphologyImpPtBldNarLabObs class.
   * The JSON must be valid against the MorphologyImpPtBldNarLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {MorphologyImpPtBldNarLabObs} An instance of MorphologyImpPtBldNarLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'MorphologyImpPtBldNarLabObs');
  ...
  /**
   * Serializes an instance of the MorphologyImpPtBldNarLabObs class to a JSON object.
   * The JSON is expected to be valid against the MorphologyImpPtBldNarLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/MorphologyImpPtBldNarLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the MorphologyImpPtBldNarLabObs class.
   * The FHIR must be valid against the MorphologyImpPtBldNarLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {MorphologyImpPtBldNarLabObs} An instance of MorphologyImpPtBldNarLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/MorphologyImpPtBldNarLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default MorphologyImpPtBldNarLabObs;
