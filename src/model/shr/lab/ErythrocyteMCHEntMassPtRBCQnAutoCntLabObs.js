...
/**
 * Generated class for shr.lab.ErythrocyteMCHEntMassPtRBCQnAutoCntLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class ErythrocyteMCHEntMassPtRBCQnAutoCntLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {ErythrocyteMCHEntMassPtRBCQnAutoCntLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the ErythrocyteMCHEntMassPtRBCQnAutoCntLabObs class.
   * The JSON must be valid against the ErythrocyteMCHEntMassPtRBCQnAutoCntLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {ErythrocyteMCHEntMassPtRBCQnAutoCntLabObs} An instance of ErythrocyteMCHEntMassPtRBCQnAutoCntLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'ErythrocyteMCHEntMassPtRBCQnAutoCntLabObs');
  ...
  /**
   * Serializes an instance of the ErythrocyteMCHEntMassPtRBCQnAutoCntLabObs class to a JSON object.
   * The JSON is expected to be valid against the ErythrocyteMCHEntMassPtRBCQnAutoCntLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/ErythrocyteMCHEntMassPtRBCQnAutoCntLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ErythrocyteMCHEntMassPtRBCQnAutoCntLabObs class.
   * The FHIR must be valid against the ErythrocyteMCHEntMassPtRBCQnAutoCntLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {ErythrocyteMCHEntMassPtRBCQnAutoCntLabObs} An instance of ErythrocyteMCHEntMassPtRBCQnAutoCntLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/ErythrocyteMCHEntMassPtRBCQnAutoCntLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default ErythrocyteMCHEntMassPtRBCQnAutoCntLabObs;
