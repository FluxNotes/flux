...
/**
 * Generated class for shr.lab.CreatinineMCncPtSerPlasQnLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class CreatinineMCncPtSerPlasQnLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {CreatinineMCncPtSerPlasQnLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the CreatinineMCncPtSerPlasQnLabObs class.
   * The JSON must be valid against the CreatinineMCncPtSerPlasQnLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {CreatinineMCncPtSerPlasQnLabObs} An instance of CreatinineMCncPtSerPlasQnLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'CreatinineMCncPtSerPlasQnLabObs');
  ...
  /**
   * Serializes an instance of the CreatinineMCncPtSerPlasQnLabObs class to a JSON object.
   * The JSON is expected to be valid against the CreatinineMCncPtSerPlasQnLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/CreatinineMCncPtSerPlasQnLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the CreatinineMCncPtSerPlasQnLabObs class.
   * The FHIR must be valid against the CreatinineMCncPtSerPlasQnLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {CreatinineMCncPtSerPlasQnLabObs} An instance of CreatinineMCncPtSerPlasQnLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/CreatinineMCncPtSerPlasQnLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default CreatinineMCncPtSerPlasQnLabObs;
