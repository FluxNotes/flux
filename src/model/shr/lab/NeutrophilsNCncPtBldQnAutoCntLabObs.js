...
/**
 * Generated class for shr.lab.NeutrophilsNCncPtBldQnAutoCntLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class NeutrophilsNCncPtBldQnAutoCntLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {NeutrophilsNCncPtBldQnAutoCntLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the NeutrophilsNCncPtBldQnAutoCntLabObs class.
   * The JSON must be valid against the NeutrophilsNCncPtBldQnAutoCntLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {NeutrophilsNCncPtBldQnAutoCntLabObs} An instance of NeutrophilsNCncPtBldQnAutoCntLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'NeutrophilsNCncPtBldQnAutoCntLabObs');
  ...
  /**
   * Serializes an instance of the NeutrophilsNCncPtBldQnAutoCntLabObs class to a JSON object.
   * The JSON is expected to be valid against the NeutrophilsNCncPtBldQnAutoCntLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/NeutrophilsNCncPtBldQnAutoCntLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the NeutrophilsNCncPtBldQnAutoCntLabObs class.
   * The FHIR must be valid against the NeutrophilsNCncPtBldQnAutoCntLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {NeutrophilsNCncPtBldQnAutoCntLabObs} An instance of NeutrophilsNCncPtBldQnAutoCntLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/NeutrophilsNCncPtBldQnAutoCntLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default NeutrophilsNCncPtBldQnAutoCntLabObs;
