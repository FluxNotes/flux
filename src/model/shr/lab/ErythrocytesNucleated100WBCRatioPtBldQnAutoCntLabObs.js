...
/**
 * Generated class for shr.lab.ErythrocytesNucleated100WBCRatioPtBldQnAutoCntLabObs.
 * @extends SimpleQuantitativeLaboratoryObservation
 */
class ErythrocytesNucleated100WBCRatioPtBldQnAutoCntLabObs extends SimpleQuantitativeLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {ErythrocytesNucleated100WBCRatioPtBldQnAutoCntLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the ErythrocytesNucleated100WBCRatioPtBldQnAutoCntLabObs class.
   * The JSON must be valid against the ErythrocytesNucleated100WBCRatioPtBldQnAutoCntLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {ErythrocytesNucleated100WBCRatioPtBldQnAutoCntLabObs} An instance of ErythrocytesNucleated100WBCRatioPtBldQnAutoCntLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'ErythrocytesNucleated100WBCRatioPtBldQnAutoCntLabObs');
  ...
  /**
   * Serializes an instance of the ErythrocytesNucleated100WBCRatioPtBldQnAutoCntLabObs class to a JSON object.
   * The JSON is expected to be valid against the ErythrocytesNucleated100WBCRatioPtBldQnAutoCntLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/ErythrocytesNucleated100WBCRatioPtBldQnAutoCntLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ErythrocytesNucleated100WBCRatioPtBldQnAutoCntLabObs class.
   * The FHIR must be valid against the ErythrocytesNucleated100WBCRatioPtBldQnAutoCntLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {ErythrocytesNucleated100WBCRatioPtBldQnAutoCntLabObs} An instance of ErythrocytesNucleated100WBCRatioPtBldQnAutoCntLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/ErythrocytesNucleated100WBCRatioPtBldQnAutoCntLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default ErythrocytesNucleated100WBCRatioPtBldQnAutoCntLabObs;
