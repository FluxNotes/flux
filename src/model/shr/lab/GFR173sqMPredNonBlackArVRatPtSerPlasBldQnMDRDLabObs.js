...
/**
 * Generated class for shr.lab.GFR173sqMPredNonBlackArVRatPtSerPlasBldQnMDRDLabObs.
 * @extends SimpleQuantitativeLaboratoryObservation
 */
class GFR173sqMPredNonBlackArVRatPtSerPlasBldQnMDRDLabObs extends SimpleQuantitativeLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {GFR173sqMPredNonBlackArVRatPtSerPlasBldQnMDRDLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the GFR173sqMPredNonBlackArVRatPtSerPlasBldQnMDRDLabObs class.
   * The JSON must be valid against the GFR173sqMPredNonBlackArVRatPtSerPlasBldQnMDRDLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {GFR173sqMPredNonBlackArVRatPtSerPlasBldQnMDRDLabObs} An instance of GFR173sqMPredNonBlackArVRatPtSerPlasBldQnMDRDLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'GFR173sqMPredNonBlackArVRatPtSerPlasBldQnMDRDLabObs');
  ...
  /**
   * Serializes an instance of the GFR173sqMPredNonBlackArVRatPtSerPlasBldQnMDRDLabObs class to a JSON object.
   * The JSON is expected to be valid against the GFR173sqMPredNonBlackArVRatPtSerPlasBldQnMDRDLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/GFR173sqMPredNonBlackArVRatPtSerPlasBldQnMDRDLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the GFR173sqMPredNonBlackArVRatPtSerPlasBldQnMDRDLabObs class.
   * The FHIR must be valid against the GFR173sqMPredNonBlackArVRatPtSerPlasBldQnMDRDLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {GFR173sqMPredNonBlackArVRatPtSerPlasBldQnMDRDLabObs} An instance of GFR173sqMPredNonBlackArVRatPtSerPlasBldQnMDRDLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/GFR173sqMPredNonBlackArVRatPtSerPlasBldQnMDRDLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default GFR173sqMPredNonBlackArVRatPtSerPlasBldQnMDRDLabObs;
