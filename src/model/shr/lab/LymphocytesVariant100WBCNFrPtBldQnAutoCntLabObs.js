...
/**
 * Generated class for shr.lab.LymphocytesVariant100WBCNFrPtBldQnAutoCntLabObs.
 * @extends SimpleQuantitativeLaboratoryObservation
 */
class LymphocytesVariant100WBCNFrPtBldQnAutoCntLabObs extends SimpleQuantitativeLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {LymphocytesVariant100WBCNFrPtBldQnAutoCntLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the LymphocytesVariant100WBCNFrPtBldQnAutoCntLabObs class.
   * The JSON must be valid against the LymphocytesVariant100WBCNFrPtBldQnAutoCntLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {LymphocytesVariant100WBCNFrPtBldQnAutoCntLabObs} An instance of LymphocytesVariant100WBCNFrPtBldQnAutoCntLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'LymphocytesVariant100WBCNFrPtBldQnAutoCntLabObs');
  ...
  /**
   * Serializes an instance of the LymphocytesVariant100WBCNFrPtBldQnAutoCntLabObs class to a JSON object.
   * The JSON is expected to be valid against the LymphocytesVariant100WBCNFrPtBldQnAutoCntLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/LymphocytesVariant100WBCNFrPtBldQnAutoCntLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the LymphocytesVariant100WBCNFrPtBldQnAutoCntLabObs class.
   * The FHIR must be valid against the LymphocytesVariant100WBCNFrPtBldQnAutoCntLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {LymphocytesVariant100WBCNFrPtBldQnAutoCntLabObs} An instance of LymphocytesVariant100WBCNFrPtBldQnAutoCntLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/LymphocytesVariant100WBCNFrPtBldQnAutoCntLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default LymphocytesVariant100WBCNFrPtBldQnAutoCntLabObs;
