...
/**
 * Generated class for shr.lab.NeutrophilsBandForm100WBCNFrPtBldQnManCntLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class NeutrophilsBandForm100WBCNFrPtBldQnManCntLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {NeutrophilsBandForm100WBCNFrPtBldQnManCntLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the NeutrophilsBandForm100WBCNFrPtBldQnManCntLabObs class.
   * The JSON must be valid against the NeutrophilsBandForm100WBCNFrPtBldQnManCntLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {NeutrophilsBandForm100WBCNFrPtBldQnManCntLabObs} An instance of NeutrophilsBandForm100WBCNFrPtBldQnManCntLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'NeutrophilsBandForm100WBCNFrPtBldQnManCntLabObs');
  ...
  /**
   * Serializes an instance of the NeutrophilsBandForm100WBCNFrPtBldQnManCntLabObs class to a JSON object.
   * The JSON is expected to be valid against the NeutrophilsBandForm100WBCNFrPtBldQnManCntLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/NeutrophilsBandForm100WBCNFrPtBldQnManCntLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the NeutrophilsBandForm100WBCNFrPtBldQnManCntLabObs class.
   * The FHIR must be valid against the NeutrophilsBandForm100WBCNFrPtBldQnManCntLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {NeutrophilsBandForm100WBCNFrPtBldQnManCntLabObs} An instance of NeutrophilsBandForm100WBCNFrPtBldQnManCntLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/NeutrophilsBandForm100WBCNFrPtBldQnManCntLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default NeutrophilsBandForm100WBCNFrPtBldQnManCntLabObs;
