...
/**
 * Generated class for shr.lab.BasophilsNCncPtBldQnAutoCntLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class BasophilsNCncPtBldQnAutoCntLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {BasophilsNCncPtBldQnAutoCntLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the BasophilsNCncPtBldQnAutoCntLabObs class.
   * The JSON must be valid against the BasophilsNCncPtBldQnAutoCntLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {BasophilsNCncPtBldQnAutoCntLabObs} An instance of BasophilsNCncPtBldQnAutoCntLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'BasophilsNCncPtBldQnAutoCntLabObs');
  ...
  /**
   * Serializes an instance of the BasophilsNCncPtBldQnAutoCntLabObs class to a JSON object.
   * The JSON is expected to be valid against the BasophilsNCncPtBldQnAutoCntLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/BasophilsNCncPtBldQnAutoCntLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the BasophilsNCncPtBldQnAutoCntLabObs class.
   * The FHIR must be valid against the BasophilsNCncPtBldQnAutoCntLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {BasophilsNCncPtBldQnAutoCntLabObs} An instance of BasophilsNCncPtBldQnAutoCntLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/BasophilsNCncPtBldQnAutoCntLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default BasophilsNCncPtBldQnAutoCntLabObs;
