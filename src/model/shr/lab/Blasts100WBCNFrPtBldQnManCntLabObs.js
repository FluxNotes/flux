...
/**
 * Generated class for shr.lab.Blasts100WBCNFrPtBldQnManCntLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class Blasts100WBCNFrPtBldQnManCntLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {Blasts100WBCNFrPtBldQnManCntLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the Blasts100WBCNFrPtBldQnManCntLabObs class.
   * The JSON must be valid against the Blasts100WBCNFrPtBldQnManCntLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {Blasts100WBCNFrPtBldQnManCntLabObs} An instance of Blasts100WBCNFrPtBldQnManCntLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'Blasts100WBCNFrPtBldQnManCntLabObs');
  ...
  /**
   * Serializes an instance of the Blasts100WBCNFrPtBldQnManCntLabObs class to a JSON object.
   * The JSON is expected to be valid against the Blasts100WBCNFrPtBldQnManCntLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/Blasts100WBCNFrPtBldQnManCntLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the Blasts100WBCNFrPtBldQnManCntLabObs class.
   * The FHIR must be valid against the Blasts100WBCNFrPtBldQnManCntLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {Blasts100WBCNFrPtBldQnManCntLabObs} An instance of Blasts100WBCNFrPtBldQnManCntLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/Blasts100WBCNFrPtBldQnManCntLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default Blasts100WBCNFrPtBldQnManCntLabObs;
