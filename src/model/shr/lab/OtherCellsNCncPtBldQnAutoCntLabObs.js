...
/**
 * Generated class for shr.lab.OtherCellsNCncPtBldQnAutoCntLabObs.
 * @extends SimpleQuantitativeLaboratoryObservation
 */
class OtherCellsNCncPtBldQnAutoCntLabObs extends SimpleQuantitativeLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {OtherCellsNCncPtBldQnAutoCntLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the OtherCellsNCncPtBldQnAutoCntLabObs class.
   * The JSON must be valid against the OtherCellsNCncPtBldQnAutoCntLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {OtherCellsNCncPtBldQnAutoCntLabObs} An instance of OtherCellsNCncPtBldQnAutoCntLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'OtherCellsNCncPtBldQnAutoCntLabObs');
  ...
  /**
   * Serializes an instance of the OtherCellsNCncPtBldQnAutoCntLabObs class to a JSON object.
   * The JSON is expected to be valid against the OtherCellsNCncPtBldQnAutoCntLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/OtherCellsNCncPtBldQnAutoCntLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the OtherCellsNCncPtBldQnAutoCntLabObs class.
   * The FHIR must be valid against the OtherCellsNCncPtBldQnAutoCntLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {OtherCellsNCncPtBldQnAutoCntLabObs} An instance of OtherCellsNCncPtBldQnAutoCntLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/OtherCellsNCncPtBldQnAutoCntLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default OtherCellsNCncPtBldQnAutoCntLabObs;
