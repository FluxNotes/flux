...
/**
 * Generated class for shr.lab.QuantityWithRequiredUnits.
 * @extends Quantity
 */
class QuantityWithRequiredUnits extends Quantity {
   ...
   * This field/value is required.
   * @param {Units} units - The shr.core.Units
   * @returns {QuantityWithRequiredUnits} this.
   */
  withUnits(units) {
  ...
  /**
   * Deserializes JSON data to an instance of the QuantityWithRequiredUnits class.
   * The JSON must be valid against the QuantityWithRequiredUnits JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {QuantityWithRequiredUnits} An instance of QuantityWithRequiredUnits populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'QuantityWithRequiredUnits');
  ...
  /**
   * Serializes an instance of the QuantityWithRequiredUnits class to a JSON object.
   * The JSON is expected to be valid against the QuantityWithRequiredUnits JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/QuantityWithRequiredUnits' } };
    if (this.number != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the QuantityWithRequiredUnits class.
   * The FHIR must be valid against the QuantityWithRequiredUnits FHIR profile, although this is not validated by the function.
   ...
   * @returns {QuantityWithRequiredUnits} An instance of QuantityWithRequiredUnits populated with the FHIR data
   */
...
export default QuantityWithRequiredUnits;
