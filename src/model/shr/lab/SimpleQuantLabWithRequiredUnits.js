...
/**
 * Generated class for shr.lab.SimpleQuantLabWithRequiredUnits.
 * @extends SimpleQuantitativeLaboratoryObservation
 */
class SimpleQuantLabWithRequiredUnits extends SimpleQuantitativeLaboratoryObservation {
   ...
   * This field/value is required.
   * @param {DataValue} dataValue - The shr.core.DataValue
   * @returns {SimpleQuantLabWithRequiredUnits} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the SimpleQuantLabWithRequiredUnits class.
   * The JSON must be valid against the SimpleQuantLabWithRequiredUnits JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {SimpleQuantLabWithRequiredUnits} An instance of SimpleQuantLabWithRequiredUnits populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'SimpleQuantLabWithRequiredUnits');
  ...
  /**
   * Serializes an instance of the SimpleQuantLabWithRequiredUnits class to a JSON object.
   * The JSON is expected to be valid against the SimpleQuantLabWithRequiredUnits JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/SimpleQuantLabWithRequiredUnits' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the SimpleQuantLabWithRequiredUnits class.
   * The FHIR must be valid against the SimpleQuantLabWithRequiredUnits FHIR profile, although this is not validated by the function.
   ...
   * @returns {SimpleQuantLabWithRequiredUnits} An instance of SimpleQuantLabWithRequiredUnits populated with the FHIR data
   */
...
export default SimpleQuantLabWithRequiredUnits;
