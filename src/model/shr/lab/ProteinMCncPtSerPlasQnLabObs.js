...
/**
 * Generated class for shr.lab.ProteinMCncPtSerPlasQnLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class ProteinMCncPtSerPlasQnLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {ProteinMCncPtSerPlasQnLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the ProteinMCncPtSerPlasQnLabObs class.
   * The JSON must be valid against the ProteinMCncPtSerPlasQnLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {ProteinMCncPtSerPlasQnLabObs} An instance of ProteinMCncPtSerPlasQnLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'ProteinMCncPtSerPlasQnLabObs');
  ...
  /**
   * Serializes an instance of the ProteinMCncPtSerPlasQnLabObs class to a JSON object.
   * The JSON is expected to be valid against the ProteinMCncPtSerPlasQnLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/ProteinMCncPtSerPlasQnLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ProteinMCncPtSerPlasQnLabObs class.
   * The FHIR must be valid against the ProteinMCncPtSerPlasQnLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {ProteinMCncPtSerPlasQnLabObs} An instance of ProteinMCncPtSerPlasQnLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/ProteinMCncPtSerPlasQnLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default ProteinMCncPtSerPlasQnLabObs;
