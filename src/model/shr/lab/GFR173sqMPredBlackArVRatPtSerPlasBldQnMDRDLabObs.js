...
/**
 * Generated class for shr.lab.GFR173sqMPredBlackArVRatPtSerPlasBldQnMDRDLabObs.
 * @extends SimpleQuantitativeLaboratoryObservation
 */
class GFR173sqMPredBlackArVRatPtSerPlasBldQnMDRDLabObs extends SimpleQuantitativeLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {GFR173sqMPredBlackArVRatPtSerPlasBldQnMDRDLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the GFR173sqMPredBlackArVRatPtSerPlasBldQnMDRDLabObs class.
   * The JSON must be valid against the GFR173sqMPredBlackArVRatPtSerPlasBldQnMDRDLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {GFR173sqMPredBlackArVRatPtSerPlasBldQnMDRDLabObs} An instance of GFR173sqMPredBlackArVRatPtSerPlasBldQnMDRDLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'GFR173sqMPredBlackArVRatPtSerPlasBldQnMDRDLabObs');
  ...
  /**
   * Serializes an instance of the GFR173sqMPredBlackArVRatPtSerPlasBldQnMDRDLabObs class to a JSON object.
   * The JSON is expected to be valid against the GFR173sqMPredBlackArVRatPtSerPlasBldQnMDRDLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/GFR173sqMPredBlackArVRatPtSerPlasBldQnMDRDLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the GFR173sqMPredBlackArVRatPtSerPlasBldQnMDRDLabObs class.
   * The FHIR must be valid against the GFR173sqMPredBlackArVRatPtSerPlasBldQnMDRDLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {GFR173sqMPredBlackArVRatPtSerPlasBldQnMDRDLabObs} An instance of GFR173sqMPredBlackArVRatPtSerPlasBldQnMDRDLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/GFR173sqMPredBlackArVRatPtSerPlasBldQnMDRDLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default GFR173sqMPredBlackArVRatPtSerPlasBldQnMDRDLabObs;
