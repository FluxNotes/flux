...
/**
 * Generated class for shr.lab.MeanCorpuscularVolumeEntVolPtRBCQnAutoCntLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class MeanCorpuscularVolumeEntVolPtRBCQnAutoCntLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {MeanCorpuscularVolumeEntVolPtRBCQnAutoCntLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the MeanCorpuscularVolumeEntVolPtRBCQnAutoCntLabObs class.
   * The JSON must be valid against the MeanCorpuscularVolumeEntVolPtRBCQnAutoCntLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {MeanCorpuscularVolumeEntVolPtRBCQnAutoCntLabObs} An instance of MeanCorpuscularVolumeEntVolPtRBCQnAutoCntLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'MeanCorpuscularVolumeEntVolPtRBCQnAutoCntLabObs');
  ...
  /**
   * Serializes an instance of the MeanCorpuscularVolumeEntVolPtRBCQnAutoCntLabObs class to a JSON object.
   * The JSON is expected to be valid against the MeanCorpuscularVolumeEntVolPtRBCQnAutoCntLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/MeanCorpuscularVolumeEntVolPtRBCQnAutoCntLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the MeanCorpuscularVolumeEntVolPtRBCQnAutoCntLabObs class.
   * The FHIR must be valid against the MeanCorpuscularVolumeEntVolPtRBCQnAutoCntLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {MeanCorpuscularVolumeEntVolPtRBCQnAutoCntLabObs} An instance of MeanCorpuscularVolumeEntVolPtRBCQnAutoCntLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/MeanCorpuscularVolumeEntVolPtRBCQnAutoCntLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default MeanCorpuscularVolumeEntVolPtRBCQnAutoCntLabObs;
