...
/**
 * Generated class for shr.lab.PlateletMeanVolumeEntVolPtBldQnReesEckerLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class PlateletMeanVolumeEntVolPtBldQnReesEckerLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {PlateletMeanVolumeEntVolPtBldQnReesEckerLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the PlateletMeanVolumeEntVolPtBldQnReesEckerLabObs class.
   * The JSON must be valid against the PlateletMeanVolumeEntVolPtBldQnReesEckerLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {PlateletMeanVolumeEntVolPtBldQnReesEckerLabObs} An instance of PlateletMeanVolumeEntVolPtBldQnReesEckerLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'PlateletMeanVolumeEntVolPtBldQnReesEckerLabObs');
  ...
  /**
   * Serializes an instance of the PlateletMeanVolumeEntVolPtBldQnReesEckerLabObs class to a JSON object.
   * The JSON is expected to be valid against the PlateletMeanVolumeEntVolPtBldQnReesEckerLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/PlateletMeanVolumeEntVolPtBldQnReesEckerLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the PlateletMeanVolumeEntVolPtBldQnReesEckerLabObs class.
   * The FHIR must be valid against the PlateletMeanVolumeEntVolPtBldQnReesEckerLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {PlateletMeanVolumeEntVolPtBldQnReesEckerLabObs} An instance of PlateletMeanVolumeEntVolPtBldQnReesEckerLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/PlateletMeanVolumeEntVolPtBldQnReesEckerLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default PlateletMeanVolumeEntVolPtBldQnReesEckerLabObs;
