...
/**
 * Generated class for shr.lab.UreaNitrogenCreatinineMRtoPtSerPlasQnLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class UreaNitrogenCreatinineMRtoPtSerPlasQnLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {UreaNitrogenCreatinineMRtoPtSerPlasQnLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the UreaNitrogenCreatinineMRtoPtSerPlasQnLabObs class.
   * The JSON must be valid against the UreaNitrogenCreatinineMRtoPtSerPlasQnLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {UreaNitrogenCreatinineMRtoPtSerPlasQnLabObs} An instance of UreaNitrogenCreatinineMRtoPtSerPlasQnLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'UreaNitrogenCreatinineMRtoPtSerPlasQnLabObs');
  ...
  /**
   * Serializes an instance of the UreaNitrogenCreatinineMRtoPtSerPlasQnLabObs class to a JSON object.
   * The JSON is expected to be valid against the UreaNitrogenCreatinineMRtoPtSerPlasQnLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/UreaNitrogenCreatinineMRtoPtSerPlasQnLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the UreaNitrogenCreatinineMRtoPtSerPlasQnLabObs class.
   * The FHIR must be valid against the UreaNitrogenCreatinineMRtoPtSerPlasQnLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {UreaNitrogenCreatinineMRtoPtSerPlasQnLabObs} An instance of UreaNitrogenCreatinineMRtoPtSerPlasQnLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/UreaNitrogenCreatinineMRtoPtSerPlasQnLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default UreaNitrogenCreatinineMRtoPtSerPlasQnLabObs;
