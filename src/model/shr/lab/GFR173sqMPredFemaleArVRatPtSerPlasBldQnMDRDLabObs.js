...
/**
 * Generated class for shr.lab.GFR173sqMPredFemaleArVRatPtSerPlasBldQnMDRDLabObs.
 * @extends SimpleQuantitativeLaboratoryObservation
 */
class GFR173sqMPredFemaleArVRatPtSerPlasBldQnMDRDLabObs extends SimpleQuantitativeLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {GFR173sqMPredFemaleArVRatPtSerPlasBldQnMDRDLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the GFR173sqMPredFemaleArVRatPtSerPlasBldQnMDRDLabObs class.
   * The JSON must be valid against the GFR173sqMPredFemaleArVRatPtSerPlasBldQnMDRDLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {GFR173sqMPredFemaleArVRatPtSerPlasBldQnMDRDLabObs} An instance of GFR173sqMPredFemaleArVRatPtSerPlasBldQnMDRDLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'GFR173sqMPredFemaleArVRatPtSerPlasBldQnMDRDLabObs');
  ...
  /**
   * Serializes an instance of the GFR173sqMPredFemaleArVRatPtSerPlasBldQnMDRDLabObs class to a JSON object.
   * The JSON is expected to be valid against the GFR173sqMPredFemaleArVRatPtSerPlasBldQnMDRDLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/GFR173sqMPredFemaleArVRatPtSerPlasBldQnMDRDLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the GFR173sqMPredFemaleArVRatPtSerPlasBldQnMDRDLabObs class.
   * The FHIR must be valid against the GFR173sqMPredFemaleArVRatPtSerPlasBldQnMDRDLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {GFR173sqMPredFemaleArVRatPtSerPlasBldQnMDRDLabObs} An instance of GFR173sqMPredFemaleArVRatPtSerPlasBldQnMDRDLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/GFR173sqMPredFemaleArVRatPtSerPlasBldQnMDRDLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default GFR173sqMPredFemaleArVRatPtSerPlasBldQnMDRDLabObs;
