...
/**
 * Generated class for shr.lab.BlastsNCncPtBldQnLabObs.
 * @extends SimpleQuantitativeLaboratoryObservation
 */
class BlastsNCncPtBldQnLabObs extends SimpleQuantitativeLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {BlastsNCncPtBldQnLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the BlastsNCncPtBldQnLabObs class.
   * The JSON must be valid against the BlastsNCncPtBldQnLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {BlastsNCncPtBldQnLabObs} An instance of BlastsNCncPtBldQnLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'BlastsNCncPtBldQnLabObs');
  ...
  /**
   * Serializes an instance of the BlastsNCncPtBldQnLabObs class to a JSON object.
   * The JSON is expected to be valid against the BlastsNCncPtBldQnLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/BlastsNCncPtBldQnLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the BlastsNCncPtBldQnLabObs class.
   * The FHIR must be valid against the BlastsNCncPtBldQnLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {BlastsNCncPtBldQnLabObs} An instance of BlastsNCncPtBldQnLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/BlastsNCncPtBldQnLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default BlastsNCncPtBldQnLabObs;
