...
/**
 * Generated class for shr.lab.ErythrocytesNucleatedNCncPtBldQnLabObs.
 * @extends SimpleQuantitativeLaboratoryObservation
 */
class ErythrocytesNucleatedNCncPtBldQnLabObs extends SimpleQuantitativeLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {ErythrocytesNucleatedNCncPtBldQnLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the ErythrocytesNucleatedNCncPtBldQnLabObs class.
   * The JSON must be valid against the ErythrocytesNucleatedNCncPtBldQnLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {ErythrocytesNucleatedNCncPtBldQnLabObs} An instance of ErythrocytesNucleatedNCncPtBldQnLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'ErythrocytesNucleatedNCncPtBldQnLabObs');
  ...
  /**
   * Serializes an instance of the ErythrocytesNucleatedNCncPtBldQnLabObs class to a JSON object.
   * The JSON is expected to be valid against the ErythrocytesNucleatedNCncPtBldQnLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/ErythrocytesNucleatedNCncPtBldQnLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ErythrocytesNucleatedNCncPtBldQnLabObs class.
   * The FHIR must be valid against the ErythrocytesNucleatedNCncPtBldQnLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {ErythrocytesNucleatedNCncPtBldQnLabObs} An instance of ErythrocytesNucleatedNCncPtBldQnLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/ErythrocytesNucleatedNCncPtBldQnLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default ErythrocytesNucleatedNCncPtBldQnLabObs;
