...
/**
 * Generated class for shr.lab.LymphocytesVariant100WBCNFrPtBldQnLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class LymphocytesVariant100WBCNFrPtBldQnLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {LymphocytesVariant100WBCNFrPtBldQnLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the LymphocytesVariant100WBCNFrPtBldQnLabObs class.
   * The JSON must be valid against the LymphocytesVariant100WBCNFrPtBldQnLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {LymphocytesVariant100WBCNFrPtBldQnLabObs} An instance of LymphocytesVariant100WBCNFrPtBldQnLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'LymphocytesVariant100WBCNFrPtBldQnLabObs');
  ...
  /**
   * Serializes an instance of the LymphocytesVariant100WBCNFrPtBldQnLabObs class to a JSON object.
   * The JSON is expected to be valid against the LymphocytesVariant100WBCNFrPtBldQnLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/LymphocytesVariant100WBCNFrPtBldQnLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the LymphocytesVariant100WBCNFrPtBldQnLabObs class.
   * The FHIR must be valid against the LymphocytesVariant100WBCNFrPtBldQnLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {LymphocytesVariant100WBCNFrPtBldQnLabObs} An instance of LymphocytesVariant100WBCNFrPtBldQnLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/LymphocytesVariant100WBCNFrPtBldQnLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default LymphocytesVariant100WBCNFrPtBldQnLabObs;
