...
/**
 * Generated class for shr.lab.LymphocytesNCncPtBldQnAutoCntLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class LymphocytesNCncPtBldQnAutoCntLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {LymphocytesNCncPtBldQnAutoCntLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the LymphocytesNCncPtBldQnAutoCntLabObs class.
   * The JSON must be valid against the LymphocytesNCncPtBldQnAutoCntLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {LymphocytesNCncPtBldQnAutoCntLabObs} An instance of LymphocytesNCncPtBldQnAutoCntLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'LymphocytesNCncPtBldQnAutoCntLabObs');
  ...
  /**
   * Serializes an instance of the LymphocytesNCncPtBldQnAutoCntLabObs class to a JSON object.
   * The JSON is expected to be valid against the LymphocytesNCncPtBldQnAutoCntLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/LymphocytesNCncPtBldQnAutoCntLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the LymphocytesNCncPtBldQnAutoCntLabObs class.
   * The FHIR must be valid against the LymphocytesNCncPtBldQnAutoCntLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {LymphocytesNCncPtBldQnAutoCntLabObs} An instance of LymphocytesNCncPtBldQnAutoCntLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/LymphocytesNCncPtBldQnAutoCntLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default LymphocytesNCncPtBldQnAutoCntLabObs;
