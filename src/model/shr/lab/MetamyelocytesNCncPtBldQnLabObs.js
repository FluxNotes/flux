...
/**
 * Generated class for shr.lab.MetamyelocytesNCncPtBldQnLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class MetamyelocytesNCncPtBldQnLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {MetamyelocytesNCncPtBldQnLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the MetamyelocytesNCncPtBldQnLabObs class.
   * The JSON must be valid against the MetamyelocytesNCncPtBldQnLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {MetamyelocytesNCncPtBldQnLabObs} An instance of MetamyelocytesNCncPtBldQnLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'MetamyelocytesNCncPtBldQnLabObs');
  ...
  /**
   * Serializes an instance of the MetamyelocytesNCncPtBldQnLabObs class to a JSON object.
   * The JSON is expected to be valid against the MetamyelocytesNCncPtBldQnLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/MetamyelocytesNCncPtBldQnLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the MetamyelocytesNCncPtBldQnLabObs class.
   * The FHIR must be valid against the MetamyelocytesNCncPtBldQnLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {MetamyelocytesNCncPtBldQnLabObs} An instance of MetamyelocytesNCncPtBldQnLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/MetamyelocytesNCncPtBldQnLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default MetamyelocytesNCncPtBldQnLabObs;
