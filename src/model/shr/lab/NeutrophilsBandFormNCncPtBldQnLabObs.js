...
/**
 * Generated class for shr.lab.NeutrophilsBandFormNCncPtBldQnLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class NeutrophilsBandFormNCncPtBldQnLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {NeutrophilsBandFormNCncPtBldQnLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the NeutrophilsBandFormNCncPtBldQnLabObs class.
   * The JSON must be valid against the NeutrophilsBandFormNCncPtBldQnLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {NeutrophilsBandFormNCncPtBldQnLabObs} An instance of NeutrophilsBandFormNCncPtBldQnLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'NeutrophilsBandFormNCncPtBldQnLabObs');
  ...
  /**
   * Serializes an instance of the NeutrophilsBandFormNCncPtBldQnLabObs class to a JSON object.
   * The JSON is expected to be valid against the NeutrophilsBandFormNCncPtBldQnLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/NeutrophilsBandFormNCncPtBldQnLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the NeutrophilsBandFormNCncPtBldQnLabObs class.
   * The FHIR must be valid against the NeutrophilsBandFormNCncPtBldQnLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {NeutrophilsBandFormNCncPtBldQnLabObs} An instance of NeutrophilsBandFormNCncPtBldQnLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/NeutrophilsBandFormNCncPtBldQnLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default NeutrophilsBandFormNCncPtBldQnLabObs;
