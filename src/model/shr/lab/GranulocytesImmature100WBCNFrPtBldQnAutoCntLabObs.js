...
/**
 * Generated class for shr.lab.GranulocytesImmature100WBCNFrPtBldQnAutoCntLabObs.
 * @extends SimpleQuantitativeLaboratoryObservation
 */
class GranulocytesImmature100WBCNFrPtBldQnAutoCntLabObs extends SimpleQuantitativeLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {GranulocytesImmature100WBCNFrPtBldQnAutoCntLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the GranulocytesImmature100WBCNFrPtBldQnAutoCntLabObs class.
   * The JSON must be valid against the GranulocytesImmature100WBCNFrPtBldQnAutoCntLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {GranulocytesImmature100WBCNFrPtBldQnAutoCntLabObs} An instance of GranulocytesImmature100WBCNFrPtBldQnAutoCntLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'GranulocytesImmature100WBCNFrPtBldQnAutoCntLabObs');
  ...
  /**
   * Serializes an instance of the GranulocytesImmature100WBCNFrPtBldQnAutoCntLabObs class to a JSON object.
   * The JSON is expected to be valid against the GranulocytesImmature100WBCNFrPtBldQnAutoCntLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/GranulocytesImmature100WBCNFrPtBldQnAutoCntLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the GranulocytesImmature100WBCNFrPtBldQnAutoCntLabObs class.
   * The FHIR must be valid against the GranulocytesImmature100WBCNFrPtBldQnAutoCntLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {GranulocytesImmature100WBCNFrPtBldQnAutoCntLabObs} An instance of GranulocytesImmature100WBCNFrPtBldQnAutoCntLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/GranulocytesImmature100WBCNFrPtBldQnAutoCntLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default GranulocytesImmature100WBCNFrPtBldQnAutoCntLabObs;
