...
/**
 * Generated class for shr.lab.ErythrocyteMCHCMCncPtRBCQnAutoCntLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class ErythrocyteMCHCMCncPtRBCQnAutoCntLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {ErythrocyteMCHCMCncPtRBCQnAutoCntLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the ErythrocyteMCHCMCncPtRBCQnAutoCntLabObs class.
   * The JSON must be valid against the ErythrocyteMCHCMCncPtRBCQnAutoCntLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {ErythrocyteMCHCMCncPtRBCQnAutoCntLabObs} An instance of ErythrocyteMCHCMCncPtRBCQnAutoCntLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'ErythrocyteMCHCMCncPtRBCQnAutoCntLabObs');
  ...
  /**
   * Serializes an instance of the ErythrocyteMCHCMCncPtRBCQnAutoCntLabObs class to a JSON object.
   * The JSON is expected to be valid against the ErythrocyteMCHCMCncPtRBCQnAutoCntLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/ErythrocyteMCHCMCncPtRBCQnAutoCntLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ErythrocyteMCHCMCncPtRBCQnAutoCntLabObs class.
   * The FHIR must be valid against the ErythrocyteMCHCMCncPtRBCQnAutoCntLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {ErythrocyteMCHCMCncPtRBCQnAutoCntLabObs} An instance of ErythrocyteMCHCMCncPtRBCQnAutoCntLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/ErythrocyteMCHCMCncPtRBCQnAutoCntLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default ErythrocyteMCHCMCncPtRBCQnAutoCntLabObs;
