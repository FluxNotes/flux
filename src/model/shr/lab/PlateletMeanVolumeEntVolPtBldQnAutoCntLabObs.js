...
/**
 * Generated class for shr.lab.PlateletMeanVolumeEntVolPtBldQnAutoCntLabObs.
 * @extends SimpleQuantitativeLaboratoryObservation
 */
class PlateletMeanVolumeEntVolPtBldQnAutoCntLabObs extends SimpleQuantitativeLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {PlateletMeanVolumeEntVolPtBldQnAutoCntLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the PlateletMeanVolumeEntVolPtBldQnAutoCntLabObs class.
   * The JSON must be valid against the PlateletMeanVolumeEntVolPtBldQnAutoCntLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {PlateletMeanVolumeEntVolPtBldQnAutoCntLabObs} An instance of PlateletMeanVolumeEntVolPtBldQnAutoCntLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'PlateletMeanVolumeEntVolPtBldQnAutoCntLabObs');
  ...
  /**
   * Serializes an instance of the PlateletMeanVolumeEntVolPtBldQnAutoCntLabObs class to a JSON object.
   * The JSON is expected to be valid against the PlateletMeanVolumeEntVolPtBldQnAutoCntLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/PlateletMeanVolumeEntVolPtBldQnAutoCntLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the PlateletMeanVolumeEntVolPtBldQnAutoCntLabObs class.
   * The FHIR must be valid against the PlateletMeanVolumeEntVolPtBldQnAutoCntLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {PlateletMeanVolumeEntVolPtBldQnAutoCntLabObs} An instance of PlateletMeanVolumeEntVolPtBldQnAutoCntLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/PlateletMeanVolumeEntVolPtBldQnAutoCntLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default PlateletMeanVolumeEntVolPtBldQnAutoCntLabObs;
