...
/**
 * Generated class for shr.lab.ErythrocytesNucleated100WBCRatioPtBldQnLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class ErythrocytesNucleated100WBCRatioPtBldQnLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {ErythrocytesNucleated100WBCRatioPtBldQnLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the ErythrocytesNucleated100WBCRatioPtBldQnLabObs class.
   * The JSON must be valid against the ErythrocytesNucleated100WBCRatioPtBldQnLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {ErythrocytesNucleated100WBCRatioPtBldQnLabObs} An instance of ErythrocytesNucleated100WBCRatioPtBldQnLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'ErythrocytesNucleated100WBCRatioPtBldQnLabObs');
  ...
  /**
   * Serializes an instance of the ErythrocytesNucleated100WBCRatioPtBldQnLabObs class to a JSON object.
   * The JSON is expected to be valid against the ErythrocytesNucleated100WBCRatioPtBldQnLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/ErythrocytesNucleated100WBCRatioPtBldQnLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ErythrocytesNucleated100WBCRatioPtBldQnLabObs class.
   * The FHIR must be valid against the ErythrocytesNucleated100WBCRatioPtBldQnLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {ErythrocytesNucleated100WBCRatioPtBldQnLabObs} An instance of ErythrocytesNucleated100WBCRatioPtBldQnLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/ErythrocytesNucleated100WBCRatioPtBldQnLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default ErythrocytesNucleated100WBCRatioPtBldQnLabObs;
