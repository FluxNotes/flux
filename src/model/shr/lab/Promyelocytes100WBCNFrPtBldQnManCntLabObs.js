...
/**
 * Generated class for shr.lab.Promyelocytes100WBCNFrPtBldQnManCntLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class Promyelocytes100WBCNFrPtBldQnManCntLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {Promyelocytes100WBCNFrPtBldQnManCntLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the Promyelocytes100WBCNFrPtBldQnManCntLabObs class.
   * The JSON must be valid against the Promyelocytes100WBCNFrPtBldQnManCntLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {Promyelocytes100WBCNFrPtBldQnManCntLabObs} An instance of Promyelocytes100WBCNFrPtBldQnManCntLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'Promyelocytes100WBCNFrPtBldQnManCntLabObs');
  ...
  /**
   * Serializes an instance of the Promyelocytes100WBCNFrPtBldQnManCntLabObs class to a JSON object.
   * The JSON is expected to be valid against the Promyelocytes100WBCNFrPtBldQnManCntLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/Promyelocytes100WBCNFrPtBldQnManCntLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the Promyelocytes100WBCNFrPtBldQnManCntLabObs class.
   * The FHIR must be valid against the Promyelocytes100WBCNFrPtBldQnManCntLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {Promyelocytes100WBCNFrPtBldQnManCntLabObs} An instance of Promyelocytes100WBCNFrPtBldQnManCntLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/Promyelocytes100WBCNFrPtBldQnManCntLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default Promyelocytes100WBCNFrPtBldQnManCntLabObs;
