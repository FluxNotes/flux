...
/**
 * Generated class for shr.lab.AlanineAminotransferaseCCncPtSerPlasQnLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class AlanineAminotransferaseCCncPtSerPlasQnLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {AlanineAminotransferaseCCncPtSerPlasQnLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the AlanineAminotransferaseCCncPtSerPlasQnLabObs class.
   * The JSON must be valid against the AlanineAminotransferaseCCncPtSerPlasQnLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {AlanineAminotransferaseCCncPtSerPlasQnLabObs} An instance of AlanineAminotransferaseCCncPtSerPlasQnLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'AlanineAminotransferaseCCncPtSerPlasQnLabObs');
  ...
  /**
   * Serializes an instance of the AlanineAminotransferaseCCncPtSerPlasQnLabObs class to a JSON object.
   * The JSON is expected to be valid against the AlanineAminotransferaseCCncPtSerPlasQnLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/AlanineAminotransferaseCCncPtSerPlasQnLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the AlanineAminotransferaseCCncPtSerPlasQnLabObs class.
   * The FHIR must be valid against the AlanineAminotransferaseCCncPtSerPlasQnLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {AlanineAminotransferaseCCncPtSerPlasQnLabObs} An instance of AlanineAminotransferaseCCncPtSerPlasQnLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/AlanineAminotransferaseCCncPtSerPlasQnLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default AlanineAminotransferaseCCncPtSerPlasQnLabObs;
