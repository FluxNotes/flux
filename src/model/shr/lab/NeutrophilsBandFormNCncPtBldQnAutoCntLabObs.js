...
/**
 * Generated class for shr.lab.NeutrophilsBandFormNCncPtBldQnAutoCntLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class NeutrophilsBandFormNCncPtBldQnAutoCntLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {NeutrophilsBandFormNCncPtBldQnAutoCntLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the NeutrophilsBandFormNCncPtBldQnAutoCntLabObs class.
   * The JSON must be valid against the NeutrophilsBandFormNCncPtBldQnAutoCntLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {NeutrophilsBandFormNCncPtBldQnAutoCntLabObs} An instance of NeutrophilsBandFormNCncPtBldQnAutoCntLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'NeutrophilsBandFormNCncPtBldQnAutoCntLabObs');
  ...
  /**
   * Serializes an instance of the NeutrophilsBandFormNCncPtBldQnAutoCntLabObs class to a JSON object.
   * The JSON is expected to be valid against the NeutrophilsBandFormNCncPtBldQnAutoCntLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/NeutrophilsBandFormNCncPtBldQnAutoCntLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the NeutrophilsBandFormNCncPtBldQnAutoCntLabObs class.
   * The FHIR must be valid against the NeutrophilsBandFormNCncPtBldQnAutoCntLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {NeutrophilsBandFormNCncPtBldQnAutoCntLabObs} An instance of NeutrophilsBandFormNCncPtBldQnAutoCntLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/NeutrophilsBandFormNCncPtBldQnAutoCntLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default NeutrophilsBandFormNCncPtBldQnAutoCntLabObs;
