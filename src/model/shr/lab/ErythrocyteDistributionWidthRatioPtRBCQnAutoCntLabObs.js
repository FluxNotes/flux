...
import SimpleQuantLabWithRequiredUnits from './SimpleQuantLabWithRequiredUnits';

/**
 * Generated class for shr.lab.ErythrocyteDistributionWidthRatioPtRBCQnAutoCntLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class ErythrocyteDistributionWidthRatioPtRBCQnAutoCntLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {ErythrocyteDistributionWidthRatioPtRBCQnAutoCntLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the ErythrocyteDistributionWidthRatioPtRBCQnAutoCntLabObs class.
   * The JSON must be valid against the ErythrocyteDistributionWidthRatioPtRBCQnAutoCntLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {ErythrocyteDistributionWidthRatioPtRBCQnAutoCntLabObs} An instance of ErythrocyteDistributionWidthRatioPtRBCQnAutoCntLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'ErythrocyteDistributionWidthRatioPtRBCQnAutoCntLabObs');
  ...
  /**
   * Serializes an instance of the ErythrocyteDistributionWidthRatioPtRBCQnAutoCntLabObs class to a JSON object.
   * The JSON is expected to be valid against the ErythrocyteDistributionWidthRatioPtRBCQnAutoCntLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/ErythrocyteDistributionWidthRatioPtRBCQnAutoCntLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ErythrocyteDistributionWidthRatioPtRBCQnAutoCntLabObs class.
   * The FHIR must be valid against the ErythrocyteDistributionWidthRatioPtRBCQnAutoCntLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {ErythrocyteDistributionWidthRatioPtRBCQnAutoCntLabObs} An instance of ErythrocyteDistributionWidthRatioPtRBCQnAutoCntLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/ErythrocyteDistributionWidthRatioPtRBCQnAutoCntLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default ErythrocyteDistributionWidthRatioPtRBCQnAutoCntLabObs;
