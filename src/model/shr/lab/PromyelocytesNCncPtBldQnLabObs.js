...
/**
 * Generated class for shr.lab.PromyelocytesNCncPtBldQnLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class PromyelocytesNCncPtBldQnLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {PromyelocytesNCncPtBldQnLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the PromyelocytesNCncPtBldQnLabObs class.
   * The JSON must be valid against the PromyelocytesNCncPtBldQnLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {PromyelocytesNCncPtBldQnLabObs} An instance of PromyelocytesNCncPtBldQnLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'PromyelocytesNCncPtBldQnLabObs');
  ...
  /**
   * Serializes an instance of the PromyelocytesNCncPtBldQnLabObs class to a JSON object.
   * The JSON is expected to be valid against the PromyelocytesNCncPtBldQnLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/PromyelocytesNCncPtBldQnLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the PromyelocytesNCncPtBldQnLabObs class.
   * The FHIR must be valid against the PromyelocytesNCncPtBldQnLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {PromyelocytesNCncPtBldQnLabObs} An instance of PromyelocytesNCncPtBldQnLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/PromyelocytesNCncPtBldQnLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default PromyelocytesNCncPtBldQnLabObs;
