...
/**
 * Generated class for shr.lab.GlobulinMCncPtSerQnCalculatedLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class GlobulinMCncPtSerQnCalculatedLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {GlobulinMCncPtSerQnCalculatedLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the GlobulinMCncPtSerQnCalculatedLabObs class.
   * The JSON must be valid against the GlobulinMCncPtSerQnCalculatedLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {GlobulinMCncPtSerQnCalculatedLabObs} An instance of GlobulinMCncPtSerQnCalculatedLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'GlobulinMCncPtSerQnCalculatedLabObs');
  ...
  /**
   * Serializes an instance of the GlobulinMCncPtSerQnCalculatedLabObs class to a JSON object.
   * The JSON is expected to be valid against the GlobulinMCncPtSerQnCalculatedLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/GlobulinMCncPtSerQnCalculatedLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the GlobulinMCncPtSerQnCalculatedLabObs class.
   * The FHIR must be valid against the GlobulinMCncPtSerQnCalculatedLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {GlobulinMCncPtSerQnCalculatedLabObs} An instance of GlobulinMCncPtSerQnCalculatedLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/GlobulinMCncPtSerQnCalculatedLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default GlobulinMCncPtSerQnCalculatedLabObs;
