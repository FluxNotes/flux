...
/**
 * Generated class for shr.lab.ErythrocyteDistributionWidthEntVolPtRBCQnLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class ErythrocyteDistributionWidthEntVolPtRBCQnLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {ErythrocyteDistributionWidthEntVolPtRBCQnLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the ErythrocyteDistributionWidthEntVolPtRBCQnLabObs class.
   * The JSON must be valid against the ErythrocyteDistributionWidthEntVolPtRBCQnLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {ErythrocyteDistributionWidthEntVolPtRBCQnLabObs} An instance of ErythrocyteDistributionWidthEntVolPtRBCQnLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'ErythrocyteDistributionWidthEntVolPtRBCQnLabObs');
  ...
  /**
   * Serializes an instance of the ErythrocyteDistributionWidthEntVolPtRBCQnLabObs class to a JSON object.
   * The JSON is expected to be valid against the ErythrocyteDistributionWidthEntVolPtRBCQnLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/ErythrocyteDistributionWidthEntVolPtRBCQnLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ErythrocyteDistributionWidthEntVolPtRBCQnLabObs class.
   * The FHIR must be valid against the ErythrocyteDistributionWidthEntVolPtRBCQnLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {ErythrocyteDistributionWidthEntVolPtRBCQnLabObs} An instance of ErythrocyteDistributionWidthEntVolPtRBCQnLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/ErythrocyteDistributionWidthEntVolPtRBCQnLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default ErythrocyteDistributionWidthEntVolPtRBCQnLabObs;
