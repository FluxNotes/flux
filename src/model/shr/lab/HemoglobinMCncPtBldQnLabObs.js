...
/**
 * Generated class for shr.lab.HemoglobinMCncPtBldQnLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class HemoglobinMCncPtBldQnLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {HemoglobinMCncPtBldQnLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the HemoglobinMCncPtBldQnLabObs class.
   * The JSON must be valid against the HemoglobinMCncPtBldQnLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {HemoglobinMCncPtBldQnLabObs} An instance of HemoglobinMCncPtBldQnLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'HemoglobinMCncPtBldQnLabObs');
  ...
  /**
   * Serializes an instance of the HemoglobinMCncPtBldQnLabObs class to a JSON object.
   * The JSON is expected to be valid against the HemoglobinMCncPtBldQnLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/HemoglobinMCncPtBldQnLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the HemoglobinMCncPtBldQnLabObs class.
   * The FHIR must be valid against the HemoglobinMCncPtBldQnLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {HemoglobinMCncPtBldQnLabObs} An instance of HemoglobinMCncPtBldQnLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/HemoglobinMCncPtBldQnLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default HemoglobinMCncPtBldQnLabObs;
