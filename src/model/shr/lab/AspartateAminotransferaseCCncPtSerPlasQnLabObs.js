...
/**
 * Generated class for shr.lab.AspartateAminotransferaseCCncPtSerPlasQnLabObs.
 * @extends SimpleQuantLabWithRequiredUnits
 */
class AspartateAminotransferaseCCncPtSerPlasQnLabObs extends SimpleQuantLabWithRequiredUnits {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {AspartateAminotransferaseCCncPtSerPlasQnLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the AspartateAminotransferaseCCncPtSerPlasQnLabObs class.
   * The JSON must be valid against the AspartateAminotransferaseCCncPtSerPlasQnLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {AspartateAminotransferaseCCncPtSerPlasQnLabObs} An instance of AspartateAminotransferaseCCncPtSerPlasQnLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'AspartateAminotransferaseCCncPtSerPlasQnLabObs');
  ...
  /**
   * Serializes an instance of the AspartateAminotransferaseCCncPtSerPlasQnLabObs class to a JSON object.
   * The JSON is expected to be valid against the AspartateAminotransferaseCCncPtSerPlasQnLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/AspartateAminotransferaseCCncPtSerPlasQnLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the AspartateAminotransferaseCCncPtSerPlasQnLabObs class.
   * The FHIR must be valid against the AspartateAminotransferaseCCncPtSerPlasQnLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {AspartateAminotransferaseCCncPtSerPlasQnLabObs} An instance of AspartateAminotransferaseCCncPtSerPlasQnLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/AspartateAminotransferaseCCncPtSerPlasQnLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default AspartateAminotransferaseCCncPtSerPlasQnLabObs;
