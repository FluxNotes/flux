...
/**
 * Generated class for shr.lab.LeukocytesOtherNCncPtBldQnAutoCntLabObs.
 * @extends SimpleQuantitativeLaboratoryObservation
 */
class LeukocytesOtherNCncPtBldQnAutoCntLabObs extends SimpleQuantitativeLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {LeukocytesOtherNCncPtBldQnAutoCntLabObs} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the LeukocytesOtherNCncPtBldQnAutoCntLabObs class.
   * The JSON must be valid against the LeukocytesOtherNCncPtBldQnAutoCntLabObs JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {LeukocytesOtherNCncPtBldQnAutoCntLabObs} An instance of LeukocytesOtherNCncPtBldQnAutoCntLabObs populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.lab', 'LeukocytesOtherNCncPtBldQnAutoCntLabObs');
  ...
  /**
   * Serializes an instance of the LeukocytesOtherNCncPtBldQnAutoCntLabObs class to a JSON object.
   * The JSON is expected to be valid against the LeukocytesOtherNCncPtBldQnAutoCntLabObs JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lab/LeukocytesOtherNCncPtBldQnAutoCntLabObs' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the LeukocytesOtherNCncPtBldQnAutoCntLabObs class.
   * The FHIR must be valid against the LeukocytesOtherNCncPtBldQnAutoCntLabObs FHIR profile, although this is not validated by the function.
   ...
   * @returns {LeukocytesOtherNCncPtBldQnAutoCntLabObs} An instance of LeukocytesOtherNCncPtBldQnAutoCntLabObs populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/lab/LeukocytesOtherNCncPtBldQnAutoCntLabObs', 'uri');
    if (fhir['meta'] != null) {
...
export default LeukocytesOtherNCncPtBldQnAutoCntLabObs;
