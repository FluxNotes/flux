...
class DosageBodySite {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.medication', 'DosageBodySite');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    if (!asExtension && fhir != null) {
      inst.value = FHIRHelper.createInstanceFromFHIR('shr.core.AnatomicalLocationPrecoordinated', fhir, fhirType, shrId, allEntries, mappedResources, referencesOut);
    }
    return inst;
  }
