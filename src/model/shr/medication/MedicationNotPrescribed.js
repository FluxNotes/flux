...
class MedicationNotPrescribed extends ActionRequestedAgainst {
  ...
  static fromFHIR(fhir, asExtension=false) {
    ...
    if (fhir['extension'] != null) {
      const match = fhir['extension'].find(e => e.url == 'http://example.com/fhir/StructureDefinition/shr-entity-Medication-extension');
      if (match != null) {
        inst.medication = createInstanceFromFHIR('shr.entity.Medication', match, true);
      }
    }
    return inst;
  }
