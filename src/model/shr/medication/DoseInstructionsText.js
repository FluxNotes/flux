...
class DoseInstructionsText {
  ...
  /**
   * Serializes an instance of the DoseInstructionsText class to a FHIR object.
   * The FHIR is expected to be valid against the DoseInstructionsText FHIR profile, but no validation checks are performed.
