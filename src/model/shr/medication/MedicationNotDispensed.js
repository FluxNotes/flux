...
class MedicationNotDispensed extends ActionNotPerformed {
  ...
  static fromFHIR(fhir, asExtension=false) {
    ...
    if (fhir['extension'] != null) {
      const match = fhir['extension'].find(e => e.url == 'http://example.com/fhir/StructureDefinition/shr-core-NonOccurrenceTimeOrPeriod-extension');
      if (match != null) {
        inst.nonOccurrenceTimeOrPeriod = createInstanceFromFHIR('shr.core.NonOccurrenceTimeOrPeriod', match, true);
      }
    }
    return inst;
  }
