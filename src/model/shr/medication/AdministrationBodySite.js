...
class AdministrationBodySite {
  ...
  /**
   * Serializes an instance of the AdministrationBodySite class to a FHIR object.
   * The FHIR is expected to be valid against the AdministrationBodySite FHIR profile, but no validation checks are performed.
