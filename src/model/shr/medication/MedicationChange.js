...
class MedicationChange extends ActionPerformed {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.medication', 'MedicationChange');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/medication/MedicationChange', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_extension of fhir['extension'] || []) {
      ...
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/shr-medication-MedicationBeforeChange-extension') {
        ...
        const inst_medicationBeforeChange = FHIRHelper.createInstanceFromFHIR('shr.medication.MedicationBeforeChange', fhir_extension, 'Extension', shrId, allEntries, mappedResources, referencesOut, true);
      ...
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/shr-medication-MedicationAfterChange-extension') {
        ...
        const inst_medicationAfterChange = FHIRHelper.createInstanceFromFHIR('shr.medication.MedicationAfterChange', fhir_extension, 'Extension', shrId, allEntries, mappedResources, referencesOut, true);
