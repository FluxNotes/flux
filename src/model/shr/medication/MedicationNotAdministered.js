...
class MedicationNotAdministered extends ActionNotPerformed {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.medication', 'MedicationNotAdministered');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/medication/MedicationNotAdministered', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_reasonNotGiven of fhir['reasonNotGiven'] || []) {
      ...
      const inst_reason = FHIRHelper.createInstanceFromFHIR('shr.base.Reason', fhir_reasonNotGiven, 'CodeableConcept', shrId, allEntries, mappedResources, referencesOut, false);
