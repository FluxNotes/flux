...
class MedicationAdherence extends CodedNonLaboratoryObservation {
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/medication/MedicationAdherence', 'uri');
    if (fhir['meta'] != null) {
      ...
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/shr-base-SpecificFocusOfFinding-extension' && fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/shr-base-SpecificFocusOfFinding-extension') {
        ...
        if (fhir_extension['valueReference'] != null) {
          ...
          if (mappedResources[entryId]) {
            ...
            const entryType = 'http://standardhealthrecord.org/spec/shr/entity/Medication';
