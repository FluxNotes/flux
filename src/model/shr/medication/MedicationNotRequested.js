...
class MedicationNotRequested extends MedicationAction {
  ...
  /**
   * Serializes an instance of the MedicationNotRequested class to a FHIR object.
   * The FHIR is expected to be valid against the MedicationNotRequested FHIR profile, but no validation checks are performed.
