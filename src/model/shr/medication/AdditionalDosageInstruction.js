...
class AdditionalDosageInstruction {
  ...
  /**
   * Serializes an instance of the AdditionalDosageInstruction class to a FHIR object.
   * The FHIR is expected to be valid against the AdditionalDosageInstruction FHIR profile, but no validation checks are performed.
