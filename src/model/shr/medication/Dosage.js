...
class Dosage {
  ...
  toFHIR(asExtension=false) {
    ...
    if (this.dosageBodySite != null && this.dosageBodySite.anatomicalLocation != null) {
      inst['site'] = typeof this.dosageBodySite.anatomicalLocation.toFHIR === 'function' ? this.dosageBodySite.anatomicalLocation.toFHIR() : this.dosageBodySite.anatomicalLocation;
    }
    if (this.routeIntoBody != null) {
  ...
  static fromFHIR(fhir, asExtension=false) {
    ...
    if (fhir['asNeeded[x]'] != null) {
      inst.asNeededIndicator = createInstanceFromFHIR('shr.medication.AsNeededIndicator', fhir['asNeeded[x]']);
    }
    if (fhir['site'] != null) {
      if(inst.dosageBodySite == null) {
        inst.dosageBodySite = createInstanceFromFHIR('shr.medication.DosageBodySite', {});
      }
      inst.dosageBodySite.anatomicalLocation = createInstanceFromFHIR('shr.core.AnatomicalLocation', fhir['site']);
    }
    if (fhir['route'] != null) {
    ...
    if (fhir['dose[x]'] != null) {
      inst.doseAmount = createInstanceFromFHIR('shr.medication.DoseAmount', fhir['dose[x]']);
    }
