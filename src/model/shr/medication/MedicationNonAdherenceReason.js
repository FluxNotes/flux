...
import CodedNonIndependentFinding from '../base/CodedNonIndependentFinding';

/**
 * Generated class for shr.medication.MedicationNonAdherenceReason.
 * @extends CodedNonIndependentFinding
 */
class MedicationNonAdherenceReason extends CodedNonIndependentFinding {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.medication', 'MedicationNonAdherenceReason');
