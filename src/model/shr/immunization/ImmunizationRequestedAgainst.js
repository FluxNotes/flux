...
class ImmunizationRequestedAgainst extends ImmunizationAction {
  ...
  /**
   * Serializes an instance of the ImmunizationRequestedAgainst class to a FHIR object.
   * The FHIR is expected to be valid against the ImmunizationRequestedAgainst FHIR profile, but no validation checks are performed.
