...
class ImmunizationNotGiven extends ImmunizationAction {
  ...
  /**
   * Serializes an instance of the ImmunizationNotGiven class to a FHIR object.
   * The FHIR is expected to be valid against the ImmunizationNotGiven FHIR profile, but no validation checks are performed.
