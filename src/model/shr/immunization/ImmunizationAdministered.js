...
/** Generated from SHR definition for shr.immunization.ImmunizationAdministered */
class ImmunizationAdministered extends Immunization {
  ...
  /**
   * Getter for shr.immunization.Vaccine
   */
  get vaccine() {
  ...
  /**
   * Setter for shr.immunization.Vaccine
   */
  set vaccine(vaccineVal) {
    this._vaccine = vaccineVal;
  }
...
export default ImmunizationAdministered;
