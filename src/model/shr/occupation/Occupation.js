...
/**
 * Generated class for shr.occupation.Occupation.
 * @extends CodedEvaluationComponent
 */
class Occupation extends CodedEvaluationComponent {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/occupation/Occupation' } };
    if (this.value != null) {
