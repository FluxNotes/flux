...
/**
 * Generated class for shr.occupation.MilitaryBranch.
 * @extends CodedEvaluationComponent
 */
class MilitaryBranch extends CodedEvaluationComponent {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/occupation/MilitaryBranch' } };
    if (this.value != null) {
