...
/**
 * Generated class for shr.occupation.MilitaryStatus.
 * @extends CodedEvaluationComponent
 */
class MilitaryStatus extends CodedEvaluationComponent {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/occupation/MilitaryStatus' } };
    if (this.value != null) {
