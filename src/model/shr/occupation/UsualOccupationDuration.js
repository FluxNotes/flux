...
/**
 * Generated class for shr.occupation.UsualOccupationDuration.
 * @extends EvaluationComponent
 */
class UsualOccupationDuration extends EvaluationComponent {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/occupation/UsualOccupationDuration' } };
    if (this.value != null) {
