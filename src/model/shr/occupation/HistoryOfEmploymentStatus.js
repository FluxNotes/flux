...
/**
 * Generated class for shr.occupation.HistoryOfEmploymentStatus.
 * @extends CodedSocialHistoryObservation
 */
class HistoryOfEmploymentStatus extends CodedSocialHistoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {HistoryOfEmploymentStatus} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the HistoryOfEmploymentStatus class.
   * The JSON must be valid against the HistoryOfEmploymentStatus JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {HistoryOfEmploymentStatus} An instance of HistoryOfEmploymentStatus populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new HistoryOfEmploymentStatus();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the HistoryOfEmploymentStatus class to a JSON object.
   * The JSON is expected to be valid against the HistoryOfEmploymentStatus JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/occupation/HistoryOfEmploymentStatus' };
...
export default HistoryOfEmploymentStatus;
