...
/**
 * Generated class for shr.occupation.MilitaryServiceEra.
 * @extends CodedEvaluationComponent
 */
class MilitaryServiceEra extends CodedEvaluationComponent {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value': 'http://standardhealthrecord.org/spec/shr/occupation/MilitaryServiceEra' } };
    if (this.value != null) {
