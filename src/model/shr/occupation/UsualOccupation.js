...
/**
 * Generated class for shr.occupation.UsualOccupation.
 * @extends CodedSocialHistoryObservation
 */
class UsualOccupation extends CodedSocialHistoryObservation {
  ...
  /**
   * Deserializes JSON data to an instance of the UsualOccupation class.
   * The JSON must be valid against the UsualOccupation JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {UsualOccupation} An instance of UsualOccupation populated with the JSON data
   */
  static fromJSON(json = {}) {
    const inst = new UsualOccupation();
    setPropertiesFromJSON(inst, json);
    return inst;
  }
  /**
   * Serializes an instance of the UsualOccupation class to a JSON object.
   * The JSON is expected to be valid against the UsualOccupation JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/occupation/UsualOccupation' };
...
export default UsualOccupation;
