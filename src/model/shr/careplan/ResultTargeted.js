...
class ResultTargeted {
  ...
  /**
   * Serializes an instance of the ResultTargeted class to a FHIR object.
   * The FHIR is expected to be valid against the ResultTargeted FHIR profile, but no validation checks are performed.
