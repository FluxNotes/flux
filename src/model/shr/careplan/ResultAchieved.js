...
class ResultAchieved {
  ...
  /**
   * Serializes an instance of the ResultAchieved class to a FHIR object.
   * The FHIR is expected to be valid against the ResultAchieved FHIR profile, but no validation checks are performed.
