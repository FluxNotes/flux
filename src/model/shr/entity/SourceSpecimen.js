...
class SourceSpecimen {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.entity', 'SourceSpecimen');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    if (!asExtension && fhir != null) {
      inst.value = FHIRHelper.createInstanceFromFHIR('shr.entity.Specimen', fhir, fhirType, shrId, allEntries, mappedResources, referencesOut);
    }
    return inst;
  }
