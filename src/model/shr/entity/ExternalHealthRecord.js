...
class ExternalHealthRecord extends Entity {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.entity', 'ExternalHealthRecord');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/entity/ExternalHealthRecord', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_extension of fhir['extension'] || []) {
      ...
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/shr-entity-AccessTime-extension') {
        inst.accessTime = FHIRHelper.createInstanceFromFHIR('shr.entity.AccessTime', fhir_extension, 'Extension', shrId, allEntries, mappedResources, referencesOut, true);
      }
    }
    return inst;
  }
