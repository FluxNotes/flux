...
class Party extends Content {
  ...
  /**
   * Serializes an instance of the Party class to a FHIR object.
   * The FHIR is expected to be valid against the Party FHIR profile, but no validation checks are performed.
  ...
  toFHIR(asExtension = false) {
    ...
    if (asExtension) {
      ...
      inst['url'] = 'http://standardhealthrecord.org/fhir/StructureDefinition/shr-entity-Party-extension';
    }
    return inst;
  }
}
