...
class Group extends Entity {
  ...
  toFHIR(asExtension=false) {
    ...
    if (this.member != null && this.member.patient != null) {
      ...
      inst['member']['entity'] = inst['member']['entity'].concat(this.member.patient.map(f => typeof f.toFHIR === 'function' ? f.toFHIR() : f));
    }
    if (this.member != null && this.member.participationPeriod != null) {
      ...
      inst['member']['period'] = inst['member']['period'].concat(this.member.participationPeriod.map(f => typeof f.toFHIR === 'function' ? f.toFHIR() : f));
    }
    if (this.member != null && this.member.activeFlag != null) {
      ...
      inst['member']['inactive'] = inst['member']['inactive'].concat(this.member.activeFlag.map(f => typeof f.toFHIR === 'function' ? f.toFHIR() : f));
    }
    return inst;
  }
  ...
  static fromFHIR(fhir, asExtension=false) {
    ...
    if (fhir['characteristic'] != null && fhir['characteristic']['value[x]'] != null) {
      if(inst.groupCharacteristic == null) {
        inst.groupCharacteristic = createInstanceFromFHIR('shr.entity.GroupCharacteristic', {});
      }
      inst.groupCharacteristic.groupCharacteristicValue = createInstanceFromFHIR('shr.entity.GroupCharacteristicValue', fhir['characteristic']['value[x]']);
    }
    ...
    if (fhir['member'] != null && fhir['member']['entity'] != null) {
      if(inst.member == null) {
        inst.member = createInstanceFromFHIR('shr.entity.Member', {});
      }
      inst.member.patient = createInstanceFromFHIR('shr.entity.Patient', fhir['member']['entity'][0]);
    }
    if (fhir['member'] != null && fhir['member']['period'] != null) {
      if(inst.member == null) {
        inst.member = createInstanceFromFHIR('shr.entity.Member', {});
      }
      inst.member.participationPeriod = createInstanceFromFHIR('shr.base.ParticipationPeriod', fhir['member']['period']);
    }
    if (fhir['member'] != null && fhir['member']['inactive'] != null) {
      if(inst.member == null) {
        inst.member = createInstanceFromFHIR('shr.entity.Member', {});
      }
      inst.member.activeFlag = createInstanceFromFHIR('shr.entity.ActiveFlag', fhir['member']['inactive']);
    }
    return inst;
  }
