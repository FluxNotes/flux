...
class Practitioner extends Role {
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/entity/Practitioner', 'uri');
    if (fhir['meta'] != null) {
    ...
    if (fhir['identifier'] != null && fhir['identifier'][0] != null) {
      inst.nationalProviderIdentifier = FHIRHelper.createInstanceFromFHIR('shr.entity.NationalProviderIdentifier', fhir['identifier'][0], 'Identifier', shrId, allEntries, mappedResources, referencesOut, false);
    }
    if (fhir['active'] != null) {
    ...
    for (const fhir_qualification of fhir['qualification'] || []) {
      ...
      const inst_qualification = FHIRHelper.createInstanceFromFHIR('shr.entity.Qualification', fhir_qualification, 'BackboneElement', shrId, allEntries, mappedResources, referencesOut, false);
    ...
    for (const fhir_communication of fhir['communication'] || []) {
      ...
      inst_person_reference_languageUsed.language = FHIRHelper.createInstanceFromFHIR('shr.core.Language', fhir_communication, 'CodeableConcept', shrId, allEntries, mappedResources, referencesOut, false);
    }
    return inst;
  }
