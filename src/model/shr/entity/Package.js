...
/**
 * Generated class for shr.entity.Package.
 */
class Package {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.entity', 'Package');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/Package' } };
    if (this.value != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the Package class.
   * The FHIR must be valid against the Package FHIR profile, although this is not validated by the function.
   ...
   * @returns {Package} An instance of Package populated with the FHIR data
   */
