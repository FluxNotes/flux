...
class ActiveFlagAsaCodeableConcept {
  ...
  /**
   * Serializes an instance of the ActiveFlagAsaCodeableConcept class to a FHIR object.
   * The FHIR is expected to be valid against the ActiveFlagAsaCodeableConcept FHIR profile, but no validation checks are performed.
  ...
  toFHIR(asExtension=false) {
    let inst = {};
    if (asExtension) {
      inst['url'] = 'http://example.com/fhir/StructureDefinition/shr-entity-ActiveFlagAsaCodeableConcept-extension';
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ActiveFlagAsaCodeableConcept class.
   * The FHIR must be valid against the ActiveFlagAsaCodeableConcept FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {asExtension=false} Whether the provided instance is an extension
   * @returns {ActiveFlagAsaCodeableConcept} An instance of ActiveFlagAsaCodeableConcept populated with the FHIR data
   */
