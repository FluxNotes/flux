...
class Substance extends Entity {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('shr.entity', 'Substance');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/entity/Substance', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_extension of fhir['extension'] || []) {
      ...
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/shr-core-Category-extension' && fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/shr-core-Category-extension') {
        ...
        const inst_category = FHIRHelper.createInstanceFromFHIR('shr.core.Category', fhir_extension, 'Extension', shrId, allEntries, mappedResources, referencesOut, true);
        inst.category.push(inst_category);
        if (fhir_extension['valueCodeableConcept'] != null) {
          inst_category.value = FHIRHelper.createInstanceFromFHIR('shr.core.CodeableConcept', fhir_extension['valueCodeableConcept'], 'CodeableConcept', shrId, allEntries, mappedResources, referencesOut, false);
        }
      }
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/shr-entity-ActiveFlag-extension' && fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/shr-entity-ActiveFlag-extension') {
        ...
        if (fhir_extension['valueCodeableConcept'] != null) {
          inst.activeFlag.value = FHIRHelper.createInstanceFromFHIR('shr.core.CodeableConcept', fhir_extension['valueCodeableConcept'], 'CodeableConcept', shrId, allEntries, mappedResources, referencesOut, false);
        }
      }
    ...
    for (const fhir_ingredient of fhir['ingredient'] || []) {
      inst.ingredient = inst.ingredient || [];
      const inst_ingredient = FHIRHelper.createInstanceFromFHIR('shr.entity.Ingredient', fhir_ingredient, 'BackboneElement', shrId, allEntries, mappedResources, referencesOut, false);
      inst.ingredient.push(inst_ingredient);
      if (fhir_ingredient['quantity'] != null) {
        inst_ingredient.ingredientAmount = FHIRHelper.createInstanceFromFHIR('shr.entity.IngredientAmount', fhir_ingredient['quantity'], 'Ratio', shrId, allEntries, mappedResources, referencesOut, false);
      }
      if (fhir_ingredient['substance'] != null) {
        inst_ingredient.substanceOrCode = inst_ingredient.substanceOrCode || FHIRHelper.createInstanceFromFHIR('shr.entity.SubstanceOrCode', {}, null, shrId);
