...
class Substance extends Entity {
  ...
  static fromFHIR(fhir, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/shr/entity/Substance');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_ingredient of fhir['ingredient'] || []) {
      ...
      const inst_ingredient = FHIRHelper.createInstanceFromFHIR('shr.entity.Ingredient', fhir_ingredient, shrId, allEntries, mappedResources, referencesOut, false);
