...
/**
 * Generated class for tumor.TumorMargins.
 * @extends CodedLaboratoryObservation
 */
class TumorMargins extends CodedLaboratoryObservation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('tumor', 'TumorMargins');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/tumor/TumorMargins' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TumorMargins class.
   * The FHIR must be valid against the TumorMargins FHIR profile, although this is not validated by the function.
   ...
   * @returns {TumorMargins} An instance of TumorMargins populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/tumor/TumorMargins', 'uri');
    if (fhir['meta'] != null) {
