...
/**
 * Generated class for tumor.TumorDimension1.
 * @extends QuantitativeNonIndependentFinding
 */
class TumorDimension1 extends QuantitativeNonIndependentFinding {
  ...
  /**
   * Deserializes JSON data to an instance of the TumorDimension1 class.
   * The JSON must be valid against the TumorDimension1 JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {TumorDimension1} An instance of TumorDimension1 populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('tumor', 'TumorDimension1');
  ...
  /**
   * Serializes an instance of the TumorDimension1 class to a JSON object.
   * The JSON is expected to be valid against the TumorDimension1 JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/tumor/TumorDimension1' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TumorDimension1 class.
   * The FHIR must be valid against the TumorDimension1 FHIR profile, although this is not validated by the function.
   ...
   * @returns {TumorDimension1} An instance of TumorDimension1 populated with the FHIR data
   */
...
export default TumorDimension1;
