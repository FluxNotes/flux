...
/**
 * Generated class for tumor.TumorMarginDescription.
 * @extends CodedNonIndependentFinding
 */
class TumorMarginDescription extends CodedNonIndependentFinding {
   ...
   * @param {FindingResult} findingResult - The shr.base.FindingResult
   * @returns {TumorMarginDescription} this.
   */
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('tumor', 'TumorMarginDescription');
  ...
  /**
   * Serializes an instance of the TumorMarginDescription class to a JSON object.
   * The JSON is expected to be valid against the TumorMarginDescription JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/tumor/TumorMarginDescription' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TumorMarginDescription class.
   * The FHIR must be valid against the TumorMarginDescription FHIR profile, although this is not validated by the function.
   ...
   * @returns {TumorMarginDescription} An instance of TumorMarginDescription populated with the FHIR data
   */
