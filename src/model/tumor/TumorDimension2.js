...
/**
 * Generated class for tumor.TumorDimension2.
 * @extends QuantitativeNonIndependentFinding
 */
class TumorDimension2 extends QuantitativeNonIndependentFinding {
  ...
  /**
   * Deserializes JSON data to an instance of the TumorDimension2 class.
   * The JSON must be valid against the TumorDimension2 JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {TumorDimension2} An instance of TumorDimension2 populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('tumor', 'TumorDimension2');
  ...
  /**
   * Serializes an instance of the TumorDimension2 class to a JSON object.
   * The JSON is expected to be valid against the TumorDimension2 JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/tumor/TumorDimension2' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TumorDimension2 class.
   * The FHIR must be valid against the TumorDimension2 FHIR profile, although this is not validated by the function.
   ...
   * @returns {TumorDimension2} An instance of TumorDimension2 populated with the FHIR data
   */
...
export default TumorDimension2;
