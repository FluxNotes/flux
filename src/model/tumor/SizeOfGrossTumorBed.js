...
/**
 * Generated class for tumor.SizeOfGrossTumorBed.
 * @extends QuantitativeNonIndependentFinding
 */
class SizeOfGrossTumorBed extends QuantitativeNonIndependentFinding {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('tumor', 'SizeOfGrossTumorBed');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/tumor/SizeOfGrossTumorBed' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the SizeOfGrossTumorBed class.
   * The FHIR must be valid against the SizeOfGrossTumorBed FHIR profile, although this is not validated by the function.
   ...
   * @returns {SizeOfGrossTumorBed} An instance of SizeOfGrossTumorBed populated with the FHIR data
   */
