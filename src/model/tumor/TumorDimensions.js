...
/**
 * Generated class for tumor.TumorDimensions.
...
class TumorDimensions extends CodedLaboratoryObservation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('tumor', 'TumorDimensions');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/tumor/TumorDimensions' };
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/tumor/TumorDimensions', 'uri');
    if (fhir['meta'] != null) {
      ...
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/shr-base-SpecificFocusOfFinding-extension' && fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/shr-base-SpecificFocusOfFinding-extension') {
        ...
        if (fhir_extension['valueReference'] != null) {
          ...
          if (!mappedResources[entryId]) {
            ...
            if (referencedEntry) {
              mappedResources[entryId] = FHIRHelper.createInstanceFromFHIR('tumor.TumorPresent', referencedEntry['resource'], 'undefined', shrId, allEntries, mappedResources, referencesOut);
            }
          }
          if (mappedResources[entryId]) {
            ...
            const entryType = 'http://standardhealthrecord.org/spec/tumor/TumorPresent';
    ...
    for (const fhir_component of fhir['component'] || []) {
      ...
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '372299002')) {
