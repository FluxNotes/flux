...
/**
 * Generated class for tumor.Cellularity.
 * @extends QuantitativeNonIndependentFinding
 */
class Cellularity extends QuantitativeNonIndependentFinding {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('tumor', 'Cellularity');
  ...
  /**
   * Serializes an instance of the Cellularity class to a JSON object.
   * The JSON is expected to be valid against the Cellularity JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/tumor/Cellularity' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the Cellularity class.
   * The FHIR must be valid against the Cellularity FHIR profile, although this is not validated by the function.
   ...
   * @returns {Cellularity} An instance of Cellularity populated with the FHIR data
   */
