...
/**
 * Generated class for onco.core.SecondaryCancerCondition.
 * @extends CancerCondition
 */
class SecondaryCancerCondition extends CancerCondition {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {SecondaryCancerCondition} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the SecondaryCancerCondition class.
   * The JSON must be valid against the SecondaryCancerCondition JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {SecondaryCancerCondition} An instance of SecondaryCancerCondition populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('onco.core', 'SecondaryCancerCondition');
  ...
  /**
   * Serializes an instance of the SecondaryCancerCondition class to a JSON object.
   * The JSON is expected to be valid against the SecondaryCancerCondition JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/onco/core/SecondaryCancerCondition' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the SecondaryCancerCondition class.
   * The FHIR must be valid against the SecondaryCancerCondition FHIR profile, although this is not validated by the function.
   ...
   * @returns {SecondaryCancerCondition} An instance of SecondaryCancerCondition populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/onco/core/SecondaryCancerCondition', 'uri');
    if (fhir['meta'] != null) {
...
export default SecondaryCancerCondition;
