...
/**
 * Generated class for onco.core.TNMClinicalRegionalNodesCategory.
 * @extends CancerStageCategory
 */
class TNMClinicalRegionalNodesCategory extends CancerStageCategory {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {TNMClinicalRegionalNodesCategory} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the TNMClinicalRegionalNodesCategory class.
   * The JSON must be valid against the TNMClinicalRegionalNodesCategory JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {TNMClinicalRegionalNodesCategory} An instance of TNMClinicalRegionalNodesCategory populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('onco.core', 'TNMClinicalRegionalNodesCategory');
  ...
  /**
   * Serializes an instance of the TNMClinicalRegionalNodesCategory class to a JSON object.
   * The JSON is expected to be valid against the TNMClinicalRegionalNodesCategory JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/onco/core/TNMClinicalRegionalNodesCategory' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TNMClinicalRegionalNodesCategory class.
   * The FHIR must be valid against the TNMClinicalRegionalNodesCategory FHIR profile, although this is not validated by the function.
   ...
   * @returns {TNMClinicalRegionalNodesCategory} An instance of TNMClinicalRegionalNodesCategory populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/onco/core/TNMClinicalRegionalNodesCategory', 'uri');
    if (fhir['meta'] != null) {
...
export default TNMClinicalRegionalNodesCategory;
