...
/**
 * Generated class for onco.core.CancerDiseaseStatus.
 * @extends CodedNonLaboratoryObservation
 */
class CancerDiseaseStatus extends CodedNonLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {CancerDiseaseStatus} this.
   */
  ...
  /**
   * Get the RelatedCancerCondition.
   * @returns {RelatedCancerCondition} The onco.core.RelatedCancerCondition
   */
  get relatedCancerCondition() {
    return this._relatedCancerCondition;
  }

  /**
   * Set the RelatedCancerCondition.
   * @param {RelatedCancerCondition} relatedCancerCondition - The onco.core.RelatedCancerCondition
   */
  set relatedCancerCondition(relatedCancerCondition) {
    this._relatedCancerCondition = relatedCancerCondition;
  }

  /**
   * Set the RelatedCancerCondition and return 'this' for chaining.
   * @param {RelatedCancerCondition} relatedCancerCondition - The onco.core.RelatedCancerCondition
   * @returns {CancerDiseaseStatus} this.
   */
  withRelatedCancerCondition(relatedCancerCondition) {
    this.relatedCancerCondition = relatedCancerCondition; return this;
  }

  /**
   * Get the EvidenceType array.
   * @returns {Array<EvidenceType>} The onco.core.EvidenceType array
   */
  get evidenceType() {
  ...
  /**
   * Set the EvidenceType array.
   * @param {Array<EvidenceType>} evidenceType - The onco.core.EvidenceType array
   */
  ...
  /**
   * Set the EvidenceType array and return 'this' for chaining.
   * @param {Array<EvidenceType>} evidenceType - The onco.core.EvidenceType array
   * @returns {CancerDiseaseStatus} this.
   */
  withEvidenceType(evidenceType) {
    this.evidenceType = evidenceType; return this;
  }

  /**
   * Deserializes JSON data to an instance of the CancerDiseaseStatus class.
   * The JSON must be valid against the CancerDiseaseStatus JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {CancerDiseaseStatus} An instance of CancerDiseaseStatus populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('onco.core', 'CancerDiseaseStatus');
  ...
  /**
   * Serializes an instance of the CancerDiseaseStatus class to a JSON object.
   * The JSON is expected to be valid against the CancerDiseaseStatus JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/onco/core/CancerDiseaseStatus' };
    ...
    if (this.relatedCancerCondition != null) {
      inst['RelatedCancerCondition'] = typeof this.relatedCancerCondition.toJSON === 'function' ? this.relatedCancerCondition.toJSON() : this.relatedCancerCondition;
    }
    if (this.evidenceType != null) {
      inst['EvidenceType'] = this.evidenceType.map(f => f.toJSON());
    }
    return inst;
  }

  /**
   * Deserializes FHIR JSON data to an instance of the CancerDiseaseStatus class.
   * The FHIR must be valid against the CancerDiseaseStatus FHIR profile, although this is not validated by the function.
   ...
   * @returns {CancerDiseaseStatus} An instance of CancerDiseaseStatus populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/onco/core/CancerDiseaseStatus', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_extension of fhir['extension'] || []) {
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/onco-core-RelatedCancerCondition-extension') {
        inst.relatedCancerCondition = FHIRHelper.createInstanceFromFHIR('onco.core.RelatedCancerCondition', fhir_extension, 'Extension', shrId, allEntries, mappedResources, referencesOut, true);
      }
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/onco-core-EvidenceType-extension' && fhir_extension['url'] != null && fhir_extension['url'] === 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/onco-core-EvidenceType-extension') {
        inst.evidenceType = inst.evidenceType || [];
        const inst_evidenceType = FHIRHelper.createInstanceFromFHIR('onco.core.EvidenceType', fhir_extension, 'Extension', shrId, allEntries, mappedResources, referencesOut, true);
        inst.evidenceType.push(inst_evidenceType);
        if (fhir_extension['valueCodeableConcept'] != null) {
          inst_evidenceType.value = FHIRHelper.createInstanceFromFHIR('shr.core.CodeableConcept', fhir_extension['valueCodeableConcept'], 'CodeableConcept', shrId, allEntries, mappedResources, referencesOut, false);
        }
      }
    }
...
export default CancerDiseaseStatus;
