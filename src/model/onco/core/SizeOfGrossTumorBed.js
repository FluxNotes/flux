...
/**
 * Generated class for onco.core.SizeOfGrossTumorBed.
 * @extends QuantitativeObservationComponent
 */
class SizeOfGrossTumorBed extends QuantitativeObservationComponent {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('onco.core', 'SizeOfGrossTumorBed');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/onco/core/SizeOfGrossTumorBed' } };
    if (this.code != null) {
