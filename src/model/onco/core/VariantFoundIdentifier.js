...
/**
 * Generated class for onco.core.VariantFoundIdentifier.
 * @extends CodedObservationComponent
 */
class VariantFoundIdentifier extends CodedObservationComponent {
   ...
   * This field/value is required.
   * @param {Code} code - The shr.core.Code
   * @returns {VariantFoundIdentifier} this.
   */
  withCode(code) {
  ...
  /**
   * Deserializes JSON data to an instance of the VariantFoundIdentifier class.
   * The JSON must be valid against the VariantFoundIdentifier JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {VariantFoundIdentifier} An instance of VariantFoundIdentifier populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('onco.core', 'VariantFoundIdentifier');
  ...
  /**
   * Serializes an instance of the VariantFoundIdentifier class to a JSON object.
   * The JSON is expected to be valid against the VariantFoundIdentifier JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/onco/core/VariantFoundIdentifier' } };
    if (this.code != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the VariantFoundIdentifier class.
   * The FHIR must be valid against the VariantFoundIdentifier FHIR profile, although this is not validated by the function.
   ...
   * @returns {VariantFoundIdentifier} An instance of VariantFoundIdentifier populated with the FHIR data
   */
...
export default VariantFoundIdentifier;
