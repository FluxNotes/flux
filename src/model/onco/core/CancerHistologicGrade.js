...
/**
 * Generated class for onco.core.CancerHistologicGrade.
 * @extends CodedLaboratoryObservation
 */
class CancerHistologicGrade extends CodedLaboratoryObservation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('onco.core', 'CancerHistologicGrade');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/onco/core/CancerHistologicGrade' };
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/onco/core/CancerHistologicGrade', 'uri');
    if (fhir['meta'] != null) {
