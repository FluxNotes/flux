...
/**
 * Generated class for onco.core.TNMClinicalPrimaryTumorCategory.
 * @extends CancerStageCategory
 */
class TNMClinicalPrimaryTumorCategory extends CancerStageCategory {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {TNMClinicalPrimaryTumorCategory} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the TNMClinicalPrimaryTumorCategory class.
   * The JSON must be valid against the TNMClinicalPrimaryTumorCategory JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {TNMClinicalPrimaryTumorCategory} An instance of TNMClinicalPrimaryTumorCategory populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('onco.core', 'TNMClinicalPrimaryTumorCategory');
  ...
  /**
   * Serializes an instance of the TNMClinicalPrimaryTumorCategory class to a JSON object.
   * The JSON is expected to be valid against the TNMClinicalPrimaryTumorCategory JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/onco/core/TNMClinicalPrimaryTumorCategory' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TNMClinicalPrimaryTumorCategory class.
   * The FHIR must be valid against the TNMClinicalPrimaryTumorCategory FHIR profile, although this is not validated by the function.
   ...
   * @returns {TNMClinicalPrimaryTumorCategory} An instance of TNMClinicalPrimaryTumorCategory populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/onco/core/TNMClinicalPrimaryTumorCategory', 'uri');
    if (fhir['meta'] != null) {
...
export default TNMClinicalPrimaryTumorCategory;
