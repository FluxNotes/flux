...
/**
 * Generated class for onco.core.TNMClinicalDistantMetastasesCategory.
 * @extends CancerStageCategory
 */
class TNMClinicalDistantMetastasesCategory extends CancerStageCategory {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {TNMClinicalDistantMetastasesCategory} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the TNMClinicalDistantMetastasesCategory class.
   * The JSON must be valid against the TNMClinicalDistantMetastasesCategory JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {TNMClinicalDistantMetastasesCategory} An instance of TNMClinicalDistantMetastasesCategory populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('onco.core', 'TNMClinicalDistantMetastasesCategory');
  ...
  /**
   * Serializes an instance of the TNMClinicalDistantMetastasesCategory class to a JSON object.
   * The JSON is expected to be valid against the TNMClinicalDistantMetastasesCategory JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/onco/core/TNMClinicalDistantMetastasesCategory' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TNMClinicalDistantMetastasesCategory class.
   * The FHIR must be valid against the TNMClinicalDistantMetastasesCategory FHIR profile, although this is not validated by the function.
   ...
   * @returns {TNMClinicalDistantMetastasesCategory} An instance of TNMClinicalDistantMetastasesCategory populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/onco/core/TNMClinicalDistantMetastasesCategory', 'uri');
    if (fhir['meta'] != null) {
