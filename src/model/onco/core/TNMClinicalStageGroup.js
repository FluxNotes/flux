...
/**
 * Generated class for onco.core.TNMClinicalStageGroup.
 * @extends CancerStageGroup
 */
class TNMClinicalStageGroup extends CancerStageGroup {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('onco.core', 'TNMClinicalStageGroup');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/onco/core/TNMClinicalStageGroup' };
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/onco/core/TNMClinicalStageGroup', 'uri');
    if (fhir['meta'] != null) {
