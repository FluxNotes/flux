...
/**
 * Generated class for onco.core.TumorMarkerTest.
 * @extends LaboratoryObservation
 */
class TumorMarkerTest extends LaboratoryObservation {
  ...
  /**
   * Deserializes JSON data to an instance of the TumorMarkerTest class.
   * The JSON must be valid against the TumorMarkerTest JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {TumorMarkerTest} An instance of TumorMarkerTest populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('onco.core', 'TumorMarkerTest');
  ...
  /**
   * Serializes an instance of the TumorMarkerTest class to a JSON object.
   * The JSON is expected to be valid against the TumorMarkerTest JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/onco/core/TumorMarkerTest' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TumorMarkerTest class.
   * The FHIR must be valid against the TumorMarkerTest FHIR profile, although this is not validated by the function.
   ...
   * @returns {TumorMarkerTest} An instance of TumorMarkerTest populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/onco/core/TumorMarkerTest', 'uri');
    if (fhir['meta'] != null) {
    ...
    if (fhir['valueCodeableConcept'] != null) {
      inst.dataValue = FHIRHelper.createInstanceFromFHIR('onco.core.TumorMarkerTestDataValue', fhir['valueCodeableConcept'], 'CodeableConcept', shrId, allEntries, mappedResources, referencesOut, false);
    }
    if (fhir['valueQuantity'] != null) {
      inst.dataValue = FHIRHelper.createInstanceFromFHIR('onco.core.TumorMarkerTestDataValue', fhir['valueQuantity'], 'Quantity', shrId, allEntries, mappedResources, referencesOut, false);
    }
    if (fhir['valueRatio'] != null) {
      inst.dataValue = FHIRHelper.createInstanceFromFHIR('onco.core.TumorMarkerTestDataValue', fhir['valueRatio'], 'Ratio', shrId, allEntries, mappedResources, referencesOut, false);
    }
...
export default TumorMarkerTest;
