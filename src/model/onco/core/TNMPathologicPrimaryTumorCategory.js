...
/**
 * Generated class for onco.core.TNMPathologicPrimaryTumorCategory.
 * @extends CancerStageCategory
 */
class TNMPathologicPrimaryTumorCategory extends CancerStageCategory {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {TNMPathologicPrimaryTumorCategory} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the TNMPathologicPrimaryTumorCategory class.
   * The JSON must be valid against the TNMPathologicPrimaryTumorCategory JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {TNMPathologicPrimaryTumorCategory} An instance of TNMPathologicPrimaryTumorCategory populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('onco.core', 'TNMPathologicPrimaryTumorCategory');
  ...
  /**
   * Serializes an instance of the TNMPathologicPrimaryTumorCategory class to a JSON object.
   * The JSON is expected to be valid against the TNMPathologicPrimaryTumorCategory JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/onco/core/TNMPathologicPrimaryTumorCategory' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TNMPathologicPrimaryTumorCategory class.
   * The FHIR must be valid against the TNMPathologicPrimaryTumorCategory FHIR profile, although this is not validated by the function.
   ...
   * @returns {TNMPathologicPrimaryTumorCategory} An instance of TNMPathologicPrimaryTumorCategory populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/onco/core/TNMPathologicPrimaryTumorCategory', 'uri');
    if (fhir['meta'] != null) {
...
export default TNMPathologicPrimaryTumorCategory;
