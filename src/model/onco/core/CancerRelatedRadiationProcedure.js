...
import RadiationProcedure from '../../shr/core/RadiationProcedure';

/**
 * Generated class for onco.core.CancerRelatedRadiationProcedure.
 * @extends RadiationProcedure
 */
class CancerRelatedRadiationProcedure extends RadiationProcedure {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {CancerRelatedRadiationProcedure} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the CancerRelatedRadiationProcedure class.
   * The JSON must be valid against the CancerRelatedRadiationProcedure JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {CancerRelatedRadiationProcedure} An instance of CancerRelatedRadiationProcedure populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('onco.core', 'CancerRelatedRadiationProcedure');
  ...
  /**
   * Serializes an instance of the CancerRelatedRadiationProcedure class to a JSON object.
   * The JSON is expected to be valid against the CancerRelatedRadiationProcedure JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/onco/core/CancerRelatedRadiationProcedure' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the CancerRelatedRadiationProcedure class.
   * The FHIR must be valid against the CancerRelatedRadiationProcedure FHIR profile, although this is not validated by the function.
   ...
   * @returns {CancerRelatedRadiationProcedure} An instance of CancerRelatedRadiationProcedure populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/onco/core/CancerRelatedRadiationProcedure', 'uri');
    if (fhir['meta'] != null) {
...
export default CancerRelatedRadiationProcedure;
