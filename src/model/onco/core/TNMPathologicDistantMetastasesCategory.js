...
import CancerStageCategory from './CancerStageCategory';

/**
 * Generated class for onco.core.TNMPathologicDistantMetastasesCategory.
 * @extends CancerStageCategory
 */
class TNMPathologicDistantMetastasesCategory extends CancerStageCategory {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {TNMPathologicDistantMetastasesCategory} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the TNMPathologicDistantMetastasesCategory class.
   * The JSON must be valid against the TNMPathologicDistantMetastasesCategory JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {TNMPathologicDistantMetastasesCategory} An instance of TNMPathologicDistantMetastasesCategory populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('onco.core', 'TNMPathologicDistantMetastasesCategory');
  ...
  /**
   * Serializes an instance of the TNMPathologicDistantMetastasesCategory class to a JSON object.
   * The JSON is expected to be valid against the TNMPathologicDistantMetastasesCategory JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/onco/core/TNMPathologicDistantMetastasesCategory' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TNMPathologicDistantMetastasesCategory class.
   * The FHIR must be valid against the TNMPathologicDistantMetastasesCategory FHIR profile, although this is not validated by the function.
   ...
   * @returns {TNMPathologicDistantMetastasesCategory} An instance of TNMPathologicDistantMetastasesCategory populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/onco/core/TNMPathologicDistantMetastasesCategory', 'uri');
    if (fhir['meta'] != null) {
...
export default TNMPathologicDistantMetastasesCategory;
