...
import SimpleCodedNonLaboratoryObservation from '../../shr/core/SimpleCodedNonLaboratoryObservation';

/**
 * Generated class for onco.core.CancerStageCategory.
 * @extends SimpleCodedNonLaboratoryObservation
 */
class CancerStageCategory extends SimpleCodedNonLaboratoryObservation {
   ...
   * This field/value is required.
   * @param {PatientSubjectOfRecord} subjectOfRecord - The shr.core.PatientSubjectOfRecord
   * @returns {CancerStageCategory} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the CancerStageCategory class.
   * The JSON must be valid against the CancerStageCategory JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {CancerStageCategory} An instance of CancerStageCategory populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('onco.core', 'CancerStageCategory');
  ...
  /**
   * Serializes an instance of the CancerStageCategory class to a JSON object.
   * The JSON is expected to be valid against the CancerStageCategory JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/onco/core/CancerStageCategory' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the CancerStageCategory class.
   * The FHIR must be valid against the CancerStageCategory FHIR profile, although this is not validated by the function.
   ...
   * @returns {CancerStageCategory} An instance of CancerStageCategory populated with the FHIR data
   */
...
export default CancerStageCategory;
