...
/**
 * Generated class for onco.core.TumorInvolvementAtSurgicalMargin.
 * @extends CodedLaboratoryObservation
 */
class TumorInvolvementAtSurgicalMargin extends CodedLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {TumorInvolvementAtSurgicalMargin} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the TumorInvolvementAtSurgicalMargin class.
   * The JSON must be valid against the TumorInvolvementAtSurgicalMargin JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {TumorInvolvementAtSurgicalMargin} An instance of TumorInvolvementAtSurgicalMargin populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('onco.core', 'TumorInvolvementAtSurgicalMargin');
  ...
  /**
   * Serializes an instance of the TumorInvolvementAtSurgicalMargin class to a JSON object.
   * The JSON is expected to be valid against the TumorInvolvementAtSurgicalMargin JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/onco/core/TumorInvolvementAtSurgicalMargin' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TumorInvolvementAtSurgicalMargin class.
   * The FHIR must be valid against the TumorInvolvementAtSurgicalMargin FHIR profile, although this is not validated by the function.
   ...
   * @returns {TumorInvolvementAtSurgicalMargin} An instance of TumorInvolvementAtSurgicalMargin populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/onco/core/TumorInvolvementAtSurgicalMargin', 'uri');
    if (fhir['meta'] != null) {
...
export default TumorInvolvementAtSurgicalMargin;
