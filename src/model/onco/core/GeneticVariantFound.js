...
/**
 * Generated class for onco.core.GeneticVariantFound.
 * @extends LaboratoryObservation
 */
class GeneticVariantFound extends LaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {GeneticVariantFound} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the GeneticVariantFound class.
   * The JSON must be valid against the GeneticVariantFound JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {GeneticVariantFound} An instance of GeneticVariantFound populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('onco.core', 'GeneticVariantFound');
  ...
  /**
   * Serializes an instance of the GeneticVariantFound class to a JSON object.
   * The JSON is expected to be valid against the GeneticVariantFound JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/onco/core/GeneticVariantFound' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the GeneticVariantFound class.
   * The FHIR must be valid against the GeneticVariantFound FHIR profile, although this is not validated by the function.
   ...
   * @returns {GeneticVariantFound} An instance of GeneticVariantFound populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/onco/core/GeneticVariantFound', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_component of fhir['component'] || []) {
      ...
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '48002-0')) {
      }
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '48003-8')) {
      }
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '82154-6')) {
      }
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '47998-0')) {
      }
    }
    return inst;
  }
...
export default GeneticVariantFound;
