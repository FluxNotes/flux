...
/**
 * Generated class for onco.core.TNMPathologicRegionalNodesCategory.
 * @extends CancerStageCategory
 */
class TNMPathologicRegionalNodesCategory extends CancerStageCategory {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {TNMPathologicRegionalNodesCategory} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the TNMPathologicRegionalNodesCategory class.
   * The JSON must be valid against the TNMPathologicRegionalNodesCategory JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {TNMPathologicRegionalNodesCategory} An instance of TNMPathologicRegionalNodesCategory populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('onco.core', 'TNMPathologicRegionalNodesCategory');
  ...
  /**
   * Serializes an instance of the TNMPathologicRegionalNodesCategory class to a JSON object.
   * The JSON is expected to be valid against the TNMPathologicRegionalNodesCategory JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/onco/core/TNMPathologicRegionalNodesCategory' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TNMPathologicRegionalNodesCategory class.
   * The FHIR must be valid against the TNMPathologicRegionalNodesCategory FHIR profile, although this is not validated by the function.
   ...
   * @returns {TNMPathologicRegionalNodesCategory} An instance of TNMPathologicRegionalNodesCategory populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/onco/core/TNMPathologicRegionalNodesCategory', 'uri');
    if (fhir['meta'] != null) {
...
export default TNMPathologicRegionalNodesCategory;
