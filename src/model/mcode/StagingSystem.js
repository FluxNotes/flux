...
/**
 * Generated class for mcode.StagingSystem.
 * @extends NonIndependentFinding
 */
class StagingSystem extends NonIndependentFinding {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/mcode/StagingSystem' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the StagingSystem class to a FHIR object.
   * The FHIR is expected to be valid against the StagingSystem FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the StagingSystem class.
   * The FHIR must be valid against the StagingSystem FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {asExtension=false} Whether the provided instance is an extension
   * @returns {StagingSystem} An instance of StagingSystem populated with the FHIR data
   */
