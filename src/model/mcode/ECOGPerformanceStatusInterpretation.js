...
/**
 * Generated class for mcode.ECOGPerformanceStatusInterpretation.
 * @extends CodedNonLaboratoryObservation
 */
class ECOGPerformanceStatusInterpretation extends CodedNonLaboratoryObservation {
   ...
   * This field/value is required.
   * @param {CodeableConcept} value - The shr.core.CodeableConcept
   * @returns {ECOGPerformanceStatusInterpretation} this.
   */
  withValue(value) {
  ...
  /**
   * Deserializes JSON data to an instance of the ECOGPerformanceStatusInterpretation class.
   * The JSON must be valid against the ECOGPerformanceStatusInterpretation JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {ECOGPerformanceStatusInterpretation} An instance of ECOGPerformanceStatusInterpretation populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new ECOGPerformanceStatusInterpretation();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the ECOGPerformanceStatusInterpretation class to a JSON object.
   * The JSON is expected to be valid against the ECOGPerformanceStatusInterpretation JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/mcode/ECOGPerformanceStatusInterpretation' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the ECOGPerformanceStatusInterpretation class to a FHIR object.
   * The FHIR is expected to be valid against the ECOGPerformanceStatusInterpretation FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ECOGPerformanceStatusInterpretation class.
   * The FHIR must be valid against the ECOGPerformanceStatusInterpretation FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {asExtension=false} Whether the provided instance is an extension
   * @returns {ECOGPerformanceStatusInterpretation} An instance of ECOGPerformanceStatusInterpretation populated with the FHIR data
   */
...
export default ECOGPerformanceStatusInterpretation;
