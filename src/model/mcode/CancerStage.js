...
/**
 * Generated class for mcode.CancerStage.
 * @extends Observation
 */
class CancerStage extends Observation {
  ...
  /**
   * Deserializes JSON data to an instance of the CancerStage class.
   * The JSON must be valid against the CancerStage JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {CancerStage} An instance of CancerStage populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new CancerStage();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the CancerStage class to a JSON object.
   * The JSON is expected to be valid against the CancerStage JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/mcode/CancerStage' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the CancerStage class to a FHIR object.
   * The FHIR is expected to be valid against the CancerStage FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the CancerStage class.
   * The FHIR must be valid against the CancerStage FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {asExtension=false} Whether the provided instance is an extension
   * @returns {CancerStage} An instance of CancerStage populated with the FHIR data
   */
