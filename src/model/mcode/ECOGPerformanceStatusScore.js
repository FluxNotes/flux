...
/**
 * Generated class for mcode.ECOGPerformanceStatusScore.
 * @extends SimpleNonLaboratoryObservation
 */
class ECOGPerformanceStatusScore extends SimpleNonLaboratoryObservation {
   ...
   * This field/value is required.
   * @param {IntegerQuantity} value - The shr.core.IntegerQuantity
   * @returns {ECOGPerformanceStatusScore} this.
   */
  withValue(value) {
  ...
  /**
   * Deserializes JSON data to an instance of the ECOGPerformanceStatusScore class.
   * The JSON must be valid against the ECOGPerformanceStatusScore JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {ECOGPerformanceStatusScore} An instance of ECOGPerformanceStatusScore populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new ECOGPerformanceStatusScore();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the ECOGPerformanceStatusScore class to a JSON object.
   * The JSON is expected to be valid against the ECOGPerformanceStatusScore JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/mcode/ECOGPerformanceStatusScore' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the ECOGPerformanceStatusScore class to a FHIR object.
   * The FHIR is expected to be valid against the ECOGPerformanceStatusScore FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ECOGPerformanceStatusScore class.
   * The FHIR must be valid against the ECOGPerformanceStatusScore FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {asExtension=false} Whether the provided instance is an extension
   * @returns {ECOGPerformanceStatusScore} An instance of ECOGPerformanceStatusScore populated with the FHIR data
   */
...
export default ECOGPerformanceStatusScore;
