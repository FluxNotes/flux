...
/**
 * Generated class for mcode.StageGroup.
 * @extends CodedNonLaboratoryObservation
 */
class StageGroup extends CodedNonLaboratoryObservation {
  ...
  /**
   * Deserializes JSON data to an instance of the StageGroup class.
   * The JSON must be valid against the StageGroup JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {StageGroup} An instance of StageGroup populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new StageGroup();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the StageGroup class to a JSON object.
   * The JSON is expected to be valid against the StageGroup JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/mcode/StageGroup' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the StageGroup class to a FHIR object.
   * The FHIR is expected to be valid against the StageGroup FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the StageGroup class.
   * The FHIR must be valid against the StageGroup FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {asExtension=false} Whether the provided instance is an extension
   * @returns {StageGroup} An instance of StageGroup populated with the FHIR data
   */
