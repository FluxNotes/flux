...
/**
 * Generated class for mcode.KarnofskyPerformanceStatusScore.
 * @extends SimpleNonLaboratoryObservation
 */
class KarnofskyPerformanceStatusScore extends SimpleNonLaboratoryObservation {
   ...
   * This field/value is required.
   * @param {IntegerQuantity} value - The shr.core.IntegerQuantity
   * @returns {KarnofskyPerformanceStatusScore} this.
   */
  withValue(value) {
  ...
  /**
   * Deserializes JSON data to an instance of the KarnofskyPerformanceStatusScore class.
   * The JSON must be valid against the KarnofskyPerformanceStatusScore JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {KarnofskyPerformanceStatusScore} An instance of KarnofskyPerformanceStatusScore populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new KarnofskyPerformanceStatusScore();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the KarnofskyPerformanceStatusScore class to a JSON object.
   * The JSON is expected to be valid against the KarnofskyPerformanceStatusScore JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/mcode/KarnofskyPerformanceStatusScore' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the KarnofskyPerformanceStatusScore class to a FHIR object.
   * The FHIR is expected to be valid against the KarnofskyPerformanceStatusScore FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the KarnofskyPerformanceStatusScore class.
   * The FHIR must be valid against the KarnofskyPerformanceStatusScore FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {asExtension=false} Whether the provided instance is an extension
   * @returns {KarnofskyPerformanceStatusScore} An instance of KarnofskyPerformanceStatusScore populated with the FHIR data
   */
  static fromFHIR(fhir, asExtension=false) {
    ...
    if (fhir['valueQuantity'] != null) {
      inst.integerQuantity = createInstanceFromFHIR('shr.core.IntegerQuantity', fhir['valueQuantity']);
    }
...
export default KarnofskyPerformanceStatusScore;
