...
/**
 * Generated class for mcode.TNMClinicalRegionalNodesClassification.
 * @extends CodedNonLaboratoryObservation
 */
class TNMClinicalRegionalNodesClassification extends CodedNonLaboratoryObservation {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/mcode/TNMClinicalRegionalNodesClassification' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the TNMClinicalRegionalNodesClassification class to a FHIR object.
   * The FHIR is expected to be valid against the TNMClinicalRegionalNodesClassification FHIR profile, but no validation checks are performed.
