...
/**
 * Generated class for mcode.Tumor.
 * @extends NonLaboratoryObservation
 */
class Tumor extends NonLaboratoryObservation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/mcode/Tumor' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the Tumor class to a FHIR object.
   * The FHIR is expected to be valid against the Tumor FHIR profile, but no validation checks are performed.
