...
/**
 * Generated class for mcode.ECOGPerformanceStatus.
 * @extends ComponentOnlyNonLaboratoryObservation
 */
class ECOGPerformanceStatus extends ComponentOnlyNonLaboratoryObservation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/mcode/ECOGPerformanceStatus' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the ECOGPerformanceStatus class to a FHIR object.
   * The FHIR is expected to be valid against the ECOGPerformanceStatus FHIR profile, but no validation checks are performed.
  ...
  static fromFHIR(fhir, asExtension=false) {
    ...
    if (fhir['value[x]'] != null) {
      inst.quantity = createInstanceFromFHIR('shr.core.Quantity', fhir['value[x]'][0]);
    }
