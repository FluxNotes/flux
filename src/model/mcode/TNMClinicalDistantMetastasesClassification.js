...
/**
 * Generated class for mcode.TNMClinicalDistantMetastasesClassification.
 * @extends CodedNonLaboratoryObservation
 */
class TNMClinicalDistantMetastasesClassification extends CodedNonLaboratoryObservation {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/mcode/TNMClinicalDistantMetastasesClassification' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the TNMClinicalDistantMetastasesClassification class to a FHIR object.
   * The FHIR is expected to be valid against the TNMClinicalDistantMetastasesClassification FHIR profile, but no validation checks are performed.
