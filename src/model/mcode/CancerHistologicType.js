...
/**
 * Generated class for mcode.CancerHistologicType.
 * @extends CodedNonLaboratoryObservation
 */
class CancerHistologicType extends CodedNonLaboratoryObservation {
  ...
  /**
   * Serializes an instance of the CancerHistologicType class to a FHIR object.
   * The FHIR is expected to be valid against the CancerHistologicType FHIR profile, but no validation checks are performed.
