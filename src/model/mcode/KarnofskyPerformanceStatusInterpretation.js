...
/**
 * Generated class for mcode.KarnofskyPerformanceStatusInterpretation.
 * @extends CodedNonLaboratoryObservation
 */
class KarnofskyPerformanceStatusInterpretation extends CodedNonLaboratoryObservation {
   ...
   * This field/value is required.
   * @param {CodeableConcept} value - The shr.core.CodeableConcept
   * @returns {KarnofskyPerformanceStatusInterpretation} this.
   */
  withValue(value) {
  ...
  /**
   * Deserializes JSON data to an instance of the KarnofskyPerformanceStatusInterpretation class.
   * The JSON must be valid against the KarnofskyPerformanceStatusInterpretation JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {KarnofskyPerformanceStatusInterpretation} An instance of KarnofskyPerformanceStatusInterpretation populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new KarnofskyPerformanceStatusInterpretation();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the KarnofskyPerformanceStatusInterpretation class to a JSON object.
   * The JSON is expected to be valid against the KarnofskyPerformanceStatusInterpretation JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/mcode/KarnofskyPerformanceStatusInterpretation' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the KarnofskyPerformanceStatusInterpretation class to a FHIR object.
   * The FHIR is expected to be valid against the KarnofskyPerformanceStatusInterpretation FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the KarnofskyPerformanceStatusInterpretation class.
   * The FHIR must be valid against the KarnofskyPerformanceStatusInterpretation FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {asExtension=false} Whether the provided instance is an extension
   * @returns {KarnofskyPerformanceStatusInterpretation} An instance of KarnofskyPerformanceStatusInterpretation populated with the FHIR data
   */
...
export default KarnofskyPerformanceStatusInterpretation;
