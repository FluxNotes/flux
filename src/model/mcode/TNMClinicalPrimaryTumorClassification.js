...
/**
 * Generated class for mcode.TNMClinicalPrimaryTumorClassification.
 * @extends CodedNonLaboratoryObservation
 */
class TNMClinicalPrimaryTumorClassification extends CodedNonLaboratoryObservation {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/mcode/TNMClinicalPrimaryTumorClassification' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the TNMClinicalPrimaryTumorClassification class to a FHIR object.
   * The FHIR is expected to be valid against the TNMClinicalPrimaryTumorClassification FHIR profile, but no validation checks are performed.
