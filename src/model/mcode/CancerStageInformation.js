...
/**
 * Generated class for mcode.CancerStageInformation.
 * @extends Observation
 */
class CancerStageInformation extends Observation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {CancerStageInformation} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the CancerStageInformation class.
   * The JSON must be valid against the CancerStageInformation JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {CancerStageInformation} An instance of CancerStageInformation populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new CancerStageInformation();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the CancerStageInformation class to a JSON object.
   * The JSON is expected to be valid against the CancerStageInformation JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/mcode/CancerStageInformation' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the CancerStageInformation class to a FHIR object.
   * The FHIR is expected to be valid against the CancerStageInformation FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the CancerStageInformation class.
   * The FHIR must be valid against the CancerStageInformation FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {CancerStageInformation} An instance of CancerStageInformation populated with the FHIR data
   */
...
export default CancerStageInformation;
