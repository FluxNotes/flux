...
/**
 * Generated class for sw.WoundTunnelingObservation.
...
class WoundTunnelingObservation extends ComponentOnlyNonLaboratoryObservation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/sw/WoundTunnelingObservation' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the WoundTunnelingObservation class to a FHIR object.
   * The FHIR is expected to be valid against the WoundTunnelingObservation FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the WoundTunnelingObservation class.
   * The FHIR must be valid against the WoundTunnelingObservation FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {WoundTunnelingObservation} An instance of WoundTunnelingObservation populated with the FHIR data
   */
