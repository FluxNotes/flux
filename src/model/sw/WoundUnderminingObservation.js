...
/**
 * Generated class for sw.WoundUnderminingObservation.
 * @extends ComponentOnlyNonLaboratoryObservation
 */
class WoundUnderminingObservation extends ComponentOnlyNonLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {WoundUnderminingObservation} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the WoundUnderminingObservation class.
   * The JSON must be valid against the WoundUnderminingObservation JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {WoundUnderminingObservation} An instance of WoundUnderminingObservation populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new WoundUnderminingObservation();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the WoundUnderminingObservation class to a JSON object.
   * The JSON is expected to be valid against the WoundUnderminingObservation JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/sw/WoundUnderminingObservation' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the WoundUnderminingObservation class to a FHIR object.
   * The FHIR is expected to be valid against the WoundUnderminingObservation FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the WoundUnderminingObservation class.
   * The FHIR must be valid against the WoundUnderminingObservation FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {WoundUnderminingObservation} An instance of WoundUnderminingObservation populated with the FHIR data
   */
...
export default WoundUnderminingObservation;
