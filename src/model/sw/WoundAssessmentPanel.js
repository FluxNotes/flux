...
import NonLaboratoryObservation from '../shr/base/NonLaboratoryObservation';

/**
 * Generated class for sw.WoundAssessmentPanel.
 * @extends NonLaboratoryObservation
 */
class WoundAssessmentPanel extends NonLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {WoundAssessmentPanel} this.
   */
   ...
   * @returns {WoundAssessmentInterpretation} The sw.WoundAssessmentInterpretation
   */
  get interpretation() {
   ...
   * @param {WoundAssessmentInterpretation} interpretation - The sw.WoundAssessmentInterpretation
   */
  ...
  /**
   * Deserializes JSON data to an instance of the WoundAssessmentPanel class.
   * The JSON must be valid against the WoundAssessmentPanel JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {WoundAssessmentPanel} An instance of WoundAssessmentPanel populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new WoundAssessmentPanel();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the WoundAssessmentPanel class to a JSON object.
   * The JSON is expected to be valid against the WoundAssessmentPanel JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/sw/WoundAssessmentPanel' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the WoundAssessmentPanel class to a FHIR object.
   * The FHIR is expected to be valid against the WoundAssessmentPanel FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the WoundAssessmentPanel class.
   * The FHIR must be valid against the WoundAssessmentPanel FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {WoundAssessmentPanel} An instance of WoundAssessmentPanel populated with the FHIR data
   */
  static fromFHIR(fhir, asExtension=false) {
    ...
    if (fhir['interpretation'] != null) {
      inst.woundAssessmentInterpretation = createInstanceFromFHIR('sw.WoundAssessmentInterpretation', fhir['interpretation']);
    }
...
export default WoundAssessmentPanel;
