...
/**
 * Generated class for sw.WoundBedColorObservation.
...
class WoundBedColorObservation extends ComponentOnlyNonLaboratoryObservation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/sw/WoundBedColorObservation' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the WoundBedColorObservation class to a FHIR object.
   * The FHIR is expected to be valid against the WoundBedColorObservation FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the WoundBedColorObservation class.
   * The FHIR must be valid against the WoundBedColorObservation FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {WoundBedColorObservation} An instance of WoundBedColorObservation populated with the FHIR data
   */
