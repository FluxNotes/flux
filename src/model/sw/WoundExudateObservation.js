...
/**
 * Generated class for sw.WoundExudateObservation.
...
class WoundExudateObservation extends ComponentOnlyNonLaboratoryObservation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/sw/WoundExudateObservation' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the WoundExudateObservation class to a FHIR object.
   * The FHIR is expected to be valid against the WoundExudateObservation FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the WoundExudateObservation class.
   * The FHIR must be valid against the WoundExudateObservation FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {WoundExudateObservation} An instance of WoundExudateObservation populated with the FHIR data
   */
