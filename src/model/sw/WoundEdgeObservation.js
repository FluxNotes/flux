...
/**
 * Generated class for sw.WoundEdgeObservation.
 * @extends ComponentOnlyNonLaboratoryObservation
 */
class WoundEdgeObservation extends ComponentOnlyNonLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {WoundEdgeObservation} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the WoundEdgeObservation class.
   * The JSON must be valid against the WoundEdgeObservation JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {WoundEdgeObservation} An instance of WoundEdgeObservation populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new WoundEdgeObservation();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the WoundEdgeObservation class to a JSON object.
   * The JSON is expected to be valid against the WoundEdgeObservation JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/sw/WoundEdgeObservation' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the WoundEdgeObservation class to a FHIR object.
   * The FHIR is expected to be valid against the WoundEdgeObservation FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the WoundEdgeObservation class.
   * The FHIR must be valid against the WoundEdgeObservation FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {WoundEdgeObservation} An instance of WoundEdgeObservation populated with the FHIR data
   */
...
export default WoundEdgeObservation;
