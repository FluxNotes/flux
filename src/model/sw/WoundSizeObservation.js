...
/**
 * Generated class for sw.WoundSizeObservation.
 * @extends ComponentOnlyNonLaboratoryObservation
 */
class WoundSizeObservation extends ComponentOnlyNonLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {WoundSizeObservation} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the WoundSizeObservation class.
   * The JSON must be valid against the WoundSizeObservation JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {WoundSizeObservation} An instance of WoundSizeObservation populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new WoundSizeObservation();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the WoundSizeObservation class to a JSON object.
   * The JSON is expected to be valid against the WoundSizeObservation JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/sw/WoundSizeObservation' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the WoundSizeObservation class to a FHIR object.
   * The FHIR is expected to be valid against the WoundSizeObservation FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the WoundSizeObservation class.
   * The FHIR must be valid against the WoundSizeObservation FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {WoundSizeObservation} An instance of WoundSizeObservation populated with the FHIR data
   */
...
export default WoundSizeObservation;
