...
/**
 * Generated class for sw.WoundLength.
 * @extends NonIndependentFinding
 */
class WoundLength extends NonIndependentFinding {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/sw/WoundLength' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the WoundLength class to a FHIR object.
   * The FHIR is expected to be valid against the WoundLength FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the WoundLength class.
   * The FHIR must be valid against the WoundLength FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {WoundLength} An instance of WoundLength populated with the FHIR data
   */
