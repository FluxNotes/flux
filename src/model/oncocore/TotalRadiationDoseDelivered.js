...
/**
 * Generated class for oncocore.TotalRadiationDoseDelivered.
 */
class TotalRadiationDoseDelivered {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('oncocore', 'TotalRadiationDoseDelivered');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/oncocore/TotalRadiationDoseDelivered' } };
    if (this.value != null) {
