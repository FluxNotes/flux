...
/**
 * Generated class for oncocore.DNASequenceVariantId.
 * @extends NonIndependentFinding
 */
class DNASequenceVariantId extends NonIndependentFinding {
   ...
   * This field/value is required.
   * @param {string} value - The string
   * @returns {DNASequenceVariantId} this.
   */
  withValue(value) {
  ...
  /**
   * Deserializes JSON data to an instance of the DNASequenceVariantId class.
   * The JSON must be valid against the DNASequenceVariantId JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {DNASequenceVariantId} An instance of DNASequenceVariantId populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('oncocore', 'DNASequenceVariantId');
  ...
  /**
   * Serializes an instance of the DNASequenceVariantId class to a JSON object.
   * The JSON is expected to be valid against the DNASequenceVariantId JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/oncocore/DNASequenceVariantId' } };
    if (this.value != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the DNASequenceVariantId class.
   * The FHIR must be valid against the DNASequenceVariantId FHIR profile, although this is not validated by the function.
   ...
   * @returns {DNASequenceVariantId} An instance of DNASequenceVariantId populated with the FHIR data
   */
...
export default DNASequenceVariantId;
