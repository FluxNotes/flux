...
class TNMClinicalPrimaryTumorClassification extends TNMStagePanelMember {
  ...
  static fromFHIR(fhir, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/oncocore/TNMClinicalPrimaryTumorClassification');
    if (fhir['meta'] != null) {
