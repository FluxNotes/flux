...
/**
 * Generated class for oncocore.TNMClinicalPrimaryTumorClassification.
 * @extends TNMStagePanelMember
 */
class TNMClinicalPrimaryTumorClassification extends TNMStagePanelMember {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {TNMClinicalPrimaryTumorClassification} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the TNMClinicalPrimaryTumorClassification class.
   * The JSON must be valid against the TNMClinicalPrimaryTumorClassification JSON schema, although this is not validated by the function.
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('oncocore', 'TNMClinicalPrimaryTumorClassification');
  ...
  /**
   * Serializes an instance of the TNMClinicalPrimaryTumorClassification class to a JSON object.
   * The JSON is expected to be valid against the TNMClinicalPrimaryTumorClassification JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/oncocore/TNMClinicalPrimaryTumorClassification' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TNMClinicalPrimaryTumorClassification class.
   * The FHIR must be valid against the TNMClinicalPrimaryTumorClassification FHIR profile, although this is not validated by the function.
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/oncocore/TNMClinicalPrimaryTumorClassification', 'uri');
    if (fhir['meta'] != null) {
...
export default TNMClinicalPrimaryTumorClassification;
