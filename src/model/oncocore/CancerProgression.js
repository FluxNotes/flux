...
class CancerProgression extends CodedNonLaboratoryObservation {
  ...
  static fromFHIR(fhir, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/oncocore/CancerProgression');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_extension of fhir['extension'] || []) {
      ...
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/oncocore-CancerProgressionEvidence-extension') {
        ...
        const inst_cancerProgressionEvidence = FHIRHelper.createInstanceFromFHIR('oncocore.CancerProgressionEvidence', fhir_extension, shrId, allEntries, mappedResources, referencesOut, true);
