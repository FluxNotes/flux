...
/**
 * Generated class for oncocore.CancerProgression.
...
class CancerProgression extends CodedNonLaboratoryObservation {
  ...
  /**
   * Get the CancerProgressionEvidence array.
   * @returns {Array<CancerProgressionEvidence>} The oncocore.CancerProgressionEvidence array
   */
  get cancerProgressionEvidence() {
    return this._cancerProgressionEvidence;
  }

  /**
   * Set the CancerProgressionEvidence array.
   * @param {Array<CancerProgressionEvidence>} cancerProgressionEvidence - The oncocore.CancerProgressionEvidence array
   */
  set cancerProgressionEvidence(cancerProgressionEvidence) {
    this._cancerProgressionEvidence = cancerProgressionEvidence;
  }

  /**
   * Set the CancerProgressionEvidence array and return 'this' for chaining.
   * @param {Array<CancerProgressionEvidence>} cancerProgressionEvidence - The oncocore.CancerProgressionEvidence array
   * @returns {CancerProgression} this.
   */
  withCancerProgressionEvidence(cancerProgressionEvidence) {
    this.cancerProgressionEvidence = cancerProgressionEvidence; return this;
  }
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('oncocore', 'CancerProgression');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/oncocore/CancerProgression' };
    ...
    if (this.cancerProgressionEvidence != null) {
      inst['CancerProgressionEvidence'] = this.cancerProgressionEvidence.map(f => f.toJSON());
    }
    return inst;
  }
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/oncocore/CancerProgression', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_extension of fhir['extension'] || []) {
      ...
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/oncocore-CancerProgressionEvidence-extension') {
        inst.cancerProgressionEvidence = inst.cancerProgressionEvidence || [];
        const inst_cancerProgressionEvidence = FHIRHelper.createInstanceFromFHIR('oncocore.CancerProgressionEvidence', fhir_extension, 'Extension', shrId, allEntries, mappedResources, referencesOut, true);
        inst.cancerProgressionEvidence.push(inst_cancerProgressionEvidence);
      }
    }
    if (fhir['status'] != null) {
