...
/**
 * Generated class for oncocore.TNMClinicalDistantMetastasesClassification.
 * @extends TNMStagePanelMember
 */
class TNMClinicalDistantMetastasesClassification extends TNMStagePanelMember {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {TNMClinicalDistantMetastasesClassification} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the TNMClinicalDistantMetastasesClassification class.
   * The JSON must be valid against the TNMClinicalDistantMetastasesClassification JSON schema, although this is not validated by the function.
  ...
  /**
   * Serializes an instance of the TNMClinicalDistantMetastasesClassification class to a JSON object.
   * The JSON is expected to be valid against the TNMClinicalDistantMetastasesClassification JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/oncocore/TNMClinicalDistantMetastasesClassification' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TNMClinicalDistantMetastasesClassification class.
   * The FHIR must be valid against the TNMClinicalDistantMetastasesClassification FHIR profile, although this is not validated by the function.
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/oncocore/TNMClinicalDistantMetastasesClassification', 'uri');
    if (fhir['meta'] != null) {
...
export default TNMClinicalDistantMetastasesClassification;
