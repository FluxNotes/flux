...
/**
 * Generated class for oncocore.GenomicSourceClass.
 */
class GenomicSourceClass {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('oncocore', 'GenomicSourceClass');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/oncocore/GenomicSourceClass' } };
    if (this.value != null) {
