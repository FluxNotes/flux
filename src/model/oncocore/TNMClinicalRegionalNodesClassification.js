...
/**
 * Generated class for oncocore.TNMClinicalRegionalNodesClassification.
 * @extends TNMStagePanelMember
 */
class TNMClinicalRegionalNodesClassification extends TNMStagePanelMember {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {TNMClinicalRegionalNodesClassification} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the TNMClinicalRegionalNodesClassification class.
   * The JSON must be valid against the TNMClinicalRegionalNodesClassification JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {TNMClinicalRegionalNodesClassification} An instance of TNMClinicalRegionalNodesClassification populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('oncocore', 'TNMClinicalRegionalNodesClassification');
  ...
  /**
   * Serializes an instance of the TNMClinicalRegionalNodesClassification class to a JSON object.
   * The JSON is expected to be valid against the TNMClinicalRegionalNodesClassification JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/oncocore/TNMClinicalRegionalNodesClassification' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TNMClinicalRegionalNodesClassification class.
   * The FHIR must be valid against the TNMClinicalRegionalNodesClassification FHIR profile, although this is not validated by the function.
   ...
   * @returns {TNMClinicalRegionalNodesClassification} An instance of TNMClinicalRegionalNodesClassification populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/oncocore/TNMClinicalRegionalNodesClassification', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_extension of fhir['extension'] || []) {
      ...
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/oncocore-CancerStageSuffix-extension') {
        inst.cancerStageSuffix = FHIRHelper.createInstanceFromFHIR('oncocore.CancerStageSuffix', fhir_extension, 'Extension', shrId, allEntries, mappedResources, referencesOut, true);
      }
    }
    if (fhir['status'] != null) {
...
export default TNMClinicalRegionalNodesClassification;
