...
/**
 * Generated class for oncocore.RadiationDosePerFraction.
 */
class RadiationDosePerFraction {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('oncocore', 'RadiationDosePerFraction');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/oncocore/RadiationDosePerFraction' } };
    if (this.value != null) {
