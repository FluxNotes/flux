...
/**
 * Generated class for oncocore.TumorMarker.
 * @extends LaboratoryObservation
 */
class TumorMarker extends LaboratoryObservation {
  ...
  /**
   * Deserializes JSON data to an instance of the TumorMarker class.
   * The JSON must be valid against the TumorMarker JSON schema, although this is not validated by the function.
  ...
  /**
   * Serializes an instance of the TumorMarker class to a JSON object.
   * The JSON is expected to be valid against the TumorMarker JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/oncocore/TumorMarker' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TumorMarker class.
   * The FHIR must be valid against the TumorMarker FHIR profile, although this is not validated by the function.
  ...
  static fromFHIR(fhir, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/oncocore/TumorMarker');
    if (fhir['meta'] != null) {
