...
/**
 * Generated class for oncocore.DNASequenceVariantName.
 * @extends NonIndependentFinding
 */
class DNASequenceVariantName extends NonIndependentFinding {
   ...
   * This field/value is required.
   * @param {string} value - The string
   * @returns {DNASequenceVariantName} this.
   */
  withValue(value) {
  ...
  /**
   * Deserializes JSON data to an instance of the DNASequenceVariantName class.
   * The JSON must be valid against the DNASequenceVariantName JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {DNASequenceVariantName} An instance of DNASequenceVariantName populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('oncocore', 'DNASequenceVariantName');
  ...
  /**
   * Serializes an instance of the DNASequenceVariantName class to a JSON object.
   * The JSON is expected to be valid against the DNASequenceVariantName JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/oncocore/DNASequenceVariantName' } };
    if (this.value != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the DNASequenceVariantName class.
   * The FHIR must be valid against the DNASequenceVariantName FHIR profile, although this is not validated by the function.
   ...
   * @returns {DNASequenceVariantName} An instance of DNASequenceVariantName populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    for (const fhir_extension of fhir['extension'] || []) {
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/primitive-string-extension') {
        inst.value = FHIRHelper.createInstanceFromFHIR('string', fhir_extension, 'Extension', shrId, allEntries, mappedResources, referencesOut, true);
      }
...
export default DNASequenceVariantName;
