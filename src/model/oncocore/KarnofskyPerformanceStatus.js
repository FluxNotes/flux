...
class KarnofskyPerformanceStatus extends SimpleNonLaboratoryObservation {
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/oncocore/KarnofskyPerformanceStatus', 'uri');
    if (fhir['meta'] != null) {
