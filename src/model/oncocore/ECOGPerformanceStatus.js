...
/**
 * Generated class for oncocore.ECOGPerformanceStatus.
 * @extends SimpleNonLaboratoryObservation
 */
class ECOGPerformanceStatus extends SimpleNonLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {ECOGPerformanceStatus} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the ECOGPerformanceStatus class.
   * The JSON must be valid against the ECOGPerformanceStatus JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {ECOGPerformanceStatus} An instance of ECOGPerformanceStatus populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new ECOGPerformanceStatus();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the ECOGPerformanceStatus class to a JSON object.
   * The JSON is expected to be valid against the ECOGPerformanceStatus JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/oncocore/ECOGPerformanceStatus' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ECOGPerformanceStatus class.
   * The FHIR must be valid against the ECOGPerformanceStatus FHIR profile, although this is not validated by the function.
   ...
   * @returns {ECOGPerformanceStatus} An instance of ECOGPerformanceStatus populated with the FHIR data
   */
  static fromFHIR(fhir, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/oncocore/ECOGPerformanceStatus');
    if (fhir['meta'] != null) {
...
export default ECOGPerformanceStatus;
