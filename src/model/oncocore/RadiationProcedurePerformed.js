...
class RadiationProcedurePerformed extends ProcedurePerformed {
  ...
  static fromJSON(json={}) {
    const inst = new RadiationProcedurePerformed();
  ...
  static fromFHIR(fhir, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/oncocore/RadiationProcedurePerformed');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_extension of fhir['extension'] || []) {
      ...
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/oncocore-RadiationDosePerFraction-extension') {
        inst.radiationDosePerFraction = FHIRHelper.createInstanceFromFHIR('oncocore.RadiationDosePerFraction', fhir_extension, shrId, allEntries, mappedResources, referencesOut, true);
      }
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/oncocore-RadiationFractionsDelivered-extension') {
        inst.radiationFractionsDelivered = FHIRHelper.createInstanceFromFHIR('oncocore.RadiationFractionsDelivered', fhir_extension, shrId, allEntries, mappedResources, referencesOut, true);
      }
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://example.com/fhir/StructureDefinition/oncocore-TotalRadiationDoseDelivered-extension') {
        inst.totalRadiationDoseDelivered = FHIRHelper.createInstanceFromFHIR('oncocore.TotalRadiationDoseDelivered', fhir_extension, shrId, allEntries, mappedResources, referencesOut, true);
      }
    }
