...
/**
 * Generated class for oncocore.CancerHistologicType.
 * @extends SimpleCodedNonLaboratoryObservation
 */
class CancerHistologicType extends SimpleCodedNonLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {CancerHistologicType} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the CancerHistologicType class.
   * The JSON must be valid against the CancerHistologicType JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {CancerHistologicType} An instance of CancerHistologicType populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('oncocore', 'CancerHistologicType');
  ...
  /**
   * Serializes an instance of the CancerHistologicType class to a JSON object.
   * The JSON is expected to be valid against the CancerHistologicType JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/oncocore/CancerHistologicType' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the CancerHistologicType class.
   * The FHIR must be valid against the CancerHistologicType FHIR profile, although this is not validated by the function.
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/oncocore/CancerHistologicType', 'uri');
    if (fhir['meta'] != null) {
...
export default CancerHistologicType;
