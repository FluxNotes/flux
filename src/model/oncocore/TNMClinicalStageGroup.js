...
class TNMClinicalStageGroup extends TNMStagePanelMember {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('oncocore', 'TNMClinicalStageGroup');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/oncocore/TNMClinicalStageGroup', 'uri');
    if (fhir['meta'] != null) {
