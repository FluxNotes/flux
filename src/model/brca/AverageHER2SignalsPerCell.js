...
/**
 * Generated class for brca.AverageHER2SignalsPerCell.
 * @extends QuantitativeNonIndependentFinding
 */
class AverageHER2SignalsPerCell extends QuantitativeNonIndependentFinding {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('brca', 'AverageHER2SignalsPerCell');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/brca/AverageHER2SignalsPerCell' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the AverageHER2SignalsPerCell class.
   * The FHIR must be valid against the AverageHER2SignalsPerCell FHIR profile, although this is not validated by the function.
   ...
   * @returns {AverageHER2SignalsPerCell} An instance of AverageHER2SignalsPerCell populated with the FHIR data
   */
