...
/**
 * Generated class for brca.BreastTNMPathologicStageGroup.
 * @extends TNMPathologicStageGroup
 */
class BreastTNMPathologicStageGroup extends TNMPathologicStageGroup {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {BreastTNMPathologicStageGroup} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the BreastTNMPathologicStageGroup class.
   * The JSON must be valid against the BreastTNMPathologicStageGroup JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {BreastTNMPathologicStageGroup} An instance of BreastTNMPathologicStageGroup populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('brca', 'BreastTNMPathologicStageGroup');
  ...
  /**
   * Serializes an instance of the BreastTNMPathologicStageGroup class to a JSON object.
   * The JSON is expected to be valid against the BreastTNMPathologicStageGroup JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/brca/BreastTNMPathologicStageGroup' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the BreastTNMPathologicStageGroup class.
   * The FHIR must be valid against the BreastTNMPathologicStageGroup FHIR profile, although this is not validated by the function.
   ...
   * @returns {BreastTNMPathologicStageGroup} An instance of BreastTNMPathologicStageGroup populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/brca/BreastTNMPathologicStageGroup', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_related of fhir['related'] || []) {
      ...
      if (fhir_related['target'] != null && fhir_related['target']['reference'] != null && FHIRHelper.conformsToProfile(allEntries.find(e => e.fullUrl === fhir_related['target']['reference']), 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/onco-core-TNMPathologicPrimaryTumorCategory')) {
        if (fhir_related['target'] != null) {
          ...
          if (!mappedResources[entryId]) {
            const referencedEntry = allEntries.find(e => e.fullUrl === entryId);
            if (referencedEntry) {
              mappedResources[entryId] = FHIRHelper.createInstanceFromFHIR('onco.core.TNMPathologicPrimaryTumorCategory', referencedEntry['resource'], 'undefined', shrId, allEntries, mappedResources, referencesOut);
            }
          }
          ...
          if (mappedResources[entryId]) {
            ...
            const entryType = 'http://standardhealthrecord.org/spec/onco/core/TNMPathologicPrimaryTumorCategory';
      ...
      if (fhir_related['target'] != null && fhir_related['target']['reference'] != null && FHIRHelper.conformsToProfile(allEntries.find(e => e.fullUrl === fhir_related['target']['reference']), 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/onco-core-TNMPathologicRegionalNodesCategory')) {
        if (fhir_related['target'] != null) {
          inst.panelMembers.observation = inst.panelMembers.observation || [];
          const entryId = fhir_related['target']['reference'];
          if (!mappedResources[entryId]) {
            const referencedEntry = allEntries.find(e => e.fullUrl === entryId);
            if (referencedEntry) {
              mappedResources[entryId] = FHIRHelper.createInstanceFromFHIR('onco.core.TNMPathologicRegionalNodesCategory', referencedEntry['resource'], 'undefined', shrId, allEntries, mappedResources, referencesOut);
            }
          }
          let inst_panelMembers_observation;
          if (mappedResources[entryId]) {
            ...
            const entryType = 'http://standardhealthrecord.org/spec/onco/core/TNMPathologicRegionalNodesCategory';
            inst_panelMembers_observation = FHIRHelper.createReferenceWithoutObject(shrId, entryId, entryType);
          }
          inst.panelMembers.observation.push(inst_panelMembers_observation);
        }
      }
      if (fhir_related['target'] != null && fhir_related['target']['reference'] != null && FHIRHelper.conformsToProfile(allEntries.find(e => e.fullUrl === fhir_related['target']['reference']), 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/onco-core-TNMPathologicDistantMetastasesCategory')) {
        if (fhir_related['target'] != null) {
          inst.panelMembers.observation = inst.panelMembers.observation || [];
          const entryId = fhir_related['target']['reference'];
          if (!mappedResources[entryId]) {
            const referencedEntry = allEntries.find(e => e.fullUrl === entryId);
            if (referencedEntry) {
              mappedResources[entryId] = FHIRHelper.createInstanceFromFHIR('onco.core.TNMPathologicDistantMetastasesCategory', referencedEntry['resource'], 'undefined', shrId, allEntries, mappedResources, referencesOut);
            }
          }
          let inst_panelMembers_observation;
          if (mappedResources[entryId]) {
            ...
            const entryType = 'http://standardhealthrecord.org/spec/onco/core/TNMPathologicDistantMetastasesCategory';
            inst_panelMembers_observation = FHIRHelper.createReferenceWithoutObject(shrId, entryId, entryType);
          }
          inst.panelMembers.observation.push(inst_panelMembers_observation);
        }
      }
      if (fhir_related['target'] != null && fhir_related['target']['reference'] != null && FHIRHelper.conformsToProfile(allEntries.find(e => e.fullUrl === fhir_related['target']['reference']), 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/brca-HER2ReceptorStatus')) {
        if (fhir_related['target'] != null) {
          inst.panelMembers.observation = inst.panelMembers.observation || [];
          const entryId = fhir_related['target']['reference'];
          if (!mappedResources[entryId]) {
          ...
          if (mappedResources[entryId]) {
            ...
            const entryType = 'http://standardhealthrecord.org/spec/brca/HER2ReceptorStatus';
            inst_panelMembers_observation = FHIRHelper.createReferenceWithoutObject(shrId, entryId, entryType);
          }
          inst.panelMembers.observation.push(inst_panelMembers_observation);
        }
      }
      if (fhir_related['target'] != null && fhir_related['target']['reference'] != null && FHIRHelper.conformsToProfile(allEntries.find(e => e.fullUrl === fhir_related['target']['reference']), 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/brca-EstrogenReceptorStatus')) {
        if (fhir_related['target'] != null) {
          inst.panelMembers.observation = inst.panelMembers.observation || [];
          const entryId = fhir_related['target']['reference'];
          if (!mappedResources[entryId]) {
          ...
          if (mappedResources[entryId]) {
            ...
            const entryType = 'http://standardhealthrecord.org/spec/brca/EstrogenReceptorStatus';
            inst_panelMembers_observation = FHIRHelper.createReferenceWithoutObject(shrId, entryId, entryType);
          }
          inst.panelMembers.observation.push(inst_panelMembers_observation);
        }
      }
      if (fhir_related['target'] != null && fhir_related['target']['reference'] != null && FHIRHelper.conformsToProfile(allEntries.find(e => e.fullUrl === fhir_related['target']['reference']), 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/brca-ProgesteroneReceptorStatus')) {
        if (fhir_related['target'] != null) {
          inst.panelMembers.observation = inst.panelMembers.observation || [];
          const entryId = fhir_related['target']['reference'];
          if (!mappedResources[entryId]) {
          ...
          if (mappedResources[entryId]) {
            ...
            const entryType = 'http://standardhealthrecord.org/spec/brca/ProgesteroneReceptorStatus';
            inst_panelMembers_observation = FHIRHelper.createReferenceWithoutObject(shrId, entryId, entryType);
          }
          inst.panelMembers.observation.push(inst_panelMembers_observation);
        }
      }
      if (fhir_related['target'] != null && fhir_related['target']['reference'] != null && FHIRHelper.conformsToProfile(allEntries.find(e => e.fullUrl === fhir_related['target']['reference']), 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/brca-DCISNuclearGrade')) {
        if (fhir_related['target'] != null) {
          inst.panelMembers.observation = inst.panelMembers.observation || [];
          const entryId = fhir_related['target']['reference'];
          if (!mappedResources[entryId]) {
          ...
          if (mappedResources[entryId]) {
            ...
            const entryType = 'http://standardhealthrecord.org/spec/brca/DCISNuclearGrade';
            inst_panelMembers_observation = FHIRHelper.createReferenceWithoutObject(shrId, entryId, entryType);
          }
          inst.panelMembers.observation.push(inst_panelMembers_observation);
        }
      }
      if (fhir_related['target'] != null && fhir_related['target']['reference'] != null && FHIRHelper.conformsToProfile(allEntries.find(e => e.fullUrl === fhir_related['target']['reference']), 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/brca-BreastCancerHistologicGrade')) {
        if (fhir_related['target'] != null) {
          inst.panelMembers.observation = inst.panelMembers.observation || [];
          const entryId = fhir_related['target']['reference'];
          if (!mappedResources[entryId]) {
          ...
          if (mappedResources[entryId]) {
            ...
            const entryType = 'http://standardhealthrecord.org/spec/brca/BreastCancerHistologicGrade';
            inst_panelMembers_observation = FHIRHelper.createReferenceWithoutObject(shrId, entryId, entryType);
          }
          inst.panelMembers.observation.push(inst_panelMembers_observation);
        }
...
export default BreastTNMPathologicStageGroup;
