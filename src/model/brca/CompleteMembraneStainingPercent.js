...
/**
 * Generated class for brca.CompleteMembraneStainingPercent.
 * @extends QuantitativeNonIndependentFinding
 */
class CompleteMembraneStainingPercent extends QuantitativeNonIndependentFinding {
   ...
   * @param {ReferenceRange} referenceRange - The shr.base.ReferenceRange
   * @returns {CompleteMembraneStainingPercent} this.
   */
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('brca', 'CompleteMembraneStainingPercent');
  ...
  /**
   * Serializes an instance of the CompleteMembraneStainingPercent class to a JSON object.
   * The JSON is expected to be valid against the CompleteMembraneStainingPercent JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/brca/CompleteMembraneStainingPercent' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the CompleteMembraneStainingPercent class.
   * The FHIR must be valid against the CompleteMembraneStainingPercent FHIR profile, although this is not validated by the function.
   ...
   * @returns {CompleteMembraneStainingPercent} An instance of CompleteMembraneStainingPercent populated with the FHIR data
   */
