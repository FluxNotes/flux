...
/**
 * Generated class for brca.ProgesteroneReceptorStatus.
 * @extends TumorMarkerTest
 */
class ProgesteroneReceptorStatus extends TumorMarkerTest {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {ProgesteroneReceptorStatus} this.
   */
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('brca', 'ProgesteroneReceptorStatus');
  ...
  /**
   * Serializes an instance of the ProgesteroneReceptorStatus class to a JSON object.
   * The JSON is expected to be valid against the ProgesteroneReceptorStatus JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/brca/ProgesteroneReceptorStatus' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ProgesteroneReceptorStatus class.
   * The FHIR must be valid against the ProgesteroneReceptorStatus FHIR profile, although this is not validated by the function.
   ...
   * @returns {ProgesteroneReceptorStatus} An instance of ProgesteroneReceptorStatus populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/brca/ProgesteroneReceptorStatus', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_component of fhir['component'] || []) {
      ...
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '14230-7')) {
      }
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '85331-7')) {
      }
    }
    return inst;
  }
