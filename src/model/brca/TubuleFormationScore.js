...
/**
 * Generated class for brca.TubuleFormationScore.
 * @extends CodedNonIndependentFinding
 */
class TubuleFormationScore extends CodedNonIndependentFinding {
   ...
   * @param {FindingResult} findingResult - The shr.base.FindingResult
   * @returns {TubuleFormationScore} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the TubuleFormationScore class.
   * The JSON must be valid against the TubuleFormationScore JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {TubuleFormationScore} An instance of TubuleFormationScore populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('brca', 'TubuleFormationScore');
  ...
  /**
   * Serializes an instance of the TubuleFormationScore class to a JSON object.
   * The JSON is expected to be valid against the TubuleFormationScore JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/brca/TubuleFormationScore' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the TubuleFormationScore class.
   * The FHIR must be valid against the TubuleFormationScore FHIR profile, although this is not validated by the function.
   ...
   * @returns {TubuleFormationScore} An instance of TubuleFormationScore populated with the FHIR data
   */
...
export default TubuleFormationScore;
