...
import ComponentOnlyNonLaboratoryObservation from '../shr/core/ComponentOnlyNonLaboratoryObservation';

/**
 * Generated class for brca.BreastClinicalLymphNodeInvolvement.
 * @extends ComponentOnlyNonLaboratoryObservation
 */
class BreastClinicalLymphNodeInvolvement extends ComponentOnlyNonLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {BreastClinicalLymphNodeInvolvement} this.
   */
  ...
  /**
   * Get the BreastLymphNodeBodyLocation.
   * @returns {BreastLymphNodeBodyLocation} The brca.BreastLymphNodeBodyLocation
   */
  get bodyLocation() {
  ...
  /**
   * Set the BreastLymphNodeBodyLocation.
   * @param {BreastLymphNodeBodyLocation} bodyLocation - The brca.BreastLymphNodeBodyLocation
   */
  ...
  /**
   * Set the BreastLymphNodeBodyLocation and return 'this' for chaining.
   * @param {BreastLymphNodeBodyLocation} bodyLocation - The brca.BreastLymphNodeBodyLocation
   * @returns {BreastClinicalLymphNodeInvolvement} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the BreastClinicalLymphNodeInvolvement class.
   * The JSON must be valid against the BreastClinicalLymphNodeInvolvement JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {BreastClinicalLymphNodeInvolvement} An instance of BreastClinicalLymphNodeInvolvement populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('brca', 'BreastClinicalLymphNodeInvolvement');
  ...
  /**
   * Serializes an instance of the BreastClinicalLymphNodeInvolvement class to a JSON object.
   * The JSON is expected to be valid against the BreastClinicalLymphNodeInvolvement JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/brca/BreastClinicalLymphNodeInvolvement' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the BreastClinicalLymphNodeInvolvement class.
   * The FHIR must be valid against the BreastClinicalLymphNodeInvolvement FHIR profile, although this is not validated by the function.
   ...
   * @returns {BreastClinicalLymphNodeInvolvement} An instance of BreastClinicalLymphNodeInvolvement populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/brca/BreastClinicalLymphNodeInvolvement', 'uri');
    if (fhir['meta'] != null) {
    ...
    if (fhir['bodySite'] != null) {
      inst.bodyLocation = inst.bodyLocation || FHIRHelper.createInstanceFromFHIR('brca.BreastLymphNodeBodyLocation', {}, null, shrId);
    ...
    for (const fhir_component of fhir['component'] || []) {
      ...
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '364109001')) {
      }
    }
    return inst;
  }
...
export default BreastClinicalLymphNodeInvolvement;
