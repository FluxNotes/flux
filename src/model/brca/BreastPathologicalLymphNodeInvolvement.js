...
import LaboratoryObservation from '../shr/core/LaboratoryObservation';

/**
 * Generated class for brca.BreastPathologicalLymphNodeInvolvement.
...
class BreastPathologicalLymphNodeInvolvement extends LaboratoryObservation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('brca', 'BreastPathologicalLymphNodeInvolvement');
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/brca/BreastPathologicalLymphNodeInvolvement' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the BreastPathologicalLymphNodeInvolvement class.
   * The FHIR must be valid against the BreastPathologicalLymphNodeInvolvement FHIR profile, although this is not validated by the function.
   ...
   * @returns {BreastPathologicalLymphNodeInvolvement} An instance of BreastPathologicalLymphNodeInvolvement populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/brca/BreastPathologicalLymphNodeInvolvement', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_component of fhir['component'] || []) {
      ...
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '399656008')) {
      }
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '118890000')) {
      }
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '444025001')) {
      }
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '21894-1')) {
      }
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '85347-3')) {
      }
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '85352-3')) {
      }
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '85344-0')) {
      }
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '85343-2')) {
      }
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '85350-7')) {
      }
    }
    return inst;
  }
