...
/**
 * Generated class for brca.AverageStainingIntensity.
 * @extends CodedNonIndependentFinding
 */
class AverageStainingIntensity extends CodedNonIndependentFinding {
   ...
   * @param {FindingResult} findingResult - The shr.base.FindingResult
   * @returns {AverageStainingIntensity} this.
   */
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('brca', 'AverageStainingIntensity');
  ...
  /**
   * Serializes an instance of the AverageStainingIntensity class to a JSON object.
   * The JSON is expected to be valid against the AverageStainingIntensity JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/brca/AverageStainingIntensity' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the AverageStainingIntensity class.
   * The FHIR must be valid against the AverageStainingIntensity FHIR profile, although this is not validated by the function.
   ...
   * @returns {AverageStainingIntensity} An instance of AverageStainingIntensity populated with the FHIR data
   */
