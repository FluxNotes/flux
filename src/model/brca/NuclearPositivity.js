...
/**
 * Generated class for brca.NuclearPositivity.
 * @extends NonIndependentFinding
 */
class NuclearPositivity extends NonIndependentFinding {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('brca', 'NuclearPositivity');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/brca/NuclearPositivity' } };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the NuclearPositivity class.
   * The FHIR must be valid against the NuclearPositivity FHIR profile, although this is not validated by the function.
   ...
   * @returns {NuclearPositivity} An instance of NuclearPositivity populated with the FHIR data
   */
