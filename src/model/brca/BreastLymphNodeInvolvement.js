...
/**
 * Generated class for brca.BreastLymphNodeInvolvement.
 * @extends CodedObservationComponent
 */
class BreastLymphNodeInvolvement extends CodedObservationComponent {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('brca', 'BreastLymphNodeInvolvement');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/brca/BreastLymphNodeInvolvement' } };
    if (this.code != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the BreastLymphNodeInvolvement class.
   * The FHIR must be valid against the BreastLymphNodeInvolvement FHIR profile, although this is not validated by the function.
   ...
   * @returns {BreastLymphNodeInvolvement} An instance of BreastLymphNodeInvolvement populated with the FHIR data
   */
