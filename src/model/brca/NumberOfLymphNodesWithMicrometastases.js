...
/**
 * Generated class for brca.NumberOfLymphNodesWithMicrometastases.
 * @extends QuantitativeObservationComponent
 */
class NumberOfLymphNodesWithMicrometastases extends QuantitativeObservationComponent {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('brca', 'NumberOfLymphNodesWithMicrometastases');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/brca/NumberOfLymphNodesWithMicrometastases' } };
    if (this.code != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the NumberOfLymphNodesWithMicrometastases class.
   * The FHIR must be valid against the NumberOfLymphNodesWithMicrometastases FHIR profile, although this is not validated by the function.
   ...
   * @returns {NumberOfLymphNodesWithMicrometastases} An instance of NumberOfLymphNodesWithMicrometastases populated with the FHIR data
   */
