...
/**
 * Generated class for brca.ExtraCapsularExtensionOfNodalTumorStatus.
 * @extends CodedObservationComponent
 */
class ExtraCapsularExtensionOfNodalTumorStatus extends CodedObservationComponent {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('brca', 'ExtraCapsularExtensionOfNodalTumorStatus');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/brca/ExtraCapsularExtensionOfNodalTumorStatus' } };
    if (this.code != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the ExtraCapsularExtensionOfNodalTumorStatus class.
   * The FHIR must be valid against the ExtraCapsularExtensionOfNodalTumorStatus FHIR profile, although this is not validated by the function.
   ...
   * @returns {ExtraCapsularExtensionOfNodalTumorStatus} An instance of ExtraCapsularExtensionOfNodalTumorStatus populated with the FHIR data
   */
