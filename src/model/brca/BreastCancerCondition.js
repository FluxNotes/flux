...
/**
 * Generated class for brca.BreastCancerCondition.
 * @extends PrimaryCancerCondition
 */
class BreastCancerCondition extends PrimaryCancerCondition {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {BreastCancerCondition} this.
   */
  ...
  /**
   * Get the BreastSite array.
   * @returns {Array<BreastSite>} The brca.BreastSite array
   */
  get bodyLocation() {
  ...
  /**
   * Set the BreastSite array.
   * @param {Array<BreastSite>} bodyLocation - The brca.BreastSite array
   */
  ...
  /**
   * Set the BreastSite array and return 'this' for chaining.
   * @param {Array<BreastSite>} bodyLocation - The brca.BreastSite array
   * @returns {BreastCancerCondition} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the BreastCancerCondition class.
   * The JSON must be valid against the BreastCancerCondition JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {BreastCancerCondition} An instance of BreastCancerCondition populated with the JSON data
   */
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('brca', 'BreastCancerCondition');
  ...
  /**
   * Serializes an instance of the BreastCancerCondition class to a JSON object.
   * The JSON is expected to be valid against the BreastCancerCondition JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/brca/BreastCancerCondition' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the BreastCancerCondition class.
   * The FHIR must be valid against the BreastCancerCondition FHIR profile, although this is not validated by the function.
   ...
   * @returns {BreastCancerCondition} An instance of BreastCancerCondition populated with the FHIR data
   */
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/brca/BreastCancerCondition', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_extension of fhir['extension'] || []) {
      ...
      if (fhir_extension['url'] != null && fhir_extension['url'] === 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/onco-core-HistologyMorphologyBehavior-extension' && fhir_extension['url'] != null && fhir_extension['url'] === 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/onco-core-HistologyMorphologyBehavior-extension') {
        ...
        if (fhir_extension['valueCodeableConcept'] != null) {
          inst.histologyMorphologyBehavior.value = FHIRHelper.createInstanceFromFHIR('shr.core.CodeableConcept', fhir_extension['valueCodeableConcept'], 'CodeableConcept', shrId, allEntries, mappedResources, referencesOut, false);
        }
      }
    }
    ...
    for (const fhir_bodySite of fhir['bodySite'] || []) {
      ...
      const inst_bodyLocation = FHIRHelper.createInstanceFromFHIR('brca.BreastSite', {}, null, shrId);
      ...
      for (const fhir_bodySite_extension of fhir_bodySite['extension'] || []) {
        ...
        if (fhir_bodySite_extension['url'] != null && fhir_bodySite_extension['url'] === 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/shr-core-RelationToLandmark-extension' && fhir_bodySite_extension['url'] != null && fhir_bodySite_extension['url'] === 'http://hl7.org/fhir/us/shr/DSTU2/StructureDefinition/shr-core-RelationToLandmark-extension') {
...
export default BreastCancerCondition;
