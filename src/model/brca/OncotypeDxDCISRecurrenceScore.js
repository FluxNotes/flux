...
/**
 * Generated class for brca.OncotypeDxDCISRecurrenceScore.
...
class OncotypeDxDCISRecurrenceScore extends SimpleLaboratoryObservation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/brca/OncotypeDxDCISRecurrenceScore' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the OncotypeDxDCISRecurrenceScore class.
   * The FHIR must be valid against the OncotypeDxDCISRecurrenceScore FHIR profile, although this is not validated by the function.
   ...
   * @returns {OncotypeDxDCISRecurrenceScore} An instance of OncotypeDxDCISRecurrenceScore populated with the FHIR data
   */
  static fromFHIR(fhir, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/brca/OncotypeDxDCISRecurrenceScore');
    if (fhir['meta'] != null) {
