...
/**
 * Generated class for brca.LymphNodeSize.
 * @extends QuantitativeObservationComponent
 */
class LymphNodeSize extends QuantitativeObservationComponent {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('brca', 'LymphNodeSize');
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/brca/LymphNodeSize' } };
    if (this.code != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the LymphNodeSize class.
   * The FHIR must be valid against the LymphNodeSize FHIR profile, although this is not validated by the function.
   ...
   * @returns {LymphNodeSize} An instance of LymphNodeSize populated with the FHIR data
   */
