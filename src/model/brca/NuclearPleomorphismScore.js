...
class NuclearPleomorphismScore extends CodedNonIndependentFinding {
  ...
  /**
   * Serializes an instance of the NuclearPleomorphismScore class to a JSON object.
   * The JSON is expected to be valid against the NuclearPleomorphismScore JSON schema, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the NuclearPleomorphismScore class.
   * The FHIR must be valid against the NuclearPleomorphismScore FHIR profile, although this is not validated by the function.
   ...
   * @returns {NuclearPleomorphismScore} An instance of NuclearPleomorphismScore populated with the FHIR data
   */
