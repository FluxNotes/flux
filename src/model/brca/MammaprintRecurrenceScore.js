...
class MammaprintRecurrenceScore extends SimpleLaboratoryObservation {
  ...
  static fromJSON(json={}) {
    const klass = ClassRegistry.get('brca', 'MammaprintRecurrenceScore');
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/brca/MammaprintRecurrenceScore', 'uri');
    if (fhir['meta'] != null) {
