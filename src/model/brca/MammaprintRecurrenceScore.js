...
/**
 * Generated class for brca.MammaprintRecurrenceScore.
 * @extends SimpleLaboratoryObservation
 */
class MammaprintRecurrenceScore extends SimpleLaboratoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {MammaprintRecurrenceScore} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the MammaprintRecurrenceScore class.
   * The JSON must be valid against the MammaprintRecurrenceScore JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {MammaprintRecurrenceScore} An instance of MammaprintRecurrenceScore populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new MammaprintRecurrenceScore();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the MammaprintRecurrenceScore class to a JSON object.
   * The JSON is expected to be valid against the MammaprintRecurrenceScore JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/brca/MammaprintRecurrenceScore' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the MammaprintRecurrenceScore class.
   * The FHIR must be valid against the MammaprintRecurrenceScore FHIR profile, although this is not validated by the function.
   ...
   * @returns {MammaprintRecurrenceScore} An instance of MammaprintRecurrenceScore populated with the FHIR data
   */
  static fromFHIR(fhir, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/brca/MammaprintRecurrenceScore');
    if (fhir['meta'] != null) {
...
export default MammaprintRecurrenceScore;
