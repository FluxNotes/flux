...
import SimpleCodedLaboratoryObservation from '../shr/core/SimpleCodedLaboratoryObservation';

/**
 * Generated class for brca.DCISNuclearGrade.
 * @extends SimpleCodedLaboratoryObservation
 */
class DCISNuclearGrade extends SimpleCodedLaboratoryObservation {
  ...
  /**
   * Deserializes JSON data to an instance of the DCISNuclearGrade class.
   * The JSON must be valid against the DCISNuclearGrade JSON schema, although this is not validated by the function.
  ...
  /**
   * Serializes an instance of the DCISNuclearGrade class to a JSON object.
   * The JSON is expected to be valid against the DCISNuclearGrade JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/brca/DCISNuclearGrade' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the DCISNuclearGrade class.
   * The FHIR must be valid against the DCISNuclearGrade FHIR profile, although this is not validated by the function.
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/brca/DCISNuclearGrade', 'uri');
    if (fhir['meta'] != null) {
...
export default DCISNuclearGrade;
