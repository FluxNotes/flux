...
/**
 * Generated class for brca.HER2byIHC.
 * @extends TumorMarkerTest
 */
class HER2byIHC extends TumorMarkerTest {
  ...
  /**
   * Deserializes JSON data to an instance of the HER2byIHC class.
   * The JSON must be valid against the HER2byIHC JSON schema, although this is not validated by the function.
  ...
  /**
   * Serializes an instance of the HER2byIHC class to a JSON object.
   * The JSON is expected to be valid against the HER2byIHC JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/brca/HER2byIHC' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the HER2byIHC class.
   * The FHIR must be valid against the HER2byIHC FHIR profile, although this is not validated by the function.
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/brca/HER2byIHC', 'uri');
    if (fhir['meta'] != null) {
    ...
    for (const fhir_component of fhir['component'] || []) {
      ...
      if (fhir_component['code'] != null && fhir_component['code']['coding'] != null && fhir_component['code']['coding'].some(g => g['code'] != null && g['code'] === '85328-3')) {
      }
    }
    return inst;
  }
