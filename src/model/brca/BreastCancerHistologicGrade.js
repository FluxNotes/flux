...
/**
 * Generated class for brca.BreastCancerHistologicGrade.
 * @extends CancerHistologicGrade
 */
class BreastCancerHistologicGrade extends CancerHistologicGrade {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/brca/BreastCancerHistologicGrade' };
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the BreastCancerHistologicGrade class.
   * The FHIR must be valid against the BreastCancerHistologicGrade FHIR profile, although this is not validated by the function.
  ...
  static fromFHIR(fhir, fhirType, shrId=uuid(), allEntries=[], mappedResources={}, referencesOut=[], asExtension=false) {
    ...
    inst.entryInfo.entryType = FHIRHelper.createInstanceFromFHIR('shr.base.EntryType', 'http://standardhealthrecord.org/spec/brca/BreastCancerHistologicGrade', 'uri');
    if (fhir['meta'] != null) {
