...
import RelatedPerson from '../shr/entity/RelatedPerson';

/**
 * Generated class for fhx.FamilyMember.
 * @extends RelatedPerson
 */
class FamilyMember extends RelatedPerson {
  ...
  /**
   * Deserializes JSON data to an instance of the FamilyMember class.
   * The JSON must be valid against the FamilyMember JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {FamilyMember} An instance of FamilyMember populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new FamilyMember();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the FamilyMember class to a JSON object.
   * The JSON is expected to be valid against the FamilyMember JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/fhx/FamilyMember' };
    if (this.person != null) {
  ...
  /**
   * Serializes an instance of the FamilyMember class to a FHIR object.
   * The FHIR is expected to be valid against the FamilyMember FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the FamilyMember class.
   * The FHIR must be valid against the FamilyMember FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {FamilyMember} An instance of FamilyMember populated with the FHIR data
   */
