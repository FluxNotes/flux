...
/**
 * Generated class for odh.PastOrPresentIndustry.
 * @extends CodedSocialHistoryObservation
 */
class PastOrPresentIndustry extends CodedSocialHistoryObservation {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/odh/PastOrPresentIndustry' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the PastOrPresentIndustry class to a FHIR object.
   * The FHIR is expected to be valid against the PastOrPresentIndustry FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the PastOrPresentIndustry class.
   * The FHIR must be valid against the PastOrPresentIndustry FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {PastOrPresentIndustry} An instance of PastOrPresentIndustry populated with the FHIR data
   */
