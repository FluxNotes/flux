...
/**
 * Generated class for odh.WorkClassification.
 * @extends CodedSocialHistoryObservation
 */
class WorkClassification extends CodedSocialHistoryObservation {
   ...
   * This field/value is required.
   * @param {CodeableConcept} value - The shr.core.CodeableConcept
   * @returns {WorkClassification} this.
   */
  withValue(value) {
  ...
  /**
   * Deserializes JSON data to an instance of the WorkClassification class.
   * The JSON must be valid against the WorkClassification JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {WorkClassification} An instance of WorkClassification populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new WorkClassification();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the WorkClassification class to a JSON object.
   * The JSON is expected to be valid against the WorkClassification JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/odh/WorkClassification' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the WorkClassification class to a FHIR object.
   * The FHIR is expected to be valid against the WorkClassification FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the WorkClassification class.
   * The FHIR must be valid against the WorkClassification FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {WorkClassification} An instance of WorkClassification populated with the FHIR data
   */
...
export default WorkClassification;
