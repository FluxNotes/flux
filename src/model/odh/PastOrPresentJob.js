...
/**
 * Generated class for odh.PastOrPresentJob.
 * @extends CodedSocialHistoryObservation
 */
class PastOrPresentJob extends CodedSocialHistoryObservation {
  ...
  /**
   * Get the Employer.
   * @returns {Employer} The odh.Employer
   */
  get employer() {
  ...
  /**
   * Set the Employer.
   * @param {Employer} employer - The odh.Employer
   */
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/odh/PastOrPresentJob' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the PastOrPresentJob class to a FHIR object.
   * The FHIR is expected to be valid against the PastOrPresentJob FHIR profile, but no validation checks are performed.
  ...
  toFHIR(asExtension=false) {
    ...
    if (this.employer != null) {
      inst['extension'] = inst['extension'] || [];
      inst['extension'].push(typeof this.employer.toFHIR === 'function' ? this.employer.toFHIR(true) : this.employer);
    }
    if (this.focalSubjectModifier != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the PastOrPresentJob class.
   * The FHIR must be valid against the PastOrPresentJob FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {PastOrPresentJob} An instance of PastOrPresentJob populated with the FHIR data
   */
