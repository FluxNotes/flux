...
/**
 * Generated class for odh.PersonEmploymentStatus.
 * @extends CodedSocialHistoryObservation
 */
class PersonEmploymentStatus extends CodedSocialHistoryObservation {
   ...
   * @param {Entry} entryInfo - The shr.base.Entry
   * @returns {PersonEmploymentStatus} this.
   */
  ...
  /**
   * Deserializes JSON data to an instance of the PersonEmploymentStatus class.
   * The JSON must be valid against the PersonEmploymentStatus JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {PersonEmploymentStatus} An instance of PersonEmploymentStatus populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new PersonEmploymentStatus();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the PersonEmploymentStatus class to a JSON object.
   * The JSON is expected to be valid against the PersonEmploymentStatus JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/odh/PersonEmploymentStatus' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the PersonEmploymentStatus class to a FHIR object.
   * The FHIR is expected to be valid against the PersonEmploymentStatus FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the PersonEmploymentStatus class.
   * The FHIR must be valid against the PersonEmploymentStatus FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {PersonEmploymentStatus} An instance of PersonEmploymentStatus populated with the FHIR data
   */
...
export default PersonEmploymentStatus;
