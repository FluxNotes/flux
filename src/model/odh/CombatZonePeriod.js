...
/**
 * Generated class for odh.CombatZonePeriod.
 * @extends SocialHistoryObservation
 */
class CombatZonePeriod extends SocialHistoryObservation {
  ...
  /**
   * Deserializes JSON data to an instance of the CombatZonePeriod class.
   * The JSON must be valid against the CombatZonePeriod JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {CombatZonePeriod} An instance of CombatZonePeriod populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new CombatZonePeriod();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the CombatZonePeriod class to a JSON object.
   * The JSON is expected to be valid against the CombatZonePeriod JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/odh/CombatZonePeriod' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the CombatZonePeriod class to a FHIR object.
   * The FHIR is expected to be valid against the CombatZonePeriod FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the CombatZonePeriod class.
   * The FHIR must be valid against the CombatZonePeriod FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {CombatZonePeriod} An instance of CombatZonePeriod populated with the FHIR data
   */
...
export default CombatZonePeriod;
