...
/**
 * Generated class for odh.OccupationalHazard.
 * @extends NonIndependentFinding
 */
class OccupationalHazard extends NonIndependentFinding {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/odh/OccupationalHazard' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the OccupationalHazard class to a FHIR object.
   * The FHIR is expected to be valid against the OccupationalHazard FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the OccupationalHazard class.
   * The FHIR must be valid against the OccupationalHazard FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {OccupationalHazard} An instance of OccupationalHazard populated with the FHIR data
   */
