...
/**
 * Generated class for odh.RetirementDate.
 * @extends SocialHistoryObservation
 */
class RetirementDate extends SocialHistoryObservation {
  ...
  /**
   * Deserializes JSON data to an instance of the RetirementDate class.
   * The JSON must be valid against the RetirementDate JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {RetirementDate} An instance of RetirementDate populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new RetirementDate();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the RetirementDate class to a JSON object.
   * The JSON is expected to be valid against the RetirementDate JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/odh/RetirementDate' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the RetirementDate class to a FHIR object.
   * The FHIR is expected to be valid against the RetirementDate FHIR profile, but no validation checks are performed.
  ...
  toFHIR(asExtension=false) {
    ...
    if (this.value != null) {
      inst['valueDateTime'] = typeof this.value.toFHIR === 'function' ? this.value.toFHIR() : this.value;
    }
    if (this.exceptionValue != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the RetirementDate class.
   * The FHIR must be valid against the RetirementDate FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {RetirementDate} An instance of RetirementDate populated with the FHIR data
   */
