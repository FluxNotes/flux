...
/**
 * Generated class for odh.UsualWork.
 * @extends CodedSocialHistoryObservation
 */
class UsualWork extends CodedSocialHistoryObservation {
  ...
  /**
   * Deserializes JSON data to an instance of the UsualWork class.
   * The JSON must be valid against the UsualWork JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {UsualWork} An instance of UsualWork populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new UsualWork();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the UsualWork class to a JSON object.
   * The JSON is expected to be valid against the UsualWork JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = this._entryInfo.toJSON();
    inst['EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/odh/UsualWork' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the UsualWork class to a FHIR object.
   * The FHIR is expected to be valid against the UsualWork FHIR profile, but no validation checks are performed.
  ...
  toFHIR(asExtension=false) {
    ...
    if (this.relevantTime != null) {
      inst['effectivePeriod'] = typeof this.relevantTime.toFHIR === 'function' ? this.relevantTime.toFHIR() : this.relevantTime;
    }
    if (this.exceptionValue != null) {
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the UsualWork class.
   * The FHIR must be valid against the UsualWork FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {UsualWork} An instance of UsualWork populated with the FHIR data
   */
