...
/**
 * Generated class for odh.WorkSchedule.
 * @extends NonIndependentFinding
 */
class WorkSchedule extends NonIndependentFinding {
  ...
  /**
   * Deserializes JSON data to an instance of the WorkSchedule class.
   * The JSON must be valid against the WorkSchedule JSON schema, although this is not validated by the function.
   * @param {object} json - the JSON data to deserialize
   * @returns {WorkSchedule} An instance of WorkSchedule populated with the JSON data
   */
  static fromJSON(json={}) {
    const inst = new WorkSchedule();
    setPropertiesFromJSON(inst, json);
    return inst;
  }

  /**
   * Serializes an instance of the WorkSchedule class to a JSON object.
   * The JSON is expected to be valid against the WorkSchedule JSON schema, but no validation checks are performed.
   * @returns {object} a JSON object populated with the data from the element
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/odh/WorkSchedule' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the WorkSchedule class to a FHIR object.
   * The FHIR is expected to be valid against the WorkSchedule FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the WorkSchedule class.
   * The FHIR must be valid against the WorkSchedule FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {WorkSchedule} An instance of WorkSchedule populated with the FHIR data
   */
