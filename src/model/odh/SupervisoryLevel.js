...
/**
 * Generated class for odh.SupervisoryLevel.
 * @extends NonIndependentFinding
 */
class SupervisoryLevel extends NonIndependentFinding {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/odh/SupervisoryLevel' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the SupervisoryLevel class to a FHIR object.
   * The FHIR is expected to be valid against the SupervisoryLevel FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the SupervisoryLevel class.
   * The FHIR must be valid against the SupervisoryLevel FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {SupervisoryLevel} An instance of SupervisoryLevel populated with the FHIR data
   */
