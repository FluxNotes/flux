...
/**
 * Generated class for odh.CodedSocialHistoryObservation.
...
class CodedSocialHistoryObservation extends SocialHistoryObservation {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/odh/CodedSocialHistoryObservation' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the CodedSocialHistoryObservation class to a FHIR object.
   * The FHIR is expected to be valid against the CodedSocialHistoryObservation FHIR profile, but no validation checks are performed.
