...
/**
 * Generated class for odh.DailyWorkHours.
 * @extends NonIndependentFinding
 */
class DailyWorkHours extends NonIndependentFinding {
   ...
   */
  toJSON() {
    const inst = { 'EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/odh/DailyWorkHours' } };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the DailyWorkHours class to a FHIR object.
   * The FHIR is expected to be valid against the DailyWorkHours FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the DailyWorkHours class.
   * The FHIR must be valid against the DailyWorkHours FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {DailyWorkHours} An instance of DailyWorkHours populated with the FHIR data
   */
