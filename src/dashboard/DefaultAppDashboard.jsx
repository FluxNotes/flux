...
import './DefaultAppDashboard.css';

export default class DefaultAppDashboard extends Component {
    ...
    render() {
        ...
        return (
            <div id="default-app-dashboard-content" style={{ display: "flex" }}>
