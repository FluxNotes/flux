...
class PatientSelectionModal extends Component {
    constructor(props) {
        ...
        this.currentPatientViewed = patientList[patientList.length - 1].patient.entryInfo.shrId;
    }
    ...
    fillModal = () => {
        ...
        patientList.forEach((patient) => {
            ...
            const pic = patient.patient.photographicImage;
            const shrId = patient.patient.entryInfo.shrId;
