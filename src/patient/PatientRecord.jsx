...
class PatientRecord {
    ...
    _calculateNextEntryId() {
        this.nextEntryId = _.reduce(this.entries, function (max, o) {
            return Math.max(max, o.entryInfo.entryId.id);
        }, 0) + 1;
    }
    ...
    addEntryToPatient(entry, clinicalNote) {
        ...
        entry.entryInfo.entryId = this._createNewEntryId(this.nextEntryId);
    ...
    getEntryById(entryId) {
        return this.entries.find((entry) => {
            return entry.entryInfo.entryId.id === entryId;
        });
    }
