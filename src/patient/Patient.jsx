...
class Patient {
	hardCodedPatient = [
		...
		},
		{
			...
			focalSubject: {entryType: "http://standardhealthrecord.org/demographics/PersonOfRecord", shrId: "788dcbc3-ed18-470c-89ef-35ff91854c7d", entryId: "1"},
			specificType: {coding: {value: "408643008", codeSystem: "http://snomed.info/sct", displayText: "Invasive ductal carcinoma of breast"}},
    ...
    static createNewStudyEnrollment(title = '', identifier = '', enrollmentDate = '', endDate = '') {
