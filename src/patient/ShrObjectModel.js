...
/* Schema: http://jstars-linux-1.mitre.org/json-schema/shr/oncology#/definitions/Progression */
	var OncologyDefinitionsProgressionClass = classes.OncologyDefinitionsProgression = function OncologyDefinitionsProgressionClass(value) {
		...
		AssessmentDefinitionsAssessmentClass.apply(this, arguments); //only the second inheritance, what is the best way to add the first? add properties directly to child? or...
		BaseDefinitionsEntryClass.apply(this,arguments); //one line? or edit schema2js to identify memberIndex-2 == first parent.
	};
