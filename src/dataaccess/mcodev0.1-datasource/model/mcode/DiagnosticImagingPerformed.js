...
/**
 * Generated class for mcode.DiagnosticImagingPerformed.
...
class DiagnosticImagingPerformed extends ProcedurePerformed {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/mcode/DiagnosticImagingPerformed' };
  ...
  /**
   * Serializes an instance of the DiagnosticImagingPerformed class to a FHIR object.
   * The FHIR is expected to be valid against the DiagnosticImagingPerformed FHIR profile, but no validation checks are performed.
