...
class AddressLine {
  ...
  /**
   * Serializes an instance of the AddressLine class to a FHIR object.
   * The FHIR is expected to be valid against the AddressLine FHIR profile, but no validation checks are performed.
