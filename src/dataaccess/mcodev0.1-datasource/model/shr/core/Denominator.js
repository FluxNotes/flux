...
class Denominator {
  ...
  /**
   * Serializes an instance of the Denominator class to a FHIR object.
   * The FHIR is expected to be valid against the Denominator FHIR profile, but no validation checks are performed.
  ...
  /**
   * Deserializes FHIR JSON data to an instance of the Denominator class.
   * The FHIR must be valid against the Denominator FHIR profile, although this is not validated by the function.
   * @param {object} fhir - the FHIR JSON data to deserialize
   * @param {boolean} asExtension - Whether the provided instance is an extension
   * @returns {Denominator} An instance of Denominator populated with the FHIR data
   */
