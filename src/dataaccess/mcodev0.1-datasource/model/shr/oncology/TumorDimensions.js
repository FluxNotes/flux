...
class TumorDimensions extends Observation {
  ...
  toJSON() {
    ...
    inst['EntryType'] = { 'Value': 'http://standardhealthrecord.org/spec/shr/oncology/TumorDimensions' };
    if (this.value != null) {
  ...
  /**
   * Serializes an instance of the TumorDimensions class to a FHIR object.
   * The FHIR is expected to be valid against the TumorDimensions FHIR profile, but no validation checks are performed.
