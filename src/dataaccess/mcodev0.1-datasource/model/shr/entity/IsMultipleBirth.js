...
class IsMultipleBirth {
  ...
  /**
   * Serializes an instance of the IsMultipleBirth class to a FHIR object.
   * The FHIR is expected to be valid against the IsMultipleBirth FHIR profile, but no validation checks are performed.
