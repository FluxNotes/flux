...
class OrganizationName {
  ...
  /**
   * Serializes an instance of the OrganizationName class to a FHIR object.
   * The FHIR is expected to be valid against the OrganizationName FHIR profile, but no validation checks are performed.
