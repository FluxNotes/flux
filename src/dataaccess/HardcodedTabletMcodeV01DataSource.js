...
import * as EntryMapper from './mcodev0.1-datasource/EntryMapper';
import moment from 'moment';


class HardcodedTabletMcodeV01DataSource extends IDataSource {
    constructor() {
        super();
        this._gestalt = {
            create: {
        ...
        this._ellaPatient = new PatientRecord(EntryMapper.mapEntries(BreastMainTreatmentTry3Ella));
        this._ihanosPatient = new PatientRecord(EntryMapper.mapEntries(GistAdjuvantIhanos));
...
export default HardcodedTabletMcodeV01DataSource;
