...
export default class NLPKeyword extends Shortcut {
    ...
    setText(text, updatePatient = true) {
        ...
        this.text = text;
        // console.log("NLPKeyword.setText: " + this.metadata.picker);
    ...
    getShortcutType() {
        ...
        //throw new Error("getShortcutType on NLPKeyword called.");
    ...
    static getStringTriggers() {
        throw new Error("getStringTriggers on NLPKeyword called.");
