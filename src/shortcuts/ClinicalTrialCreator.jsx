...
class ClinicalTrialCreator extends CreatorShortcut {
    constructor(onUpdate, clinicalTrial) {
        ...
        if (Lang.isUndefined(clinicalTrial)) {
            ...
            // TODO: Setting the entryInfo will be autogenerated and this should be taken out
            this.clinicalTrial.entryInfo = new Entry();
            this.clinicalTrial.entryInfo.entryType = ["http://standardhealthrecord.org/base/Study"];
    ...
    setAttributeValue(name, value, publishChanges) {
        if (name === "title") {
            ...
            this.clinicalTrial.enrollmentDate = value; // TODO: this will need to use an extension from SHR until SHR is updated
        } else if (name === "endDateFlag") {
            this.endDateFlag = value === true;
        } else if (name === "endDate") {
            this.clinicalTrial.endDate = value; // TODO: this will need to use an extension from SHR until SHR is updated
        } else {
