...
import TestConditionSelection from './TestConditionSelection';
import TestDataSummaryTable from './TestDataSummaryTable';
...
class TestDataSummaryPanel extends Component {
	constructor(props) {
		super(props);
...
TestDataSummaryPanel.propTypes = {
...
export default TestDataSummaryPanel;
