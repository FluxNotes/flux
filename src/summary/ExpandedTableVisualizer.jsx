...
export default class ExpandedTableVisualizer extends Visualizer {
    ...
    renderedQuestion(question, index) {
        return(
            <TableRow key={index}>
    ...
    renderedPositiveQuestions(positiveQuestions) {
        let indx = 0;
        const renderedPositiveQuestions = positiveQuestions.map((question) => {
            return this.renderedQuestion(question, indx++);
        });
        return (
    ...
    renderedNegativeQuestions(negativeQuestions) {
        ...
        // let indx = 0;
        // const renderedNegativeQuestions = negativeQuestions.map((question) => {
        //     return this.renderedQuestion(question, indx++);
        // });
        // // return (
        //     <Table className="negative-questions-table">
        //         <TableBody>{renderedNegativeQuestions}</TableBody>
        //     </Table>
        // );
    }
        ...
        return (
            <div className="expanded-table" key={tableIndex}>
                ...
                <div className="expanded-table-body">
                    {this.renderedPositiveQuestions(positiveQuestions)}
                    {this.renderedNegativeQuestions(negativeQuestions)}
                </div>
            </div>
        );
    }
