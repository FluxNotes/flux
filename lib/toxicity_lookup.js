const gradeOptions = [
    {name: '1', value: 'Grade 1', description: "Mild; asymptomatic or mild symptoms; clinical or diagnostic observations only; intervention not indicated."},
    {name: '2', value: 'Grade 2', description: "Moderate; minimal, local or noninvasive intervention indicated; limiting age-appropriate instrumental activities of daily life."},
    {name: '3', value: 'Grade 3', description: "Severe or medically significant but not immediately life-threatening; hospitalization or prolongation of hospitalization indicated; disabling; limiting self care ADL"},
    {name: '4', value: 'Grade 4', description: "Life-threatening consequences; urgent intervention indicated. "},
    {name: '5', value: 'Grade 5', description: "Death related to adverse effect"}
]
