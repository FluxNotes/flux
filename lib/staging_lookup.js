...
exports.getTsNamesForEdition = getTsNamesForEdition;
function getTsNamesForEdition(ed) {
...
exports.getNsNamesForEdition = getNsNamesForEdition;
function getNsNamesForEdition(ed) {
...
exports.getMsNamesForEdition = getMsNamesForEdition;
function getMsNamesForEdition(ed) {
...
exports.getTableForEdition = getTableForEdition;
function getTableForEdition(ed) {
    switch (ed) {
        case 5:
...
function isValidM(possibleM, ed=7) {
